...
(function(f,d,b){tdcRecycle={_maxItems:100,_currentIndex:0,_items:[],_timeout:b,_timoutSavingHistory:b,$_restoreItem:b,$_restoreContent:b,$_undo:b,$_redo:b,_isInitialized:!1,item:function(b,a,c,h){this.timestamp=b;this.description=a;this.shortcode=c;this.headerTemplateData=h},init:function(){tdcRecycle._isInitialized||(tdcRecycle.$_restoreItem=f("#tdc-restore"),tdcRecycle.$_restoreContent=f("#tdc-restore-content"),tdcRecycle.$_undo=f(".tdc-restore-undo"),tdcRecycle.$_redo=f(".tdc-restore-redo"),tdcRecycle.$_restoreItem.on("click",
function(b){tdcRecycle.$_restoreContent.toggle()}),tdcRecycle.$_restoreContent.on("click",".tdc-snapshot",function(e){d.isUndefined(tdcRecycle._timeout)||clearTimeout(tdcRecycle._timeout);tdcRecycle._timeout=setTimeout(function(a){a=f(a);var c=new tdcJobManager.job,e=a.find(".tdc-snapshot-shortcode"),k=a.find(".tdc-snapshot-header"),l=tdcUtil.b64DecodeUnicode(e.html()),m=JSON.parse(tdcUtil.b64DecodeUnicode(k.html()));tdcNotice.removeAll();tdcRecycle._currentIndex=a.prevAll(".tdc-snapshot").length;
tdcRecycle.$_restoreContent.find(".tdc-snapshot-active").removeClass("tdc-snapshot-active");a.addClass("tdc-snapshot-active");c.shortcode=l;c.columns=3;c.success_callback=function(a){var c=f(tdcAdminIFrameUI._$liveIframe).contents(),h=c.find(".tdc-content-wrap");d.has(a,"replyHtml")&&h.html(a.replyHtml);window.addWrappers(c,".td-main-content-wrap","tdc_content");tdcIFrameData._isInitialized=!1;tdcIFrameData._postOriginalContentJSON=b;window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(a.shortcode);
tdcState.getHeaderTemplateId()!==m.tdc_header_template_id||tdcState.getHeaderTemplateContent()!==m.tdc_header_template_content?(tdcState.setHeaderTemplateId(m.tdc_header_template_id),tdcState.setHeaderTemplateContent(m.tdc_header_template_content),""===m.tdc_assoc_header_template?tdcState.setGlobalTemplate():tdcState.unsetGlobalTemplate(),"no_header"===m.tdc_header_template_id?tdcState.setNoHeader():tdcState.unsetNoHeader(),tdcState.isGlobalTemplate()?tdcSidebar.$_headerTemplateList.val(""):tdcState.isNoHeader()?
tdcSidebar.$_headerTemplateList.val(m.tdc_header_template_id):tdcSidebar.$_headerTemplateList.val("tdb_template_"+m.tdc_header_template_id),tdcIFrameData.setHeaderTemplate(m.tdc_header_template_content,b,{is_snapshot:!0,indexPath:e.data("index_path")})):(tdcState.isNoHeader()&&["tdc_header_desktop","tdc_header_desktop_sticky","tdc_header_mobile","tdc_header_mobile_sticky"].forEach(function(a,c){tdcIFrameData.rebuildZone(a,"[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]",b,{is_snapshot:!0})}),
tdcIFrameData._callbackShortcodeRender({lateCallback:function(){var c=f(tdcAdminIFrameUI._$liveIframe).contents();tdcSidebar._currentModel=b;tdcIFrameData.init(c,!0);tdcRecycle.clearJsItems();tdcOperationUI.init(c);d.has(a,"replyJsForEval")&&tdcAdminIFrameUI.evalInIframe(a.replyJsForEval);tdcSidebarPanel.showShortcodeFromPath(e.data("index_path"))}}))};c.error_callback=function(a,c){tdcDebug.log(c);tdcDebug.log(a)};c.is_snapshot=!0;tdcJobManager.addJob(c);tdcSidebarPanel.clearPanel()},500,this)}),
tdcRecycle.$_undo.on("click",tdcRecycle._undo),tdcRecycle.$_redo.on("click",tdcRecycle._redo),tdcRecycle._getData(),tdcRecycle.takeSnapshot(),tdcRecycle.saveHeaderState(),tdcRecycle.saveFooterState(),document.body.addEventListener("keydown",tdcRecycle._checkKeyDown,!0),document.getElementById("tdc-live-iframe").contentDocument.addEventListener("keydown",tdcRecycle._checkKeyDown,!0),tdcRecycle._isInitialized=!0)},_getData:function(){var b=tdcRecycle.$_restoreContent.find(".tdc-snapshot");b.length&&
b.each(function(){var a=f(this);a=new tdcRecycle.item(a.children(":nth-child(1)").data("timestamp"),"Restore point",tdcUtil.b64DecodeUnicode(a.children(":nth-child(3)").html()),a.children(":nth-child(4)").html());tdcRecycle._items.unshift(a)});1<tdcRecycle._items.length&&(tdcRecycle.$_undo.addClass("tdc-restore-active"),tdcRecycle.$_redo.removeClass("tdc-restore-active"))},_getIndexPath:function(b){var a="";if(!d.isUndefined(b)){a=b.get("parentModel");if(d.isUndefined(a))return"tdc_zone"===b.get("tag")?
tdcIFrameData.tdcTopCollection.indexOf(b):"";var c=a.get("childCollection");a=tdcRecycle._getIndexPath(a)+"_"+c.models.indexOf(b)}return a},_undo:function(b){1!==tdcRecycle._items.length&&(tdcRecycle._currentIndex++,tdcRecycle._currentIndex>tdcRecycle._items.length-1?tdcRecycle._currentIndex=tdcRecycle._items.length-1:(tdcRecycle._currentIndex===tdcRecycle._items.length-1&&tdcRecycle.$_undo.removeClass("tdc-restore-active"),b=tdcRecycle.$_restoreContent.find(".tdc-snapshot:eq("+tdcRecycle._currentIndex+
...
takeSnapshot:function(e){var a={error:b,getShortcode:""};tdcIFrameData.getShortcodeFromData(a);d.isUndefined(a.error)||tdcDebug.log(a.error);if(!d.isUndefined(a.getShortcode)&&""!==a.getShortcode){var c=tdcUtil.b64EncodeUnicode(JSON.stringify(tdcSavePost.getHeaderTemplateData()));if(!tdcRecycle._isLastSnapshot(a.getShortcode,c)){tdcRecycle._currentIndex=0;d.isUndefined(e)&&(e="Restore point");var h=new Date;e=new tdcRecycle.item(h.getTime(),e,a.getShortcode,c);a=tdcRecycle._getIndexPath(tdcSidebar.getCurrentModel());
...
h.toLocaleDateString()+" "+h.toLocaleTimeString()+'</div><div style="width: 350px; float: left">Before '+e.description+'</div><div class="tdc-snapshot-shortcode" style="display: none" data-index_path="'+a+'">'+tdcUtil.b64EncodeUnicode(e.shortcode)+'</div><div class="tdc-snapshot-header" style="display: none">'+e.headerTemplateData+"</div></div>");1<tdcRecycle._items.length&&(tdcRecycle.$_undo.addClass("tdc-restore-active"),tdcRecycle.$_redo.removeClass("tdc-restore-active"));clearTimeout(tdcRecycle._timoutSavingHistory);
...
new Date,c=new tdcRecycle.item(a.getTime(),b.description+" - restored",b.shortcode,b.headerTemplateData),h=tdcRecycle._getIndexPath(tdcSidebar.getCurrentModel());tdcRecycle._maxItems===tdcRecycle._items.length&&(tdcRecycle._items.splice(tdcRecycle._items.length-1,1),tdcRecycle.$_restoreContent.find(".tdc-snapshot:last").remove());tdcRecycle._items.push(c);tdcRecycle.$_restoreContent.prepend('<div class="tdc-snapshot"><div style="width: 150px; float: left">'+a.toLocaleDateString()+" "+a.toLocaleTimeString()+
'</div><div style="width: 350px; float: left">Before '+c.description+'</div><div class="tdc-snapshot-shortcode" style="display: none" data-index_path="'+h+'">'+tdcUtil.b64EncodeUnicode(c.shortcode)+'</div><div class="tdc-snapshot-header" style="display: none" data-index_path="'+h+'">'+tdcUtil.b64EncodeUnicode(c.headerTemplateData)+"</div></div>");1<tdcRecycle._items.length&&(tdcRecycle.$_undo.addClass("tdc-restore-active"),tdcRecycle.$_redo.removeClass("tdc-restore-active"));return b.shortcode}}},
...
(function(f,d,b,e){tdcState={_headerTemplateId:"",_headerTemplateContent:"",_isGlobalTemplate:!1,_isNoHeader:!1,_isHeaderSticky:!1,_isMobileHeaderSticky:!1,_isGlobalFooterTemplate:!1,_isNoFooter:!1,init:function(a,c,b,e,h,k,d,l){tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(c);b&&tdcState.setGlobalTemplate();e&&tdcState.setNoHeader();tdcState.setFooterTemplateId(h);tdcState.setFooterTemplateContent(k);d&&tdcState.setGlobalFooterTemplate();l&&tdcState.setNoFooter()},setHeaderTemplateId:function(a){tdcState._headerTemplateId=
a},getHeaderTemplateId:function(){return tdcState._headerTemplateId},setHeaderTemplateContent:function(a){tdcState._headerTemplateContent=a},getHeaderTemplateContent:function(){return tdcState._headerTemplateContent},setGlobalTemplate:function(){tdcState._isGlobalTemplate=!0},unsetGlobalTemplate:function(){tdcState._isGlobalTemplate=!1},isGlobalTemplate:function(){return tdcState._isGlobalTemplate},setNoHeader:function(){tdcState._isNoHeader=!0},unsetNoHeader:function(){tdcState._isNoHeader=!1},isNoHeader:function(){return tdcState._isNoHeader},
...
setFooterTemplateContent:function(a){tdcState._footerTemplateContent=a},getFooterTemplateContent:function(){return tdcState._footerTemplateContent},setGlobalFooterTemplate:function(){tdcState._isGlobalFooterTemplate=!0},unsetGlobalFooterTemplate:function(){tdcState._isGlobalFooterTemplate=!1},isGlobalFooterTemplate:function(){return tdcState._isGlobalFooterTemplate},setNoFooter:function(){tdcState._isNoFooter=!0},unsetNoFooter:function(){tdcState._isNoFooter=!1},isNoFooter:function(){return tdcState._isNoFooter}};
f=window.tdcPostSettings.headerTemplateId;d=window.tdcPostSettings.headerTemplateContent;var a=e=!1,c=window.tdcPostSettings.footerTemplateId,h=window.tdcPostSettings.footerTemplateContent,k=!1,l=!1;""===f?(f=window.tdcAdminSettings.headerTemplateId.toString().replace("tdb_template_",""),d=window.tdcAdminSettings.headerTemplateContent,e=!0):"no_header"===f&&(a=!0);if(""!==d){var m=JSON.parse(tdcUtil.b64DecodeUnicode(d));b.isUndefined(m.tdc_is_header_sticky)||!0!==m.tdc_is_header_sticky||tdcState.setHeaderSticky();
b.isUndefined(m.tdc_is_mobile_header_sticky)||!0!==m.tdc_is_mobile_header_sticky||tdcState.setMobileHeaderSticky()}""===c?(c=window.tdcAdminSettings.footerTemplateId.toString().replace("tdb_template_",""),h=window.tdcAdminSettings.footerTemplateContent,k=!0):"no_footer"===c&&(l=!0);tdcState.init(f,d,e,a,c,h,k,l)})(jQuery,Backbone,_);var tdcSavePost;
...
data:tdcLivePanel.$panel.serialize()}).done(function(a,e,k){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&(b.isObject(a)&&b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(new tdcNotice.notice("Content Successfully Saved!",!1,!0),0!==tdcLivePanel.$tdbPostSettings.length&&!0===tdcLivePanel.$tdbPostSettings.data("changed")&&new tdcNotice.notice("Single Templates Post Settings Successfully Saved!",
...
f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/save_history","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:tdcLivePanel.$panel.serialize()}).done(function(a,c,e){"success"===c&&b.isObject(a)&&b.has(a,"errors")&&new tdcNotice.notice(a.errors,!0,!1)}).fail(function(a,c,b){})}},updateHeaderTemplate:function(){var a=tdcSavePost.getHeaderTemplateData();a.tdc_header_template_content!==window.tdcAdminSettings.lastHeaderTemplateData&&
(window.tdcAdminSettings.lastHeaderTemplateData=a.tdc_header_template_content,f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/update_header_template","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{td_magic_token:tdcLivePanel.$token.val(),tdc_action:"update_header_template",tdc_header_template_id:a.tdc_header_template_id,tdc_header_template_content:a.tdc_header_template_content,tdc_assoc_header_template:a.tdc_assoc_header_template,
tdc_post_id:tdcLivePanel.$tdcPostId.val()}}).done(function(a,e,k){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&b.isObject(a)&&(b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(b.has(a,"header_template_id")&&(tdcState.setHeaderTemplateId(a.header_template_id),tdcSidebar.updateHeaderTemplates()),tdcMain.resetContentModified(),new tdcNotice.notice("Header Successfully Saved!",!1,!0)))}).fail(function(a,
b,e){}))},getHeaderTemplateData:function(){var a=tdcState.getHeaderTemplateId(),c="",b={};""!==a&&"no_header"!==a&&(c=tdcUtil.b64EncodeUnicode(JSON.stringify(tdcIFrameData.getHeaderShortcodeFromData())));tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(c);b.tdc_header_template_id=a;b.tdc_header_template_content=c;b.tdc_assoc_header_template=tdcState.isGlobalTemplate()?"":!0;return b},cloudLoadHeaderTemplate:function(a,c,e,d){b.isUndefined(a)||(d={td_magic_token:tdcLivePanel.$token.val(),
tdc_action:"load_header_template",tdc_header_template_content:a,tdc_header_template_title:d},b.isUndefined(e)||(d.tdc_header_template_id=e),f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/load_header_template","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:d}).done(function(e,h,d){"success"===h&&b.isObject(e)&&(b.has(e,"errors")?new tdcNotice.notice(e.errors,!0,!1):b.has(e,"header_template_id")&&
(tdcState.setHeaderTemplateId(e.header_template_id),tdcState.unsetGlobalTemplate()),tdcSidebar.updateHeaderTemplates(),tdcIFrameData.setHeaderTemplate(a,c))}).fail(function(a,c,b){}))},cloudLoadFooterTemplate:function(a,c,e,d){b.isUndefined(a)||(d={td_magic_token:tdcLivePanel.$token.val(),tdc_action:"load_footer_template",tdc_footer_template_content:a,tdc_footer_template_title:d},b.isUndefined(e)||(d.tdc_footer_template_id=e),f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/load_footer_template",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:d}).done(function(e,h,d){"success"===h&&b.isObject(e)&&(b.has(e,"errors")?new tdcNotice.notice(e.errors,!0,!1):b.has(e,"footer_template_id")&&(tdcState.setFooterTemplateId(e.footer_template_id),tdcState.unsetGlobalFooterTemplate()),tdcSidebar.updateFooterTemplates(),tdcIFrameData.setFooterTemplate(a,c))}).fail(function(a,c,b){}))},getFooterTemplateData:function(){var a=
tdcState.getFooterTemplateId(),c="",b={};""!==a&&"no_footer"!==a&&(c=tdcIFrameData.getFooterShortcodeFromData());tdcState.setFooterTemplateId(a);tdcState.setFooterTemplateContent(c);b.tdc_footer_template_id=a;b.tdc_footer_template_content=c;b.tdc_assoc_footer_template=tdcState.isGlobalFooterTemplate()?"":!0;return b},saveMobileMenu:function(a,c){f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/save_header_mobile_menu","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",
window.tdcAdminSettings.wpRestNonce)},data:{template_id:a,menu_id:c}}).done(function(a,e,d){"success"===e&&(b.isObject(a)&&b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):window.tdcPostSettings.mobileMenuId=c)}).fail(function(a,c,b){})},updateFooterTemplate:function(){var a=tdcSavePost.getFooterTemplateData();tdcUtil.b64EncodeUnicode(JSON.stringify(a.tdc_footer_template_content))!==window.tdcAdminSettings.lastFooterTemplateData&&(window.tdcAdminSettings.lastFooterTemplateData=tdcUtil.b64EncodeUnicode(JSON.stringify(a.tdc_footer_template_content)),
f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/update_footer_template","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{td_magic_token:tdcLivePanel.$token.val(),tdc_action:"update_footer_template",tdc_footer_template_id:a.tdc_footer_template_id,tdc_footer_template_content:a.tdc_footer_template_content,tdc_assoc_footer_template:a.tdc_assoc_footer_template,tdc_post_id:tdcLivePanel.$tdcPostId.val()}}).done(function(a,
e,d){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&b.isObject(a)&&(b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(b.has(a,"footer_template_id")&&(tdcState.setFooterTemplateId(a.footer_template_id),tdcSidebar.updateFooterTemplates()),tdcMain.resetContentModified(),new tdcNotice.notice("Footer Successfully Saved!",!1,!0)))}).fail(function(a,b,e){}))}}})(jQuery,Backbone,_);
...
b+"&uuid="+tdcJobManager._getUniqueID()),beforeSend:function(b){b.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},cache:!1,data:d,dataType:"json",statusCode:{404:function(){console.log("tdcJobManager.addJob - ERROR: 404 not found")},500:function(){console.log("tdcJobManager.addJob - ERROR: 500 server error")}},success:function(b,a,c){null===b?f.error_callback(d,"tdcJobManager.addJob - ERROR: Empty response received from server"):(!0===tdcJobManager._isJobCallbackReplyValid(f.blockUid,
b.jobId)?f.success_callback(b):tdcDebug.log("tdcJobManager.addJob - dropped job :) (probably it's older than the last timestamp)"),tdcDebug.groupEnd())},error:function(b,a,c){f.error_callback(d,"tdcJobManager.addJob - Error callback - textStatus: "+a+" errorThrown: "+c);tdcDebug.groupEnd()}})},_isJobCallbackReplyValid:function(f,d){return"undefined"===typeof tdcJobManager._sentJobs[f]||parseInt(tdcJobManager._sentJobs[f])<parseInt(d)?(tdcJobManager._sentJobs[f]=d,!0):!1},_generateJobId:function(){var f=
tdcJobManager.totalJobsCount;tdcJobManager.totalJobsCount++;return f},_getUniqueID:function(){function f(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return f()+f()+"-"+f()+"-"+f()+"-"+f()+"-"+f()+f()+f()}}})();var tdcAdminWrapperUI;
...
a)},_moveDraggedElement:function(){var a=tdcOperationUI.getDraggedElement(),c=tdcOperationUI.getCurrentElementOver(),h=tdcAdminWrapperUI.$placeholder,d="";if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(h)||!h.is(":visible")&&c!==tdcAdminWrapperUI.$recycle)){var l=tdcOperationUI.isSidebarElementDragged(),m=tdcOperationUI.isElementDragged(),g=!1,n=!1,p=!1,q=!1,t=!1,v=!1,u=tdcOperationUI.isElementWithRowDragged(),r=tdcOperationUI.getRowStartValues();if(m){var w=a.closest(".tdc-elements");if(!l&&
(d=tdcIFrameData._getSourceCol(tdcOperationUI.getDraggedElement()),b.isUndefined(d)))return}else(g=tdcOperationUI.isInnerColumnDragged())&&(w=a.closest(".tdc-inner-columns"));!g&&(n=tdcOperationUI.isInnerRowDragged(),p=tdcOperationUI.isTempInnerRowDragged(),n||p)&&(w=a.closest(".tdc-elements"));n||p||(q=tdcOperationUI.isColumnDragged())&&(w=a.closest(".tdc-columns"));!q&&(t=tdcOperationUI.isRowDragged(),v=tdcOperationUI.isTempRowDragged(),t||v)&&(w=a.closest(".tdc-rows"));if(l||m||g||n||p||q||t||
v){var A="",x=a.find(".td_block_inner");x.length&&(A=x.attr("id"));if(!l&&!b.isUndefined(w)&&w.length){var z=w.children();x=z.index(a);var y=z.index(h);if(c!==tdcAdminWrapperUI.$recycle&&-1!==y&&1===Math.abs(x-y))return;if(m||n||p||t||v){if((m||n||t)&&c===tdcAdminWrapperUI.$recycle){h="Deleting ";tdConfirm.showModal(n?h+"inner row":t?h+"row":h+"element",tdcOperationUI,function(){if((-1===y&&1===z.length||2===z.length&&-1!==y)&&(!t||1!==tdcIFrameData.tdcRows.length)){var c="";B=a.closest(".tdc-inner-column");
B.length?c=" tdc-element-inner-column":(C=a.closest(".tdc-column"),C.length&&(c=" tdc-element-column"));c=f('<div class="'+tdcOperationUI._emptyElementClass+c+'" title="Empty element that should be removed by composer"></div>');tdcElementUI.bindEmptyElement(c);w.append(c)}tdcRecycle.takeSnapshot("Delete element");tdcOperationUI.setDraggedElement(a);tdcOperationUI.setCurrentElementOver(tdcAdminWrapperUI.$recycle);tdcIFrameData.changeData({$refEl:tdcOperationUI.getDraggedElement(),wasSidebarElementDragged:l,
wasElementDragged:m,wasInnerColumnDragged:g,wasInnerRowDragged:n,wasTempInnerRowDragged:p,wasColumnDragged:q,wasRowDragged:t,wasTempRowDragged:v,wasElementWithRowDragged:u,rowStartValues:r,draggedBlockUid:A,sourceColParam:d});tdcSidebarPanel.clearPanel();tdcOperationUI.setDraggedElement(e);tdcOperationUI.setCurrentElementOver(e);tb_remove()},e,"Are you sure you want to delete this element?");return}if(-1===y&&1===z.length||2===z.length&&-1!==y){c="";var B=a.closest(".tdc-inner-column");if(B.length)c=
" tdc-element-inner-column";else{var C=a.closest(".tdc-column");C.length&&(c=" tdc-element-column")}c=f('<div class="'+tdcOperationUI._emptyElementClass+c+'" title="Empty element that should be removed by composer"></div>');tdcElementUI.bindEmptyElement(c);w.append(c)}}}l&&(c="",m?c="tdc-element":p?c="tdc-element-inner-row-temp":n?c="tdc-element-inner-row":v?c="tdc-row-temp":t&&(c="tdc-row"),c=f('<div class="'+c+'">'+a.html()+"</div>"),b.isUndefined(a.data("shortcodeName"))||c.data("shortcodeName",
a.data("shortcodeName")),b.isUndefined(a.data("startValues"))||c.data("startValues",a.data("startValues")),b.isUndefined(a.data("shortcodeContent"))||c.data("shortcodeContent",a.data("shortcodeContent")),b.isUndefined(a.data("rowStartValues"))||c.data("rowStartValues",a.data("rowStartValues")),b.isUndefined(a.data("templateContent"))||c.data("templateContent",a.data("templateContent")),tdcOperationUI.setDraggedElement(c),a=tdcOperationUI.getDraggedElement());h.replaceWith(a);if(l||m)B=a.closest(".tdc-inner-column"),
B.length?(a.removeClass("tdc-element-column"),a.addClass("tdc-element-inner-column")):(C=a.closest(".tdc-column"),C.length&&(a.removeClass("tdc-element-inner-column"),a.addClass("tdc-element-column")));h=a.prev();h.hasClass(tdcOperationUI._emptyElementClass)&&h.remove();h=a.next();h.hasClass(tdcOperationUI._emptyElementClass)&&h.remove();tdcIFrameData.changeData({$refEl:tdcOperationUI.getDraggedElement(),wasSidebarElementDragged:l,wasElementDragged:m,wasInnerColumnDragged:g,wasInnerRowDragged:n,wasTempInnerRowDragged:p,
wasColumnDragged:q,wasRowDragged:t,wasTempRowDragged:v,wasElementWithRowDragged:u,draggedBlockUid:A,sourceColParam:d})}else new tdcNotice.notice("_moveDraggedElement Error: $draggedElement not valid!",!0,!1)}},_copyElement:function(a){var c=tdcOperationUI.getCurrentElementOver(),h=tdcAdminWrapperUI.$placeholder;if(!b.isUndefined(c)&&!b.isUndefined(h)){var d=tdcUtil.getStorageItem("copyShortcodeType"),l=tdcUtil.getStorageItem("copyShortcodeAttrs"),m=tdcUtil.getStorageItem("copySourceCol"),g=tdcUtil.getStorageItem("copyShortcode"),
n=!1,p=!1,q=!1,t=!1,v=!1,u="",r=f('<div class="tdc-dropped"></div>');"vc_row"===d?(u="tdc-row",v=!0,r.addClass("tdc-row-temp")):"vc_column"===d?(u="tdc-element-column",q=!0):"vc_row_inner"===d?(u="tdc-element-inner-row",t=!0,r.addClass("tdc-element-inner-row-temp")):"vc_column_inner"===d?(u="tdc-element-inner-column",p=!0):""!==d&&(u="tdc-element",n=!0);r.addClass(u);r.data("shortcodeName",d);r.data("startValues",l);if(v||t)r.data("templateContent",g);else if(q||p){c=c.data("model_id");var w="";d=
tdcIFrameData.getModel(c).get("childCollection");b.isUndefined(d)||b.map(d.models,function(a,c){c={error:e,getShortcode:""};tdcIFrameData._checkModelData(a,c);b.isUndefined(c.getShortcode)||(w+=c.getShortcode)});d="";d=b.isUndefined(a)||!0!==a?tdcUtil.b64EncodeUnicode(tdcUtil.b64DecodeUnicode(g)+w):tdcUtil.b64EncodeUnicode(w+tdcUtil.b64DecodeUnicode(g));r.data("templateContent",d);r.data("model_id",c)}h.replaceWith(r);r.closest(".tdc-inner-columns").length?r.addClass("tdc-element-inner-column"):r.closest(".tdc-columns").length&&
r.addClass("tdc-element-column");tdcIFrameData.changeData({$refEl:r,wasSidebarElementDragged:!0,wasElementDragged:n,wasInnerColumnDragged:p,wasInnerRowDragged:!1,wasTempInnerRowDragged:t,wasColumnDragged:q,wasRowDragged:!1,wasTempRowDragged:v,wasElementWithRowDragged:!1,draggedBlockUid:"",sourceColParam:m})}}}})(jQuery,Backbone,_);var tdcZoneUI;
...
c.stopPropagation();tdcContextMenu.setContextMenu(c,a)&&(tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(a),$currentRow:tdcOperationUI.inRow(a)}),tdcOperationUI.activeElementOver(a))})},positionRowPlaceholder:function(a,c){var h=tdcAdminWrapperUI.$placeholder,d=0,l=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)d=a.pageX,l=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);
else if("scroll"===a.type){d=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;l=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var m={pageX:d,pageY:l};tdcOperationUI.setCurrentElementOver(e);tdcRowUI.tdcRow.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",m))});return}a=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(a))tdcOperationUI.hidePlaceholder();
else{var g=tdcOperationUI.getCurrentElementOverOuterHeight();d=tdcOperationUI.getCurrentElementOverOuterWidth();var n=tdcOperationUI.getCurrentElementOverOffset();if(l>n.top+g/2){l=a.next();if(!l.length||l.length&&l.attr("id")!==tdcAdminWrapperUI.placeholderId)a.after(h),tdcOperationUI.updateInfoHelper();parseInt(n.top)+parseInt(g)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"",right:"auto",
bottom:"0",width:d,"margin-left":""}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"",right:"",bottom:"",width:d,"margin-left":""})}else{l=a.prev();if(!l.length||l.length&&l.attr("id")!==tdcAdminWrapperUI.placeholderId)a.before(h),tdcOperationUI.updateInfoHelper();parseInt(n.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:"",right:"auto",bottom:"",width:d,"margin-left":""}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",
top:"",left:"",right:"",bottom:"",width:d,"margin-left":""})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcRowUI._elementCssClass}}})(jQuery,Backbone,_);var tdcColumnUI;
...
(c.preventDefault(),tdcOperationUI.setCurrentElementOver(e),tdcColumnUI.positionColumnPlaceholder(c)):(tdcMaskUI.setCurrentContainer(e),c=tdcOperationUI.inRow(a),b.isUndefined(c)||c.mouseenter())}).on("fakemouseenterevent",function(c){if(tdcOperationUI.isColumnDragged(a)){var b=a.find(".tdc-elements:first");if(b.length){var e=b.outerHeight(!0);b=b.outerWidth();var d=a.offset(),m=0,g=a.prevAll("."+tdcColumnUI._elementCssClass);g.length&&g.each(function(a,c){m+=parseInt(f(c).find(".tdc-elements:first").width())});
m+=d.left;parseInt(m)<=parseInt(c.pageX)&&parseInt(c.pageX)<=parseInt(m+b)&&parseInt(d.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(d.top+e)&&(tdcOperationUI.setCurrentElementOver(a),tdcColumnUI.positionColumnPlaceholder(c))}}}).on("contextmousedown",function(c){c.preventDefault();c.stopPropagation();tdcContextMenu.setContextMenu(c,a)&&(tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(a),$currentRow:tdcOperationUI.inRow(a),$currentColumn:tdcOperationUI.inColumn(a)}),tdcOperationUI.activeElementOver(a))})},
positionColumnPlaceholder:function(a,c){var h=tdcAdminWrapperUI.$placeholder,d=0,l=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)d=a.pageX,l=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){d=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;l=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var m={pageX:d,pageY:l};
tdcOperationUI.setCurrentElementOver(e);tdcOperationUI.getDraggedElement().closest(".tdc-columns").find(".tdc-column").each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",m))});return}a=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(a))tdcOperationUI.hidePlaceholder();else{var g=a.outerWidth(!0);l=tdcOperationUI.getCurrentElementOverOffset();var n=0,p=a.prevAll();p.length&&
p.each(function(a,c){a=f(c);a.hasClass("tdc-column")&&(n+=parseInt(a.outerWidth(!0)))});p=a.parent(".tdc-columns").parent(".vc_row");var q=p.css("position");if(b.isUndefined(q)||"static"!==q)if(p=p.css("padding-left"),b.isUndefined(p)||(p=parseInt(p.replace("px",""))),d>l.left+g/2){d=a.next();if(!d.length||d.length&&d.attr("id")!==tdcAdminWrapperUI.placeholderId)a.after(h),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+g+p),"margin-left":-24,top:""})}else{d=
a.prev();if(!d.length||d.length&&d.attr("id")!==tdcAdminWrapperUI.placeholderId)a.before(h),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+p),"margin-left":-24,top:""})}else if(d>l.left+g/2){d=a.next();if(!d.length||d.length&&d.attr("id")!==tdcAdminWrapperUI.placeholderId)a.after(h),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(l.left+g),"margin-left":-24,top:""})}else{d=a.prev();if(!d.length||d.length&&d.attr("id")!==
tdcAdminWrapperUI.placeholderId)a.before(h),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(l.left),"margin-left":-24,top:""})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcColumnUI._elementCssClass}}})(jQuery,Backbone,_);var tdcInnerRowUI;
...
$currentRow:tdcOperationUI.inRow(a),$currentColumn:tdcOperationUI.inColumn(a),$currentInnerRow:tdcOperationUI.inInnerRow(a)}),tdcOperationUI.activeElementOver(a))})},positionInnerRowPlaceholder:function(a,c){var d=tdcAdminWrapperUI.$placeholder,k=0,l=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)k=a.pageX,l=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){k=
tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;l=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var m={pageX:k,pageY:l};tdcOperationUI.setCurrentElementOver(e);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",m))});tdcInnerRowUI.tdcElementInnerRow.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",
m))});return}a=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(a))tdcOperationUI.hidePlaceholder();else{var g=a.outerHeight(!0);k=a.innerWidth();var n=a.offset();if(l>n.top+g/2){l=a.next();if(!l.length||l.length&&l.attr("id")!==tdcAdminWrapperUI.placeholderId)a.after(d),tdcOperationUI.updateInfoHelper(e);parseInt(n.top)+parseInt(g)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",
top:"",left:"","margin-top":"","margin-left":"",bottom:"0",width:k}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:k})}else{l=a.prev();if(!l.length||l.length&&l.attr("id")!==tdcAdminWrapperUI.placeholderId)a.before(d),tdcOperationUI.updateInfoHelper(e);parseInt(n.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:"","margin-top":"0","margin-left":"",
bottom:"",width:k}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:k})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcInnerRowUI._elementCssClass}}})(jQuery,Backbone,_);var tdcInnerColumnUI;
...
a.find(".tdc-elements:first");if(b.length){var e=b.outerHeight(!0);b=b.outerWidth();var d=a.offset(),m=0,g=a.prevAll("."+tdcInnerColumnUI._elementCssClass);g.length&&g.each(function(a,c){m+=parseInt(f(c).find(".tdc-elements:first").width())});m+=d.left;parseInt(m)<=parseInt(c.pageX)&&parseInt(c.pageX)<=parseInt(m+b)&&parseInt(d.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(d.top+e)&&(tdcOperationUI.setCurrentElementOver(a),tdcInnerColumnUI.positionInnerColumnPlaceholder(c))}}}).on("contextmousedown",
function(c){c.preventDefault();c.stopPropagation();tdcContextMenu.setContextMenu(c,a)&&(tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(a),$currentRow:tdcOperationUI.inRow(a),$currentColumn:tdcOperationUI.inColumn(a),$currentInnerRow:tdcOperationUI.inInnerRow(a),$currentInnerColumn:tdcOperationUI.inInnerColumn(a)}),tdcOperationUI.activeElementOver(a))})},positionInnerColumnPlaceholder:function(a,c){var d=tdcAdminWrapperUI.$placeholder,k=0,l=0;if("mousedown"===a.type||"mousemove"===a.type||
"fakemouseenterevent"===a.type)k=a.pageX,l=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){k=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;l=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var m={pageX:k,pageY:l};tdcOperationUI.setCurrentElementOver(e);tdcOperationUI.getDraggedElement().closest(".tdc-inner-columns").find(".tdc-inner-column").each(function(a,
c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",m))});return}a=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(a))tdcOperationUI.hidePlaceholder();else{l=a.outerWidth(!0);var g=a.offset(),n=0,p=a.prevAll();p.length&&p.each(function(a,c){a=f(c);a.hasClass("tdc-inner-column")&&(n+=parseInt(a.outerWidth(!0)))});p=a.parent(".tdc-inner-columns").parent(".vc_row_inner").css("padding-left");p=
b.isUndefined(p)?0:parseInt(p.replace("px",""));if(k>g.left+l/2){k=a.next();if(!k.length||k.length&&k.attr("id")!==tdcAdminWrapperUI.placeholderId)a.after(d),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+l+p),"margin-left":-24})}else{k=a.prev();if(!k.length||k.length&&k.attr("id")!==tdcAdminWrapperUI.placeholderId)a.before(d),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+p),"margin-left":-24})}b.isUndefined(c)||
...
(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){d.X=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;d.Y=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var k={pageX:d.X,pageY:d.Y};tdcOperationUI.setCurrentElementOver(e);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",k))});return}var l=tdcOperationUI.getCurrentElementOver();
if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(l))tdcOperationUI.hidePlaceholder();else{var m=tdcOperationUI.getCurrentElementOverOuterHeight();a=tdcOperationUI.getCurrentElementOverOuterWidth();var g=tdcOperationUI.getCurrentElementOverOffset(),n=tdcOperationUI.getCurrentElementOverHeight(),p=!1;"inline-block"===l.css("display")&&(p=!0);p?(m=tdcOperationUI.getCurrentElementOverPosition(),p=parseInt(l.css("margin-top")),d.Y>g.top+n/2?(d=tdcElementUI._checkInnerColumnLastElement(d),
b.isUndefined(d.elementOuterWidth)||(a=d.elementOuterWidth),parseInt(g.top)+parseInt(n)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?(g=parseInt(g.left),d.isInnerColumnLastElement&&(l=l.closest(".tdc-element-inner-row"),g=parseInt(l.offset().left)-parseInt(l.css("margin-left"))),tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:g,"margin-top":"","margin-left":"",bottom:"0",width:a})):(g=parseInt(m.left),d.isInnerColumnLastElement&&(l=l.closest(".tdc-element-inner-row"),
g=parseInt(l.position().left)+parseInt(l.css("margin-left"))),tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:m.top+p+n,left:g,"margin-top":"","margin-left":"",bottom:"",width:a}))):(d=tdcElementUI._checkInnerColumnFirstElement(d),b.isUndefined(d.elementOuterWidth)||(a=d.elementOuterWidth),parseInt(g.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?(g=parseInt(g.left)-parseInt(l.css("margin-left")),tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:g,"margin-top":"0",
"margin-left":"",bottom:"",width:a})):(g=parseInt(m.left),tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:m.top+p,left:g,"margin-top":"","margin-left":"",bottom:"",width:a})))):d.Y>g.top+n/2?(d=tdcElementUI._checkInnerColumnLastElement(d),b.isUndefined(d.elementOuterWidth)||(a=d.elementOuterWidth),parseInt(g.top)+parseInt(m)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"",
"margin-left":"",bottom:"0",width:a}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:a})):(d=tdcElementUI._checkInnerColumnFirstElement(d),b.isUndefined(d.elementOuterWidth)||(a=d.elementOuterWidth),parseInt(g.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:"","margin-top":"0","margin-left":"",bottom:"",width:a}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",
top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:a}));b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},_checkInnerColumnFirstElement:function(a){var c={isInnerColumnFirstElement:!1},b=tdcAdminWrapperUI.$placeholder,d=tdcOperationUI.getCurrentElementOver(),l=tdcOperationUI.getCurrentElementOverOffset();tdcElementUI.isInnerColumnFirstElement(d)&&a.Y<l.top+tdcElementUI._innerColumnGap&&(c.isInnerColumnFirstElement=!0);if(c.isInnerColumnFirstElement){if(d=
d.closest(".tdc-element-inner-row"),c.elementOuterWidth=d.outerWidth(!0),a=d.prev(),!a.length||a.length&&a.attr("id")!==tdcAdminWrapperUI.placeholderId)d.before(b),tdcOperationUI.updateInfoHelper(e)}else if(a=d.prev(),!a.length||a.length&&a.attr("id")!==tdcAdminWrapperUI.placeholderId)d.before(b),tdcOperationUI.updateInfoHelper(e);return c},_checkInnerColumnLastElement:function(a){var c={isInnerColumnLastElement:!1},b=tdcAdminWrapperUI.$placeholder,d=tdcOperationUI.getCurrentElementOver(),l=tdcOperationUI.getCurrentElementOverHeight(),
m=tdcOperationUI.getCurrentElementOverOffset();tdcElementUI.isInnerColumnLastElement(d)&&a.Y>m.top+l-tdcElementUI._innerColumnGap&&(c.isInnerColumnLastElement=!0);if(c.isInnerColumnLastElement){if(d=d.closest(".tdc-element-inner-row"),c.elementOuterWidth=d.outerWidth(!0),a=d.next(),!a.length||a.length&&a.attr("id")!==tdcAdminWrapperUI.placeholderId)d.after(b),tdcOperationUI.updateInfoHelper(e)}else if(a=d.next(),!a.length||a.length&&a.attr("id")!==tdcAdminWrapperUI.placeholderId)d.after(b),tdcOperationUI.updateInfoHelper(e);
return c},positionEmptyElementPlaceholder:function(a){var c=tdcAdminWrapperUI.$placeholder,d=0,k=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)d=a.pageX,k=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){d=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;k=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var l=
{pageX:d,pageY:k};tdcOperationUI.setCurrentElementOver(e);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",l))});return}var m=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(m))tdcOperationUI.hidePlaceholder();else{var g=tdcOperationUI.getCurrentElementOverOuterHeight();a=tdcOperationUI.getCurrentElementOverOuterWidth();d=tdcOperationUI.getCurrentElementOverOffset();
if(k>d.top+g/2){var n=!1;tdcElementUI.isInnerColumnLastElement(m)&&k>d.top+g-tdcElementUI._innerColumnGap&&(n=!0);n?(m=m.closest(".tdc-element-inner-row"),a=m.outerWidth(!0),k=m.next(),k.length||(m.after(c),tdcOperationUI.updateInfoHelper(e))):(k=m.next(),k.length||(m.after(c),tdcOperationUI.updateInfoHelper(e)));parseInt(d.top)+parseInt(g)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"",
"margin-left":"",bottom:0,width:a}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":-50,"margin-left":"",bottom:"",width:a})}else g=!1,tdcElementUI.isInnerColumnFirstElement(m)&&k<d.top+tdcElementUI._innerColumnGap&&(g=!0),g?(m=m.closest(".tdc-element-inner-row"),a=m.outerWidth(!0),k=m.prev(),k.length||(m.before(c),tdcOperationUI.updateInfoHelper(e))):(k=m.prev(),k.length||(m.before(c),tdcOperationUI.updateInfoHelper(e))),parseInt(d.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?
...
(e=tdcMaskUI.$currentContainer,c="tdc-content-row"):tdcOperationUI.isColumn(tdcMaskUI.$currentContainer)?(e=tdcMaskUI.$currentContainer.find(".tdc-elements:first"),c="tdc-content-column"):tdcOperationUI.isInnerRow(tdcMaskUI.$currentContainer)?(e=tdcMaskUI.$currentContainer,c="tdc-content-inner-row"):tdcOperationUI.isInnerColumn(tdcMaskUI.$currentContainer)&&(e=tdcMaskUI.$currentContainer.find(".tdc-elements:first"),c="tdc-content-inner-column");if(e.length){var d=e.offset();a=d.top;d=d.left;var l=
e.outerWidth();e=e.outerHeight(!0);tdcMaskUI.$content.css({top:a,left:d,width:l,height:e});tdcMaskUI.$content.attr("class",c);tdcMaskUI.$content.show();tdcMaskUI.$contentFull.hide();e=tdcMaskUI.$currentContainer.data("model_id");b.isUndefined(e)||(e=tdcIFrameData.getModel(e),tdcSidebar.setSidebarInfo(e.get("tag")))}}},setCurrentElement:function(a){if(tdcMaskUI._isInitialized&&!tdcSidebar.mouseOverSidebar)if(tdcMaskUI.$currentElement=a,b.isUndefined(tdcMaskUI.$currentElement))tdcMaskUI.$wrapper.hide(),
tdcMaskUI.$content.hide(),tdcMaskUI.$contentFull.hide();else{a=tdcMaskUI.$currentElement.closest(".tdc-zone").offset();var c=tdcMaskUI.$currentElement.offset(),e=tdcMaskUI.$currentElement.outerWidth(),d=tdcMaskUI.$currentElement.outerWidth(!0),l=tdcMaskUI.$currentElement.outerHeight(),m=tdcMaskUI.$currentElement.outerHeight(!0),g=tdcMaskUI.$currentElement.css("margin-top"),f=tdcMaskUI.$currentElement.css("margin-left");12>Math.abs(a.top-c.top)?tdcMaskUI.$wrapper.addClass("tdc-mask-top"):tdcMaskUI.$wrapper.removeClass("tdc-mask-top");
tdcMaskUI.$wrapper.css({top:c.top,left:c.left,width:e,height:l});tdcMaskUI.$content.css({top:c.top,left:c.left,width:e,height:l});tdcMaskUI.$contentFull.css({top:c.top-parseFloat(g),left:c.left-parseFloat(f),width:d,height:m});tdcMaskUI.$content.removeAttr("class");tdcMaskUI.$wrapper.show();tdcMaskUI.$content.show();tdcMaskUI.$contentFull.show();tdcMaskUI.setHandlers();a=tdcMaskUI.$currentElement.data("model_id");b.isUndefined(a)||(a=tdcIFrameData.getModel(a),c=a.get("attrs"),b.has(c,"custom_title")?
...
!0,!1);else{a=tdcIFrameData.getModel(a);var c=a.get("parentModel"),d=c.get("childCollection");if(b.isUndefined(a))new tdcNotice.notice("tdcRowHandlerUI -> tdcRowHandlerUI._$handlerClone Error: Element model not in structure data!",!0,!1);else{tdcOperationUI.setDraggedElement(f('<div class="tdc-row">Cloned row</div>'));var l=tdcOperationUI.getDraggedElement();l.insertAfter(tdcRowHandlerUI.$elementRow);tdcRowUI.bindRow(l);var m=l.prevAll(".tdc-row").length;c=new tdcIFrameData.TdcModel({content:"",attrs:b.clone(a.get("attrs")),
tag:"vc_row",type:"closed",level:1,parentModel:c});new tdcIFrameData.TdcLiveView({model:c,el:l[0]});var g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:c});l.data("model_id",c.cid);d.add(c,{at:m});d=new tdcIFrameData.TdcCollection;d.add(g);c.set("childCollection",d);g.set("childCollection",new tdcIFrameData.TdcCollection);c.getShortcodeRender(3,"",!0,a);tdcOperationUI.setDraggedElement(e);tb_remove()}}},[a],"Are you sure you want to clone the current row and all its elements?"),
...
!0,!1);else{tdcOperationUI.setDraggedElement(f('<div class="tdc-element-column tdc-element-inner-row">Cloned Inner Row</div>'));var c=tdcOperationUI.getDraggedElement();c.insertAfter(tdcInnerRowHandlerUI.$elementInnerRow);tdcInnerRowUI.bindInnerRow(c);var d=c.prevAll(".tdc-element-column").length,l=new tdcIFrameData.TdcModel({content:"",attrs:b.clone(a.get("attrs")),tag:"vc_row_inner",type:"closed",level:2,parentModel:a.get("parentModel")});new tdcIFrameData.TdcLiveView({model:l,el:c[0]});var m=new tdcIFrameData.TdcModel({content:"",
attrs:{},tag:"vc_column_inner",type:"closed",level:3,parentModel:l});c.data("model_id",l.cid);a.get("parentModel").get("childCollection").add(l,{at:d});c=new tdcIFrameData.TdcCollection;c.add(m);l.set("childCollection",c);c=new tdcIFrameData.TdcCollection;m.set("childCollection",c);m=tdcIFrameData._getDestinationCol(tdcOperationUI.getDraggedElement());l.getShortcodeRender(m,"",!0,a);tdcOperationUI.setDraggedElement(e);tb_remove()}},[a],"Are you sure you want to clone the current inner row and all its elements?")},
deleteHandler:function(a){null!==a&&a.preventDefault();tdConfirm.showModal("Delete inner row",tdcInnerRowHandlerUI,function(){tdcOperationUI.setDraggedElement(tdcInnerRowHandlerUI.$elementInnerRow);tdcOperationUI.setCurrentElementOver(tdcAdminWrapperUI.$recycle);var a=tdcOperationUI.getDraggedElement(),d=tdcAdminWrapperUI.$placeholder;a=a.closest(".tdc-elements");var k=a.children();d=k.index(d);if(-1===d&&1===k.length||2===k.length&&-1!==d)d="",b.isUndefined(tdcElementHandlerUI.$element)&&(tdcElementHandlerUI.$element=
...
!1);else if(a=tdcIFrameData.getModel(a),b.isUndefined(a))new tdcNotice.notice("tdcElementHandlerUI -> tdcElementHandlerUI._$handlerClone Error: Element model not in structure data!",!0,!1);else{var c=a.clone(),d=a.get("parentModel").get("childCollection");d.add(c,{at:d.indexOf(a)+1,silent:!0});tdcOperationUI.setDraggedElement(f('<div class="tdc-element">Cloned Element</div>'));d=tdcOperationUI.getDraggedElement();d.insertAfter(tdcElementHandlerUI.$element);tdcElementUI.bindElement(d);var k=tdcIFrameData._getDestinationModel(tdcOperationUI.getDraggedElement(),
[".tdc-inner-column",".tdc-column"]);b.isUndefined(k)&&new tdcNotice.notice("tdcElementHandlerUI -> tdcElementHandlerUI._$handlerClone Error: Destination model not in structure data!",!0,!1);k=tdcIFrameData._getDestinationCol(tdcOperationUI.getDraggedElement());new tdcIFrameData.TdcLiveView({model:c,el:d[0]});d.data("model_id",c.cid);c.getShortcodeRender(k,"",!0,a);tdcOperationUI.setDraggedElement(e)}},setElement:function(a){!b.isUndefined(a)&&tdcOperationUI.isElement(a)?(tdcElementHandlerUI.$element=
...
(tdcSidebar.$_headerTemplateZones.show(),tdcSidebar.$_sidebar.find(".tdu-save-header-template").show());""===tdcState.getFooterTemplateId()?tdcSidebar.$_sidebar.find(".tdu-save-footer-template").hide():"no_footer"===tdcState.getFooterTemplateId()?tdcSidebar.$_sidebar.find(".tdu-save-footer-template").hide():tdcSidebar.$_sidebar.find(".tdu-save-footer-template").show();tdcIFrameData.addDummyContent();tdcIFrameData._isInitialized=!0;tdcRecycle.init()}},activateZone:function(a,c,d){tdcIFrameData.iframeContents.find(".tdc-zone").each(function(h){h=
f(this);if(h.data("type")===a){var k=h.data("model_id");if(!b.isUndefined(k)&&(k=tdcIFrameData.getModel(k),!b.isUndefined(k))){var m=k.get("blockUid");if(!b.isUndefined(m)){var g=tdcAdminIFrameUI.getLiveIframe(),n=g.contents().find("#"+m);n.length||(n=g.contents().find('[data-td-block-uid="'+m+'"]'));n.length&&(m={},tdcOperationUI.inRow(n)?tdcOperationUI.inRow(n)?tdcOperationUI.inColumn(n)?tdcOperationUI.inInnerRow(n)?tdcOperationUI.inInnerColumn(n)?(m.$currentZone=tdcOperationUI.inZone(n),m.$currentRow=
tdcOperationUI.inRow(n),m.$currentColumn=tdcOperationUI.inColumn(n),m.$currentInnerRow=tdcOperationUI.inInnerRow(n),m.$currentInnerColumn=tdcOperationUI.inInnerColumn(n),m.$currentElement=n):(m.$currentZone=tdcOperationUI.inZone(n),m.$currentRow=tdcOperationUI.inRow(n),m.$currentColumn=tdcOperationUI.inColumn(n),m.$currentInnerRow=tdcOperationUI.inInnerRow(n),m.$currentInnerColumn=n):(m.$currentZone=tdcOperationUI.inZone(n),m.$currentRow=tdcOperationUI.inRow(n),m.$currentColumn=tdcOperationUI.inColumn(n),
m.$currentInnerRow=n):(m.$currentZone=tdcOperationUI.inZone(n),m.$currentRow=tdcOperationUI.inRow(n),m.$currentColumn=n):(m.$currentZone=tdcOperationUI.inZone(n),m.$currentRow=n):m.$currentZone=n,tdcSidebar._currentModel=k,n.data("model_id",k.cid),tdcSidebar.setSettings(m,!0,k),tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-phone").trigger("click"),0<a.indexOf("sticky")?(0<a.indexOf("mobile")?tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-phone").trigger("click"):
"phone"===tdcSidebar.currentViewportSettings.name&&tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-all").trigger("click"),b.isUndefined(c)||(!0===c?(tdcSidebar.setForcedHeaderZone(a),h.parent().addClass("tdc-zone-sticky-active"),h.parent().removeClass("tdc-zone-sticky-inactive"),h.parent().removeClass("tdc-zone-sticky-invisible"),b.isUndefined(d)||!0!==d||(setTimeout(function(){tdcIFrameData.addDummyContent()},100),setTimeout(function(){tdcIFrameData.iframeContents.scrollTop(tdcAdminIFrameUI.getIframeWindow().tdHeader.getFixedHeaderHeight()+
...
tdcSidebar.setForcedHeaderZone(e),b.isUndefined(d)||!0!==d||(setTimeout(function(){tdcIFrameData.addDummyContent()},100),setTimeout(function(){tdcIFrameData.iframeContents.scrollTop(0)},200))))}}}})},addDummyContent:function(){tdcIFrameData.iframeContents.find(".tdc-zone").each(function(a){if("tdc_content"===f(this).data("type")){a=tdcIFrameData.iframeContents.find(".tdc-dummy-content");var c=tdcIFrameData.iframeContents.contents().find("body"),b=c.height()-tdcAdminIFrameUI.getIframeWindow().innerHeight,
...
c,d,k){var h=tdcIFrameData.getFirstModelByZoneType(a);if(!b.isUndefined(h)){var m=h.get("blockUid");tdcIFrameData.removeModel(h,!0,{silent:!0});h=tdcIFrameData._getOriginalContentJSON(c);if(b.isUndefined(h)||""===h)h=[{child:[tdcShortcodeParser.parse(0,'[tdc_zone type="'+a+'"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]')[0].child[0]],index:0,content:'[tdc_zone type="'+a+'"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]',shortcode:{tag:"tdc_zone",type:"closed",attrs:{named:{type:a}},content:"[vc_row][vc_column][/vc_column][/vc_row]"}}];
if(tdcIFrameData._initComponentData(a,h,!0)){h=tdcIFrameData.getFirstModelByZoneType(a);a=tdcIFrameData.iframeContents.find("#"+m);if(!a.length)return!1;c=a.get(0);a.data("model_id",h.cid);h.set("blockUid",m);h.set("html",c.innerHTML);new tdcIFrameData.TdcLiveView({model:h,el:c});b.isUndefined(d)||tdcIFrameData._checkModelData(h,{error:e,getShortcode:"",newImages:d});h.getShortcodeRender(3,m,!0,e,k)}return!0}return!1},setHeaderTemplate:function(a,c,d){if(""===a)tdcState.isNoHeader()?tdcIFrameData.iframeContents.find(".tdc-header-wrap").addClass("tdc-zone-invisible"):
tdcIFrameData.iframeContents.find(".tdc-header-wrap").removeClass("tdc-zone-invisible"),tdcIFrameData.iframeContents.find(".td-header-desktop-wrap, .td-header-desktop-sticky-wrap, .td-header-mobile-wrap, .td-header-mobile-sticky-wrap").addClass("tdc-zone-invisible"),tdcSidebar.$_headerTemplateZones.hide(),tdcSidebar.$_sidebar.find(".tdu-save-header-template").hide(),b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot?(tdcRecycle.init(),tdcRecycle.takeSnapshot()):"Newspaper"===window.tdcAdminSettings.themeName&&
["tdc_header_desktop","tdc_header_desktop_sticky","tdc_header_mobile","tdc_header_mobile_sticky"].forEach(function(a,c){var h;b.isUndefined(d)||(h=JSON.parse(JSON.stringify(d)));"tdc_header_mobile_sticky"!==a||b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot||(b.isUndefined(h)&&(h={}),h.lateCallback=function(){var a=f(tdcAdminIFrameUI._$liveIframe).contents();tdcIFrameData.init(a,!0);tdcRecycle.clearJsItems();tdcOperationUI.init(a);b.isUndefined(h.indexPath)||tdcSidebarPanel.showShortcodeFromPath(h.indexPath)});
tdcIFrameData.rebuildZone(a,"[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]",e,h)});else{var h=JSON.parse(tdcUtil.b64DecodeUnicode(a));tdcIFrameData.iframeContents.find(".tdc-header-wrap").addClass("tdc-zone-invisible");tdcIFrameData.iframeContents.find(".td-header-desktop-wrap, .td-header-desktop-sticky-wrap, .td-header-mobile-wrap, .td-header-mobile-sticky-wrap").removeClass("tdc-zone-invisible");tdcSidebar.$_headerTemplateZones.show();tdcSidebar.$_sidebar.find(".tdu-save-header-template").show();
"Newspaper"===window.tdcAdminSettings.themeName&&["tdc_header_desktop","tdc_header_desktop_sticky","tdc_header_mobile","tdc_header_mobile_sticky"].forEach(function(a,e){if(h.hasOwnProperty(a)){if(!b.isUndefined(d))var k=JSON.parse(JSON.stringify(d));"tdc_header_mobile_sticky"!==a||b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot||(b.isUndefined(k)&&(k={}),k.lateCallback=function(){var a=f(tdcAdminIFrameUI._$liveIframe).contents();tdcIFrameData.init(a,!0);tdcRecycle.clearJsItems();tdcOperationUI.init(a);
b.has(d,"data")&&b.has(data,"replyJsForEval")&&tdcAdminIFrameUI.evalInIframe(d.data.replyJsForEval);b.isUndefined(k.indexPath)||tdcSidebarPanel.showShortcodeFromPath(k.indexPath)});tdcIFrameData.rebuildZone(a,h[a],c,k)}});"header"===window.tdcPostSettings.tdbTemplateType&&tdcSavePost.updateHeaderTemplate()}},setFooterTemplate:function(a,c,d){if(""===a)if(tdcState.isNoFooter()?tdcIFrameData.iframeContents.find(".tdc-footer-wrap").addClass("tdc-zone-invisible"):tdcIFrameData.iframeContents.find(".tdc-footer-wrap").removeClass("tdc-zone-invisible"),
tdcIFrameData.iframeContents.find(".td-footer-wrap").addClass("tdc-zone-invisible"),tdcSidebar.$_sidebar.find(".tdu-save-footer-template").hide(),b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot)tdcRecycle.init(),tdcRecycle.takeSnapshot();else{if("Newspaper"===window.tdcAdminSettings.themeName){if(!b.isUndefined(d))var h=JSON.parse(JSON.stringify(d));tdcIFrameData.rebuildZone("tdc_footer","[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]",e,h)}}else tdcIFrameData.iframeContents.find(".tdc-footer-wrap").addClass("tdc-zone-invisible"),
tdcIFrameData.iframeContents.find(".td-footer-wrap").removeClass("tdc-zone-invisible"),tdcSidebar.$_sidebar.find(".tdu-save-footer-template").show(),"Newspaper"===window.tdcAdminSettings.themeName&&(b.isUndefined(d)||(h=JSON.parse(JSON.stringify(d))),tdcIFrameData.rebuildZone("tdc_footer",a,c,h)),"footer"===window.tdcPostSettings.tdbTemplateType&&tdcSavePost.updateFooterTemplate()},_callbackShortcodeRender:function(a){b.isUndefined(a)||b.isUndefined(a.lateCallback)||(b.isUndefined(a.lateCallbackContext)?
setTimeout(function(){a.lateCallback.call(this)},2E3):setTimeout(function(){a.lateCallback.call(a.lateCallbackContext)},2E3))},_defineStructuredData:function(){tdcIFrameData._isInitialized||(tdcIFrameData.TdcModel=Backbone.Model.extend({getShortcodeRender:function(a,c,d,k,l){var h=this,g={error:e,getShortcode:""};b.isUndefined(k)?tdcIFrameData._checkModelData(h,g):tdcIFrameData._checkModelData(k,g);if(!b.isUndefined(g.getShortcode)){var f=new tdcJobManager.job;f.shortcode=g.getShortcode;f.columns=
a;f.blockUid=c;f.tries=0;f.success_callback=function(a){tdcDebug.log(a);var m=tdcAdminIFrameUI.getIframeWindow();b.isUndefined(k)&&tdcIFrameData.deleteCallback(h);!1===d?h.set("blockUid",a.blockUid):h.set("blockUid",e);b.has(a,"replyHtml")&&(h.set("bindNewContent",d),h.set("shortcode",f.shortcode),h.set("html",a.replyHtml,l));b.has(a,"replyJsForEval")&&(m.tdcEvalGlobal={oldBlockUid:c},tdcAdminIFrameUI.evalInIframe(a.replyJsForEval));b.isUndefined(l)||b.isUndefined(l.earlyCallback)||(b.isUndefined(l.earlyCallbackContext)?
l.earlyCallback.call(this):l.earlyCallback.call(l.earlyCallbackContext))};b.isUndefined(l)||b.isUndefined(l.is_snapshot)||!0!==l.is_snapshot||(f.is_snapshot=!0);f.error_callback=function(a,c){tdcDebug.log(c);tdcDebug.log(a);f.tries||(f.tries++,tdcJobManager.addJob(f))};a=tdcOperationUI.getDraggedElement();b.isUndefined(a)||a.addClass("tdc-dropped");tdcJobManager.addJob(f)}g={error:e,getShortcode:""};tdcIFrameData._checkModelData(h,g);b.isUndefined(g.error)||tdcDebug.log(g.error);g={error:e,getShortcode:""};
b.isUndefined(h.get("parentModel"))||(tdcIFrameData._checkModelData(h.get("parentModel"),g),b.isUndefined(g.error)||tdcDebug.log(g.error))}}),tdcIFrameData.TdcCollection=Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcTopCollection=Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcLiveView=Backbone.View.extend({initialize:function(){this.listenTo(this.model,"change:current",this.changeCurrent);this.listenTo(this.model,"change:html",this.customRender);
...
c.length&&0===parseInt(c.outerHeight(!0))&&c.addClass("tdc-block-empty");if(this.model.has("bindNewContent")&&!0===this.model.get("bindNewContent"))if(this.model.set("bindNewContent",!1,{silent:!0}),this.$el.hasClass("tdc-element-inner-row-temp")){if(a.has("templateContent")){c=tdcUtil.b64DecodeUnicode(a.get("templateContent"));var h=this.$el.find(".tdc-inner-row");a.set("type","closed");a.set("content",c);a.unset("shortcode",{silent:!0});a.unset("templateContent",{silent:!0});tdcShortcodeParser.init(tdcIFrameData._shortcodeParserSettingsClone);
var l=tdcShortcodeParser.parse(2,c);l.length&&(l=b.clone(l[0].shortcode.attrs.named),a.set("attrs",l));this.$el.removeClass("tdc-element-inner-row-temp").addClass("tdc-element-inner-row");this.model.set("blockUid",h.attr("id"));window.addInnerRowWrappers(this.$el);if(!0===tdcIFrameData._initNewContentStructureData(4,c,a)){var m=a.get("childCollection"),g={};tdcIFrameData.bindViewsModelsWrappers(g,m,this.$el,4);if(!b.isEmpty(g)){for(var n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
!0,!1);return}}}else if(h=this.$el.find(".tdc-inner-row"),m=a.get("childCollection"),this.$el.removeClass("tdc-element-inner-row-temp").addClass("tdc-element-inner-row"),this.model.set("blockUid",h.attr("id")),window.addInnerRowWrappers(this.$el),!b.isUndefined(m)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,m,this.$el,4),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcInnerRowUI.init(this.$el.parent());
tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),$currentInnerRow:tdcOperationUI.inInnerRow(this.$el)},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-element-inner-row")){h=this.$el.find(".tdc-inner-row");m=this.model.get("childCollection");b.isUndefined(m)||m.reset();window.addInnerRowWrappers(this.$el);
this.model.set("blockUid",h.attr("id"));var p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(4,p,a)&&(m=this.model.get("childCollection"),!b.isUndefined(m)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,m,this.$el,4),!b.isEmpty(g)))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),
$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),$currentInnerRow:tdcOperationUI.inInnerRow(this.$el)},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-cloud-temp")){if(this.model.has("templateContent")){var q=this;c=q.model.get("templateContent");n=q.$el.find(".tdc-row");tdcShortcodeParser.init(tdcIFrameData._shortcodeParserSettingsClone);c=tdcShortcodeParser.parse(1,tdcUtil.b64DecodeUnicode(c));if(c.length!==n.length){new tdcNotice.notice("Errors happened in templateContent(content.length!==$tdcRows.length) during tdcIFrameData.TdcLiveView -> customRender!",
!0,!1);return}a=tdcIFrameData.getFirstModelByZoneType("tdc_content");b.isUndefined(a)&&new tdcNotice.notice("Errors happened in templateContent during tdc_content zone!",!0,!1);m=a.get("childCollection");b.isUndefined(m)&&new tdcNotice.notice("Errors happened in templateContent during tdc_content childCollection!",!0,!1);m=new tdcIFrameData.TdcCollection;a.set("childCollection",m);g={};b.each(c,function(c,b,e){tdcIFrameData._getData(a,c,g)});b.isEmpty(g)||(tdcDebug.log(g),new tdcNotice.notice("Errors happened in templateContent during tdcIFrameData.changeData() -> _getData()!",
!0,!1));c={error:e,shortcode:e};tdcIFrameData.checkCurrentData(c);b.isUndefined(c.error)||(tdcDebug.log(c.error),new tdcNotice.notice(g,!0,!1));m=a.get("childCollection");if(n.length!==m.length){new tdcNotice.notice("Errors happened in templateContent during() tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}q.$el.find(".tdc-row").each(function(a,c){var e=f(c);e.insertBefore(q.$el);a=m.at(a);new tdcIFrameData.TdcLiveView({model:a,el:c});var d=q.$el.prevAll().length;c=a.get("childCollection");
m.add(a,{at:d});window.addRowWrappers(e);if(!0===tdcIFrameData._initNewContentStructureData(2,p,a)&&!b.isUndefined(c))if(d={},tdcIFrameData.bindViewsModelsWrappers(d,c,e,2),b.isEmpty(d))e.data("model_id",a.cid);else{for(var h in d)tdcDebug.log(d[h]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1)}});a.set("childCollection",m);n=tdcOperationUI.inZone(q.$el);q.$el.remove();tdcIFrameData.removeModel(q.model);tdcZoneUI.init(h);tdcRowUI.init(h);tdcColumnUI.init(h);
tdcInnerRowUI.init(h);tdcInnerColumnUI.init(h);tdcElementUI.init(h);tdcSidebar.setSettings({$currentZone:n,$currentRow:h},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}}else if(this.$el.hasClass("tdc-row-temp")){if(a.has("templateContent")){c=tdcUtil.b64DecodeUnicode(a.get("templateContent"));h=this.$el.find(".tdc-row");m=a.get("childCollection");a.set("type","closed");a.set("content",c);a.unset("shortcode",{silent:!0});a.unset("templateContent",{silent:!0});tdcShortcodeParser.init(tdcIFrameData._shortcodeParserSettingsClone);
l=tdcShortcodeParser.parse(1,c);l.length&&(l=b.clone(l[0].shortcode.attrs.named),a.set("attrs",l));this.$el.removeClass("tdc-row-temp").addClass(h.attr("class"));this.$el.attr("id",h.attr("id"));this.$el.html(h.html());this.model.set("blockUid",h.attr("id"));window.addRowWrappers(this.$el);if(!0===tdcIFrameData._initNewContentStructureData(2,c,a)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,m,this.$el,2),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
!0,!1);return}tdcRowUI.init(this.$el.parent());tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:this.$el},e,this.model)}else{h=this.$el.find(".tdc-row");m=a.get("childCollection");this.$el.removeClass("tdc-row-temp").addClass(h.attr("class"));this.$el.attr("id",h.attr("id"));this.$el.html(h.html());this.model.set("blockUid",h.attr("id"));window.addRowWrappers(this.$el);g={};tdcIFrameData.bindViewsModelsWrappers(g,
m,this.$el,2);if(!b.isEmpty(g)){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcRowUI.init(this.$el.parent());tdcColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(c),$currentRow:this.$el,$currentColumn:tdcOperationUI.inColumn(c),$currentElement:c},e,this.model)}tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-zone")){h=this.$el.find(".tdc-zone");
m=this.model.get("childCollection");b.isUndefined(m)||m.reset();this.$el.html(h.html());this.$el.attr("class",h.attr("class"));this.$el.attr("id",h.attr("id"));this.model.set("blockUid",h.attr("id"));window.addZoneWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(1,p,this.model)&&!b.isUndefined(m)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,m,this.$el,1),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
!0,!1);return}tdcRowUI.init(this.$el);tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:this.$el});tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-row")){h=this.$el.find(".tdc-row");m=this.model.get("childCollection");b.isUndefined(m)||m.reset();this.$el.html(h.html());this.$el.attr("class",h.attr("class"));this.$el.attr("id",h.attr("id"));this.model.set("blockUid",h.attr("id"));
window.addRowWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(2,p,this.model)&&!b.isUndefined(m)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,m,this.$el,2),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),
$currentRow:this.$el},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-column")){a.has("templateContent")&&(c=tdcUtil.b64DecodeUnicode(a.get("templateContent")),a.set("type","closed"),a.unset("templateContent",{silent:!0}));h=this.$el.find(".tdc-column");m=this.model.get("childCollection");b.isUndefined(m)||m.reset();h.unwrap();this.$el=h;this.$el.data("model_id",this.model.cid);window.addColumnWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(3,
p,this.model)&&(m=this.model.get("childCollection"),!b.isUndefined(m)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,m,this.$el,3),!b.isEmpty(g)))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcColumnUI.init(this.$el.parent());tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),$currentRow:tdcOperationUI.inRow(this.$el),
$currentColumn:this.$el},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-inner-row")){h=this.$el.find(".tdc-inner-row");m=this.model.get("childCollection");b.isUndefined(m)||m.reset();this.$el.html(h.html());window.addInnerRowWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(3,p,this.model)&&!b.isUndefined(m)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,m,this.$el,3),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);
...
a.set("type","closed"),a.unset("templateContent",{silent:!0}));h=this.$el.find(".tdc-inner-column");m=this.model.get("childCollection");b.isUndefined(m)||m.reset();h.unwrap();this.$el=h;this.$el.data("model_id",this.model.cid);window.addInnerColumnWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(5,p,this.model)&&(m=this.model.get("childCollection"),!b.isUndefined(m)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,m,this.$el,5),!b.isEmpty(g)))){for(n in g)tdcDebug.log(g[n]);
new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcInnerColumnUI.init(this.$el.parent());tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),$currentInnerRow:tdcOperationUI.inInnerRow(this.$el),$currentInnerColumn:this.$el},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc_zone")){h=
this.$el.find(".tdc-row");c=this.model.cid;a=tdcIFrameData.getModel(c);m=a.get("childCollection");h.data("model_id",c);this.model.set("blockUid",h.attr("id"));window.addZoneWrappers(this.$el);if(!b.isUndefined(m)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,m,h,2),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcZoneUI.init(this.$el);tdcRowUI.init(this.$el);tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);
tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);this.$el=h;tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),$currentRow:h},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-element")){h=this.$el.attr("class");n=[];b.isUndefined(h)||(n=this.$el.attr("class").split(/\s+/));this.$el.html(this.model.get("html"));h=this.$el.find(".td_block_wrap");h.unwrap();this.$el=h;this.$el.data("model_id",this.model.cid);this.model.set("blockUid",
h.data("td-block-uid"));h=e;this.model.has("rebindToPanel")&&!0===this.model.get("rebindToPanel")&&(this.model.set("rebindToPanel",!1,{silent:!0}),h=!0);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),$currentInnerRow:tdcOperationUI.inInnerRow(this.$el),$currentInnerColumn:tdcOperationUI.inInnerColumn(this.$el),$currentElement:this.$el},h,this.model);tdcIFrameData._callbackShortcodeRender(d);
var t=this;f.each(n,function(a,c){0===c.indexOf("tdc-element")&&t.$el.addClass(c)});tdcElementUI.bindElement(this.$el)}(b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot)&&tdcRecycle.takeSnapshot()}}}))},_getPostOriginalContentJSON:function(a){if(!0===a||b.isUndefined(tdcIFrameData._postOriginalContentJSON)&&!b.isUndefined(window.tdcPostSettings))a=Object.keys(window.tdcAdminSettings.mappedShortcodes),a=a.filter(function(a){return 0>["tdc_zone","vc_row","vc_column","vc_row_inner","vc_column_inner"].indexOf(a)}),
a={0:["tdc_zone"],1:["vc_row"],2:["vc_column"],3:["vc_row_inner"],4:["vc_column_inner"],5:a},tdcIFrameData._shortcodeParserSettingsClone=a,tdcShortcodeParser.init(a),tdcIFrameData._postOriginalContentJSON=tdcShortcodeParser.parse(0,tdcUtil.b64DecodeUnicode(window.tdcPostSettings.postContent));return tdcIFrameData._postOriginalContentJSON},_getOldPostOriginalContentJSON:function(){if(b.isUndefined(tdcIFrameData._postOriginalContentJSON)&&!b.isUndefined(window.tdcPostSettings)){var a=Object.keys(window.tdcAdminSettings.mappedShortcodes);
a=a.filter(function(a){return 0>["vc_row","vc_column","vc_row_inner","vc_column_inner"].indexOf(a)});a={0:["vc_row"],1:["vc_column"],2:["vc_row_inner"],3:["vc_column_inner"],4:a};tdcIFrameData._shortcodeParserSettingsClone=a;tdcShortcodeParser.init(a);tdcIFrameData._postOriginalContentJSON=tdcShortcodeParser.parse(0,tdcUtil.b64DecodeUnicode(window.tdcPostSettings.postContent))}return tdcIFrameData._postOriginalContentJSON},_getOriginalContentJSON:function(a){var c=Object.keys(window.tdcAdminSettings.mappedShortcodes);
...
window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode('[tdc_zone type="tdc_content"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]'),a=tdcIFrameData._getPostOriginalContentJSON(!0));var c={};c.tdc_content=a;a=tdcState.getHeaderTemplateContent();if(""!==a){a=JSON.parse(tdcUtil.b64DecodeUnicode(a));for(var e in a)c[e]=tdcIFrameData._getOriginalContentJSON(a[e])}e=tdcState.getFooterTemplateContent();""!==e&&(c.tdc_footer=tdcIFrameData._getOriginalContentJSON(e));var d=tdcShortcodeParser.parse(0,
"[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]");"tdc_header_desktop tdc_header_desktop_sticky tdc_header_mobile tdc_header_mobile_sticky tdc_content tdc_footer".split(" ").forEach(function(a){if("Newspaper"===window.tdcAdminSettings.themeName||"tdc_content"===a)if(b.isUndefined(c[a])||""===c[a]||"object"===typeof c[a]&&!c[a].length)c[a]=[{child:[d[0].child[0]],index:0,content:'[tdc_zone type="'+a+'"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]',shortcode:{tag:"tdc_zone",type:"closed",
attrs:{named:{type:a}},content:"[vc_row][vc_column][/vc_column][/vc_row]"}}]});for(var l in c)if(c.hasOwnProperty(l)&&!tdcIFrameData._initComponentData(l,c[l]))return;return!0}},_initComponentData:function(a,c,d){if(!b.isUndefined(d)&&!1!==d||!tdcIFrameData._isInitialized){if(c.length){var h={};b.each(c,function(c,b,d){tdcIFrameData._getData(e,c,h,e,a)});b.isEmpty(h)||(console.log(c),tdcDebug.log(h),new tdcNotice.notice("Errors happened during _initStructureData() -> _getData()!",!0,!1));c={error:e,
shortcode:e};tdcIFrameData.checkCurrentData(c);b.isUndefined(c.error)||(tdcDebug.log(c.error),new tdcNotice.notice(h,!0,!1))}return!0}},_initNewContentStructureData:function(a,c,d){c=tdcIFrameData._getContentJSON(a,c);if(c.length){var h={};b.each(c,function(c,b,e){tdcIFrameData._getData(d,c,h,a)});b.isEmpty(h)||(tdcDebug.log(h),new tdcNotice.notice(h,!0,!1));c={error:e,shortcode:e};tdcIFrameData.checkCurrentData(c);b.isUndefined(c.error)||(tdcDebug.log(c.error),new tdcNotice.notice("Errors happened during _initNewContentStructureData() -> checkCurrentData()!",
!0,!1))}return!0},_getData:function(a,c,e,d,l){var h;if(b.isUndefined(a))var k=tdcIFrameData.tdcTopCollection;else k=a.get("childCollection"),b.isUndefined(k)&&(k=new tdcIFrameData.TdcCollection,a.set("childCollection",k));for(var f in tdcIFrameData._shortcodeParserSettingsClone)if(!(!b.isUndefined(d)&&parseInt(d,10)>f||b.isUndefined(c.shortcode))&&b.isObject(c.shortcode)&&b.has(c.shortcode,"tag")&&-1!==b.indexOf(tdcIFrameData._shortcodeParserSettingsClone[f],c.shortcode.tag)){0<parseInt(f,10)&&b.isUndefined(a)&&
(h="Not zones as the first elements!");!b.isUndefined(a)&&parseInt(a.get("level"),10)>=parseInt(f,10)&&(h="Elements does not respect the shortcode levels! ParentModel (cid: "+a.cid+" ) level: "+a.get("level")+" - element level : "+f);!b.isUndefined(a)&&2<parseInt(f,10)-parseInt(a.get("level"),10)&&3!==parseInt(a.get("level"),10)&&5!==parseInt(f,10)&&(h="Elements respect the shortcode levels, but the difference higher than 2 is not allowed here!");b.isUndefined(h)||(e[b.keys(e).length]={element:c,
info:h,parentModel:a});5!==parseInt(f,10)||b.isUndefined(c.shortcode.content)||(d=b.clone(c.shortcode.attrs.named),d.content=c.shortcode.content,c.shortcode.attrs.named=d);f={content:c.content,attrs:c.shortcode.attrs.named,tag:c.shortcode.tag,type:c.shortcode.type,level:parseInt(f,10),parentModel:a,bindNewContent:!1};b.isUndefined(l)||(f.type_zone=l);var p=new tdcIFrameData.TdcModel(f);b.has(c,"child")&&0<c.child.length&&(p.set("childCollection",new tdcIFrameData.TdcCollection),b.each(c.child,function(a,
c,b){tdcIFrameData._getData(p,a,e)}));break}b.isUndefined(p)?e[b.keys(e).length]={element:c,info:"Element not found!",parentModel:a}:b.isUndefined(k)||k.add(p)},getModel:function(a,c){if(tdcIFrameData._isInitialized){var e;b.isUndefined(c)&&(c=tdcIFrameData.tdcTopCollection);b.each(c.models,function(c,d,h){b.isUndefined(e)&&(c.cid===a?e=c:c.has("childCollection")&&(c=c.get("childCollection"),e=tdcIFrameData.getModel(a,c)))});if(!b.isUndefined(e))return e}},getFirstModelByTag:function(a,c){if(tdcIFrameData._isInitialized){var e;
...
a.length&&b.each(a.models,function(a,c,b){tdcIFrameData.deleteCallback(a)})},_checkModelData:function(a,c){if(b.isUndefined(c.error)){var d=a.get("parentModel");if(0!==a.level||b.isUndefined(d))if(!b.isUndefined(d)&&parseInt(d.get("level"),10)>=parseInt(a.level,10))c.error="Elements does not respect the shortcode levels!";else if(!b.isUndefined(d)&&2<parseInt(a.level,10)-parseInt(d.get("level"),10)&&2!==parseInt(d.get("level"),10)&&4!==parseInt(a.level,10))c.error="Elements respect the shortcode levels, but the difference higher than 2 is not allowed here!";
else{!b.isUndefined(c.getShortcode)&&b.isUndefined(c.deepLevel)&&(c.deepLevel=0,c["tempShortcodeDeepLevel"+c.deepLevel]="");if(!b.isUndefined(c.getShortcode)&&a.has("templateContent")&&""!==a.get("templateContent"))c.template=tdcUtil.b64DecodeUnicode(a.get("templateContent"));else if(a.has("childCollection")){b.isUndefined(c.getShortcode)||(c.deepLevel++,c["tempShortcodeDeepLevel"+c.deepLevel]="");var k=a.get("childCollection");b.each(k.models,function(a,b,e){tdcIFrameData._checkModelData(k.get(a.cid),
c)});b.isUndefined(c.getShortcode)||c.deepLevel--}if(!b.isUndefined(c.getShortcode)){d=a.get("type");var l=a.get("tag"),m=a.get("attrs"),g="";if("undefined"!==typeof c.images){var f=b.clone(m);b.map(m,function(a,e){b.map(window.tdcAdminSettings.mappedShortcodes[l].params,function(a,d){if(e===a.param_name)if("attach_image"===a.type)a=m[a.param_name],d=tdcJobManager._getUniqueID(),b.isUndefined(c.images.ids)?(c.images.ids={},c.images.ids[a]=d):b.isUndefined(c.images.ids[a])?c.images.ids[a]=d:d=c.images.ids[a],
f[e]=d;else if("tdc_css"===a.param_name&&""!==m.tdc_css){var h=JSON.parse(window.atob(m.tdc_css));b.map(h,function(a,e){b.map(h[e],function(a,d){if(0===a.trim().indexOf("url")){var k=tdcJobManager._getUniqueID();b.isUndefined(c.images.urls)?(c.images.urls={},c.images.urls[a]=k):b.isUndefined(c.images.urls[a])?c.images.urls[a]=k:k=c.images.urls[a];h[e][d]=k}})});f.tdc_css=window.btoa(JSON.stringify(h))}})});m=f}else"undefined"!==typeof c.newImages&&(f=b.clone(m),b.map(m,function(a,e){b.map(window.tdcAdminSettings.mappedShortcodes[l].params,
function(a,d){if(e===a.param_name)if("attach_image"===a.type){var h=m[a.param_name];a=c.newImages.find(function(a){return h===a.uid.substring(8)});"undefined"!==typeof a&&(f[e]=a.attachment_id)}else if("tdc_css"===a.param_name&&""!==m.tdc_css){var k=JSON.parse(window.atob(m.tdc_css));b.map(k,function(a,e){b.map(k[e],function(a,b){var d=c.newImages.find(function(c){return a===c.uid.substring(8)});"undefined"!==typeof d&&(k[e][b]='url("'+d.url+'")')})});f.tdc_css=window.btoa(JSON.stringify(k))}})}),
m=f,a.set("attrs",m));if("td_block_text_with_title"===l||"vc_column_text"===l||"vc_raw_html"===l||"tdc_woo_shortcodes"===l)if(b.map(m,function(a,c){"content"!==c&&(g+=" "+c+'="'+a+'"')}),b.has(m,"content"))if("vc_raw_html"===l||"tdc_woo_shortcodes"===l)g="["+l+g+"]"+b.unescape(m.content)+"[/"+l+"]";else try{var p=tdcUtil.b64DecodeUnicode(m.content);g="["+l+g+"]"+p+"[/"+l+"]"}catch(q){g="["+l+g+"]"+b.unescape(m.content)+"[/"+l+"]"}else g="["+l+g+"]";else switch(b.map(m,function(a,c){g+=" "+c+'="'+
a+'"'}),d){case "single":g="["+l+g+"]";break;case "closed":a="";b.isUndefined(c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)])||(a=c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)],c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)]=e);g="["+l+g+"]"+a+"[/"+l+"]";break;case "template":g="vc_column"===l||"vc_column_inner"===l?"["+l+g+"]"+c.template+"[/"+l+"]":c.template}c["tempShortcodeDeepLevel"+c.deepLevel]+=g;0===c.deepLevel&&(c.getShortcode+=g)}}else c.error="Not zones as the first elements!"}},
checkCurrentData:function(a){tdcIFrameData._isInitialized&&b.each(tdcIFrameData.tdcTopCollection.models,function(c,b,e){tdcIFrameData._checkModelData(tdcIFrameData.tdcTopCollection.get(c.cid),a)})},changeData:function(a){if(tdcIFrameData._isInitialized){tdcMain.setContentModified();var c=a.$refEl,d=c.prevAll().length;if(a.wasSidebarElementDragged)if(a.wasElementDragged){var k=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-inner-column",".tdc-column"]);b.isUndefined(k)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",
!0,!1);var l=tdcIFrameData._getDestinationCol(a.$refEl);k.has("childCollection")||k.set("childCollection",new tdcIFrameData.TdcCollection);var m=k.get("childCollection");var g={},f=c.data("start-values"),p;"undefined"!==typeof f&&(f=JSON.parse(tdcUtil.b64DecodeUnicode(f)),"undefined"!==typeof f&&(b.isArray(f)&&f.length?(g=f[0],1<f.length&&(p=f)):g=f));f=c.data("shortcodeName");g=new tdcIFrameData.TdcModel({content:"",attrs:g,tag:f,type:"single",level:4,parentModel:k});new tdcIFrameData.TdcLiveView({model:g,
el:c[0]});b.isUndefined(p)||g.set("presetValues",p);tdcElementUI.bindElement(c);tdcRecycle.takeSnapshot(g.get("tag")+" : sidebar element added");c.data("model_id",g.cid);m.add(g,{at:d});g.set("parentModel",k);g.getShortcodeRender(l,a.draggedBlockUid,!0)}else if(a.wasTempInnerRowDragged)tdcRecycle.takeSnapshot("Sidebar inner-row added"),k=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]),b.isUndefined(k)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",
!0,!1),l=tdcIFrameData._getDestinationCol(a.$refEl),k.has("childCollection")||k.set("childCollection",new tdcIFrameData.TdcCollection),m=k.get("childCollection"),f=c.data("templateContent"),b.isUndefined(f)?(k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row_inner",type:"closed",level:3,parentModel:k}),new tdcIFrameData.TdcLiveView({model:k,el:c[0]}),g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",type:"closed",level:4,parentModel:k}),c.data("model_id",k.cid),m.add(k,
{at:d}),c=new tdcIFrameData.TdcCollection,c.add(g),k.set("childCollection",c),c=new tdcIFrameData.TdcCollection,g.set("childCollection",c)):(k=new tdcIFrameData.TdcModel({templateContent:f,attrs:{},tag:"vc_row_inner",type:"template",level:3,parentModel:k}),new tdcIFrameData.TdcLiveView({model:k,el:c[0]}),c.data("model_id",k.cid),m.add(k,{at:d})),k.getShortcodeRender(l,a.draggedBlockUid,!0);else if(a.wasTempRowDragged){tdcRecycle.takeSnapshot("Sidebar row added");f=c.data("templateContent");k=tdcIFrameData._getDestinationModel(a.$refEl,
[".tdc-zone"]);b.isUndefined(k)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);k.has("childCollection")||k.set("childCollection",new tdcIFrameData.TdcCollection);m=k.get("childCollection");if(b.isUndefined(f)){var q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:k});new tdcIFrameData.TdcLiveView({model:q,el:c[0]});g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q});
c.data("model_id",q.cid);d=c.prevAll(".tdc-row").length;m.add(q,{at:d});m=new tdcIFrameData.TdcCollection;m.add(g);q.set("childCollection",m);d=new tdcIFrameData.TdcCollection;g.set("childCollection",d);a.wasElementWithRowDragged&&(m={},k={},f=c.data("start-values"),l=c.data("row-start-values"),"undefined"!==typeof l&&(k=JSON.parse(window.atob(l))),q.set({attrs:k}),"undefined"!==typeof f&&(m=JSON.parse(window.atob(f)),b.isArray(m)&&(m=m[0])),f=c.data("shortcodeName"),c=new tdcIFrameData.TdcModel({content:"",
attrs:m,tag:f,type:"single",level:3,parentModel:g}),d.add(c),g=new tdcIFrameData.TdcCollection,c.set("childCollection",g))}else q=new tdcIFrameData.TdcModel({templateContent:f,attrs:{},tag:"vc_row",type:"template",level:1,parentModel:k}),new tdcIFrameData.TdcLiveView({model:q,el:c[0]}),d=c.prevAll(".tdc-row").length,c.data("model_id",q.cid),b.isUndefined(k)||(m.add(q,{at:d}),k.set("childCollection",m),q.set("childCollection",new tdcIFrameData.TdcCollection));q.getShortcodeRender(1,a.draggedBlockUid,
!0)}else if(a.wasColumnDragged){if(tdcRecycle.takeSnapshot("Column copied"),f=c.data("templateContent"),!b.isUndefined(f)){c=c.data("model_id");if(b.isUndefined(c)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,!1);return}g=tdcIFrameData.getModel(c);if(b.isUndefined(g)){new tdcNotice.notice("changeData Error: Column model not in structure data!",!0,!1);return}g.set("templateContent",f);g.set("type","template");l=tdcIFrameData._getDestinationCol(a.$refEl);g.getShortcodeRender(l,
a.draggedBlockUid,!0)}}else{if(a.wasInnerColumnDragged&&(tdcRecycle.takeSnapshot("Inner column copied"),f=c.data("templateContent"),!b.isUndefined(f))){c=c.data("model_id");if(b.isUndefined(c)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,!1);return}g=tdcIFrameData.getModel(c);if(b.isUndefined(c)){new tdcNotice.notice("changeData Error: Column model not in structure data!",!0,!1);return}g.set("templateContent",f);g.set("type","template");c=tdcIFrameData._getDestinationCol(a.$refEl);
g.getShortcodeRender(c,a.draggedBlockUid,!0)}}else{g=c.data("model_id");if(b.isUndefined(g)){new tdcNotice.notice("changeData Error: Element model id is not in $refEl data!",!0,!1);return}g=tdcIFrameData.getModel(g);if(b.isUndefined(g)){new tdcNotice.notice("changeData Error: Element model not in structure data!",!0,!1);return}if(a.wasElementDragged){tdcDebug.log("case 1");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("element recycled");tdcIFrameData.removeModel(g);
tdcRecycle.takeSnapshot(g.get("tag")+" : element recycled");return}tdcRecycle.takeSnapshot(g.get("tag")+" : element moved");p=g.get("parentModel");k=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-inner-column",".tdc-column"]);b.isUndefined(k)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);p.cid===k.cid?(l=p.get("childCollection"),l.remove(g,{silent:!0}),l.add(g,{at:d})):(l=tdcIFrameData._getDestinationCol(a.$refEl),k.has("childCollection")||k.set("childCollection",
new tdcIFrameData.TdcCollection),m=k.get("childCollection"),tdcIFrameData.removeModel(g,!1,{silent:!0}),m.add(g,{at:d}),g.set("parentModel",k),a.sourceColParam!==l&&g.getShortcodeRender(l,a.draggedBlockUid,!0));tdcRecycle.takeSnapshot(g.get("tag")+" : element moved")}else if(a.wasInnerRowDragged){tdcDebug.log("case 2");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("inner row recycled");tdcIFrameData.removeModel(g);tdcRecycle.takeSnapshot("Inner row recycled");
return}tdcRecycle.takeSnapshot("Inner row moved");p=g.get("parentModel");k=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]);b.isUndefined(k)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);if(p.cid===k.cid)l=p.get("childCollection"),l.remove(g,{silent:!0}),l.add(g,{at:d});else{k.has("childCollection")||k.set("childCollection",new tdcIFrameData.TdcCollection);m=k.get("childCollection");tdcIFrameData.removeModel(g,!0,{silent:!0});m.add(g,{at:d});
g.set("parentModel",k);a=p.get("attrs");d=k.get("attrs");if(b.has(a,"width"))switch(a.width){case "1/3":l="13";break;case "2/3":l="23"}if(b.has(d,"width"))switch(d.width){case "1/3":f="13";break;case "2/3":f="23"}b.isUndefined(l)&&(l="11");b.isUndefined(f)&&(f="11");if(l!==f&&(a=g.get("childCollection"),!b.isUndefined(a))){a=tdcIFrameData.getChildCollectionWidths(a);b.isUndefined(a)&&(a="11");d="11";m=1;switch(f){case "11":switch(a){case "11":d="11";break;case "23_13":d="23_13";break;case "13_23":d=
"13_23";break;case "12_12":d="13_13_13";break;case "13_13_13":d="13_13_13"}m=3;break;case "13":switch(a){case "11":d="11";break;case "23_13":d="11";break;case "13_23":d="11";break;case "12_12":d="11";break;case "13_13_13":d="11"}break;case "23":switch(a){case "11":d="12_12";break;case "23_13":d="12_12";break;case "13_23":d="12_12";break;case "12_12":d="12_12";break;case "13_13_13":d="12_12"}m=2}if(a!==d||l!==f)tdcIFrameData.changeInnerRowModel(g,a,d),g.getShortcodeRender(m,null,!0)}a=tdcOperationUI.inZone(c);
d=tdcOperationUI.inRow(c);m=tdcOperationUI.inColumn(c);c=tdcOperationUI.inInnerRow(c);b.isUndefined(a)||b.isUndefined(d)||b.isUndefined(m)||b.isUndefined(c)||tdcSidebar.setSettings({$currentZone:a,$currentRow:d,$currentColumn:m,$currentInnerRow:c},!0)}tdcRecycle.takeSnapshot(g.get("tag")+" : inner row moved")}else if(a.wasInnerColumnDragged||a.wasColumnDragged)tdcDebug.log("case 3"),p=g.get("parentModel"),l=p.get("childCollection"),l.remove(g,{silent:!0}),l.add(g,{at:d}),a.wasColumnDragged?(a=tdcOperationUI.inZone(c),
d=tdcOperationUI.inRow(c),b.isUndefined(d)||b.isUndefined(a)||tdcSidebar.setSettings({$currentZone:a,$currentRow:d}),tdcRecycle.takeSnapshot("Column moved")):a.wasInnerColumnDragged&&(a=tdcOperationUI.inZone(c),d=tdcOperationUI.inRow(c),m=tdcOperationUI.inColumn(c),c=tdcOperationUI.inInnerRow(c),b.isUndefined(a)||b.isUndefined(d)||b.isUndefined(m)||b.isUndefined(c)||tdcSidebar.setSettings({$currentZone:a,$currentRow:d,$currentColumn:m,$currentInnerRow:c}),tdcRecycle.takeSnapshot("Inner-column moved"));
else if(a.wasRowDragged){tdcDebug.log("case 4");p=g.get("parentModel");f=p.get("blockUid");l=p.get("childCollection");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){l.remove(g);tdcDebug.log("row recycled");tdcRecycle.takeSnapshot("Row recycled");l.length||(q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:p}),new tdcIFrameData.TdcLiveView({model:q,el:tdcIFrameData.iframeContents.find("#"+f+" .tdc_zone")[0]}),g=new tdcIFrameData.TdcModel({content:"",
attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q}),l.add(q,{at:0}),m=new tdcIFrameData.TdcCollection,m.add(g),q.set("childCollection",m),g.set("childCollection",new tdcIFrameData.TdcCollection),q.getShortcodeRender(1,a.draggedBlockUid,!0));return}d=c.prevAll(".tdc-row").length;a=c.closest(".tdc-zone").data("model_id");m=l;p.cid!==a&&(k=tdcIFrameData.getModel(a),m=k.get("childCollection"));l.remove(g,{silent:!0});m.add(g,{at:d});k.set("childCollection",m);g.set("parentModel",k);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(c)});
l.length||(q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:p}),new tdcIFrameData.TdcLiveView({model:q,el:tdcIFrameData.iframeContents.find("#"+f+" .tdc_zone")[0]}),g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q}),l.add(q,{at:0}),m=new tdcIFrameData.TdcCollection,m.add(g),q.set("childCollection",m),g.set("childCollection",new tdcIFrameData.TdcCollection),setTimeout(function(){q.getShortcodeRender(1,
e,!0)},200));p.set("childCollection",l);tdcRecycle.takeSnapshot("Row moved");tdcDebug.log("newPosition: "+d);tdcDebug.log(c)}}tdcDebug.log(tdcIFrameData.tdcTopCollection)}},_parseModelWidthAttrs:function(a){a=a.get("attrs");var c=3;if(b.has(a,"width"))switch(a.width){case "1/3":c=1;break;case "2/3":c=2;break;case "1/2":c=1}return c},getColumnNumber:function(a){var c=3,e=parseInt(a.get("level"),10),d=a.get("parentModel");b.isUndefined(d)||(4===e?(a=tdcIFrameData._parseModelWidthAttrs(d),c=3===a?tdcIFrameData.getColumnNumber(d):
...
getShortcode:""},k=tdcIFrameData.getFirstModelByZoneType(c);tdcIFrameData._checkModelData(k,d);b.isUndefined(d.error)?b.isUndefined(d.getShortcode)?delete a[c]:a[c]=d.getShortcode:new tdcNotice.notice(d.errors,!0,!1)});if(!b.isEmpty(a))return a.tdc_is_header_sticky=tdcState.isHeaderSticky(),a.tdc_is_mobile_header_sticky=tdcState.isMobileHeaderSticky(),a},getFooterShortcodeFromData:function(){var a={};if("Newspaper"===window.tdcAdminSettings.themeName){var c={error:e,getShortcode:""},d=tdcIFrameData.getFirstModelByZoneType("tdc_footer");
tdcIFrameData._checkModelData(d,c);if(!b.isUndefined(c.error)){new tdcNotice.notice(c.errors,!0,!1);return}b.isUndefined(c.getShortcode)||(a=c.getShortcode)}if(!b.isEmpty(a))return a},bindViewsModelsWrappers:function(a,c,e,d){if(b.isEmpty(a)&&(b.isUndefined(d)&&(d=0),!b.isUndefined(c))){var h=[];switch(d){case 0:var k=[];e.find(".tdc-zone").each(function(){var a=f(this);a.parents(".menu-item").length||k.push(a)});if(c.models.length!==k.length){a[b.keys(a).length]={collection:c,jqDOMElements:k,info:"Error at zones: "+
c.models.length+"(models) : "+k.length+"(dom)"};return}d++;b.each(k,function(c,b,e){b=f(c);e=b.data("type");e=tdcIFrameData.getFirstModelByZoneType(e);b.data("model_id",e.cid);e.set("blockUid",b.attr("id"));e.set("html",c.innerHTML);new tdcIFrameData.TdcLiveView({model:e,el:c});e.has("childCollection")&&tdcIFrameData.bindViewsModelsWrappers(a,e.get("childCollection"),b,d)});d--;return;case 1:e.find(".tdc-row").each(function(){var a=f(this);a.parents(".menu-item").length||h.push(a)});if(c.models.length!==
h.length){a[b.keys(a).length]={collection:c,jqDOMElements:h,info:"Error at rows: "+c.models.length+"(models) : "+h.length+"(dom)"};return}break;case 2:e.find(".tdc-columns:first").children(".tdc-column").each(function(){var a=f(this);a.parents(".menu-item").length||h.push(a)});if(c.models.length!==h.length){a[b.keys(a).length]={collection:c,jqDOMElements:h,info:"Errors at columns: "+c.models.length+"(models) : "+h.length+"(dom)",level:d};return}break;case 3:e.find(".tdc-elements:first").children(".tdc-element, .tdc-element-inner-row").each(function(){var a=
f(this);a.parents(".menu-item").length||h.push(a)});if(c.models.length!==h.length){a[b.keys(a).length]={collection:c,jqDOMElements:h,info:"Errors at columns elements: "+c.models.length+"(models) : "+h.length+"(dom)",level:d};return}break;case 4:e.find(".tdc-inner-columns:first").children(".tdc-inner-column").each(function(){var a=f(this);a.parents(".menu-item").length||h.push(a)});if(c.models.length!==h.length){a[b.keys(a).length]={collection:c,jqDOMElements:h,info:"Errors at inner columns: "+c.models.length+
"(models) : "+h.length+"(dom)",level:d};return}break;case 5:if(e.find(".tdc-elements:first").children(".tdc-element").each(function(){var a=f(this);a.parents(".menu-item").length||h.push(a)}),c.models.length!==h.length){a[b.keys(a).length]={collection:c,jqDOMElements:h,info:"Errors at elements: "+c.models.length+"(models) : "+h.length+"(dom)",level:d};return}}d++;b.each(h,function(e,h,k){h=c.models[h];k=f(e);k.data("model_id",h.cid);h.set("html",e.innerHTML,{silent:!0});if(5===h.get("level")){var l=
k.data("td-block-uid");if(b.isUndefined(l)){var m=k.find(".td_block_inner, .tdb-block-inner, .td-post-sharing");m.length&&(l=m.attr("id"))}}else 3===h.get("level")?(m=k.find(".tdc-inner-row"),m.length&&(l=m.attr("id"))):1===h.get("level")&&(l=k.attr("id"));h.set("blockUid",l);new tdcIFrameData.TdcLiveView({model:h,el:e});!k.hasClass("tdc-element")&&h.has("childCollection")&&0<b.size(h.get("childCollection"))&&tdcIFrameData.bindViewsModelsWrappers(a,h.get("childCollection"),k,d)});d--}},changeRowModel:function(a,
c,e){var d=a.get("childCollection");if("11"===c&&("23_13"===e||"13_23"===e||"13_13_13"===e)){e=e.split("_");var h=e[0].charAt(0)+"/"+e[0].charAt(1),f=d.at(0),g=f.get("attrs");b.isUndefined(g)?f.set("attrs",{width:h}):(g=b.clone(g),g.width=h,f.set("attrs",g));d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[1].charAt(0)+"/"+e[1].charAt(1)},type:"closed",level:1,parentModel:a}));3===e.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+
"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a}));tdcIFrameData.changeColumnModel(f,c,e[0])}else if(("23_13"===c||"13_23"===c||"13_13_13"===c)&&"11"===e){c=c.split("_");f=d.at(0);g=f.get("attrs");var n=f.get("childCollection"),p=d.at(1),q=p.get("childCollection");b.isUndefined(g)||(g=b.clone(g),delete g.width,f.set("attrs",g));b.isUndefined(n)&&(n=new tdcIFrameData.TdcCollection,f.set("childCollection",n));!b.isUndefined(q)&&q.length&&b.each(q.models,function(a,c,b){a.set("parentModel",f);
n.add(a)});3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",f);n.add(a)}),tdcIFrameData.removeModel(a));tdcIFrameData.removeModel(p);tdcIFrameData.changeColumnModel(f,c[0],e)}else if(!("23_13"!==c&&"13_23"!==c&&"13_13_13"!==c||"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)){c=c.split("_");e=e.split("_");h=e[0].charAt(0)+"/"+e[0].charAt(1);var t=e[1].charAt(0)+"/"+e[1].charAt(1);f=d.at(0);g=f.get("attrs");p=d.at(1);var v=
p.get("attrs");q=p.get("childCollection");3===e.length?d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a})):3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&(b.isUndefined(q)&&(q=new tdcIFrameData.TdcCollection,p.set("childCollection",q)),b.each(d.models,function(a,c,b){a.set("parentModel",p);q.add(a)})),tdcIFrameData.removeModel(a));g=b.clone(g);g.width=h;f.set("attrs",g);
c[0]!==e[0]&&tdcIFrameData.changeColumnModel(f,c[0],e[0]);h=b.clone(v);h.width=t;p.set("attrs",h);c[1]!==e[1]&&tdcIFrameData.changeColumnModel(p,c[1],e[1])}tdcDebug.log(tdcIFrameData.tdcTopCollection.models)},changeFluidStructureModel:function(a,c,e){var d=a.get("childCollection"),h=a.get("tag"),f="vc_column";c=c.split("_");var g=e.split("_");if("vc_row"===h||"vc_row_inner"===h){"vc_row_inner"===h&&(f="vc_column_inner");if(g.length>c.length)for(h=0;h<g.length;h++){e="";for(var n=0;n<g[h].length;n++)e+=
g[h].charAt(n)+"/";""!==e&&(e=e.substring(0,e.length-1));if(h<c.length){var p=d.at(h);n=p.get("attrs");var q=b.clone(n);q.width=e;p.set("attrs",q)}else d.add(new tdcIFrameData.TdcModel({content:"",tag:f,attrs:{width:e},type:"closed",level:1,parentModel:a}))}else for(h=0;h<c.length;h++)if(h<g.length){p=d.at(h);n=p.get("attrs");q=b.clone(n);e="";for(n=0;n<g[h].length;n++)e+=g[h].charAt(n)+"/";""!==e&&(e=e.substring(0,e.length-1));q.width=e;p.set("attrs",q);var t=p}else{p=d.at(g.length);a=p.get("childCollection");
var v=t.get("childCollection");b.isUndefined(v)&&(v=new tdcIFrameData.TdcCollection,t.set("childCollection",v));b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",t);v.add(a)});tdcIFrameData.removeModel(p)}tdcDebug.log(tdcIFrameData.tdcTopCollection.models)}},changeColumnModel:function(a,c,e){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(e))){var d=a.get("childCollection");if(!b.isUndefined(d)&&d.length){var h=a.get("attrs");!b.isUndefined(h)&&b.has(h,"width");b.each(d.models,
function(d,h,k){if("vc_row_inner"===d.get("tag")&&(d=d.get("childCollection"),!b.isUndefined(d)&&d.length)){var l="";b.each(d.models,function(a,c,e){a=a.get("attrs");!b.isUndefined(a)&&b.isObject(a)&&b.has(a,"width")&&(l=c===e.length-1?l+a.width:l+(a.width+"_"))});l=l.replace(/\//g,"");"12_12"!==l&&"23_13"!==l&&"13_23"!==l&&"13_13_13"!==l&&(l="");if("11"===c)if("23"===e)if("23_13"===l){var f=d.at(0),g=d.at(1);k=f.get("attrs");h=g.get("attrs");k=b.clone(k);h=b.clone(h);k.width="1/2";h.width="1/2";
f.set("attrs",k);g.set("attrs",h)}else if("13_23"===l)f=d.at(0),g=d.at(1),k=f.get("attrs"),h=g.get("attrs"),k=b.clone(k),h=b.clone(h),k.width="1/2",h.width="1/2",f.set("attrs",k),g.set("attrs",h);else if("13_13_13"===l){f=d.at(0);g=d.at(1);d=d.at(2);k=f.get("attrs");h=g.get("attrs");var m=d.get("attrs");k=b.clone(k);h=b.clone(h);b.clone(m);k.width="1/2";h.width="1/2";f.set("attrs",k);g.set("attrs",h);h=d.get("childCollection");if(!b.isUndefined(h)&&h.length){var n=g.get("childCollection");b.isUndefined(n)&&
(n=new tdcIFrameData.TdcCollection,g.set("childCollection",n));b.each(h.models,function(a,c,b){n.add(a);a.set("parentModel",g)})}tdcIFrameData.removeModel(d)}else{if(d.models.length){f=d.at(0);k=f.get("attrs");k=b.clone(k);var r=f.get("childCollection");delete k.width;f.set("attrs",k);b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r));var w=0;for(b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",
f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}}else{if("13"===e&&d.models.length)for(f=d.at(0),k=f.get("attrs"),k=b.clone(k),r=f.get("childCollection"),delete k.width,f.set("attrs",k),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else if("23"===
c)if("11"===e)if("12_12"===l)f=d.at(0),g=d.at(1),k=f.get("attrs"),h=g.get("attrs"),k=b.clone(k),h=b.clone(h),k.width="1/3",h.width="1/3",f.set("attrs",k),g.set("attrs",h),h=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,parentModel:a}),d.add(h);else{if(d.models.length)for(f=d.at(0),k=f.get("attrs"),k=b.clone(k),r=f.get("childCollection"),delete k.width,f.set("attrs",k),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",
...
b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else if("13"===c)if("11"===e)if(""===l||"12_12"!==l&&"23_13"!==l&&"13_23"!==l&&"13_13_13"!==l){if(d.models.length)for(f=d.at(0),k=f.get("attrs"),k=b.clone(k),r=f.get("childCollection"),delete k.width,f.set("attrs",k),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||
b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else"12_12"===l&&d.models.length&&(f=d.at(0),g=d.at(1),k=f.get("attrs"),h=g.get("attrs"),k.width="1/3",h.width="1/3",f.set("attrs",k),g.set("attrs",h),d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));else if("23"===e&&(""===l||"12_12"!==l)&&d.models.length)for(f=d.at(0),k=f.get("attrs"),k=b.clone(k),r=f.get("childCollection"),
delete k.width,f.set("attrs",k),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}})}}},changeInnerRowModel:function(a,c,e){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(e))){var d=a.get("childCollection");if("11"!==c||"12_12"!==e&&"23_13"!==e&&"13_23"!==
e&&"13_13_13"!==e)if("12_12"!==c&&"23_13"!==c&&"13_23"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)"13_13_13"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e?tdcIFrameData.changeFluidStructureModel(a,c,e):("11"===e?(q=d.at(0),t=q.get("attrs"),h=q.get("childCollection"),g=d.at(1),f=g.get("childCollection"),a=d.at(2),d=a.get("childCollection"),b.isUndefined(t)||(t=b.clone(t),delete t.width,q.set("attrs",t)),b.isUndefined(h)&&(h=new tdcIFrameData.TdcCollection,q.set("childCollection",
h)),!b.isUndefined(f)&&f.length&&b.each(f.models,function(a,c,b){a.set("parentModel",q);h.add(a)}),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",q);h.add(a)}),tdcIFrameData.removeModel(g)):(n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1),c=n[1].charAt(0)+"/"+n[1].charAt(1),q=d.at(0),t=q.get("attrs"),g=d.at(1),e=g.get("attrs"),f=g.get("childCollection"),a=d.at(2),d=a.get("childCollection"),t=b.clone(t),t.width=p,q.set("attrs",t),e=b.clone(e),e.width=c,g.set("attrs",
e),b.isUndefined(f)&&(f=new tdcIFrameData.TdcCollection,g.set("childCollection",f)),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",g);f.add(a)})),tdcIFrameData.removeModel(a));else if("11"===e){q=d.at(0);t=q.get("attrs");var h=q.get("childCollection");g=d.at(1);var f=g.get("childCollection");b.isUndefined(t)||(t=b.clone(t),delete t.width,q.set("attrs",t));b.isUndefined(h)&&(h=new tdcIFrameData.TdcCollection,q.set("childCollection",h));!b.isUndefined(f)&&f.length&&
b.each(f.models,function(a,c,b){a.set("parentModel",q);h.add(a)});tdcIFrameData.removeModel(g)}else n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1),c=n[1].charAt(0)+"/"+n[1].charAt(1),q=d.at(0),t=q.get("attrs"),g=d.at(1),e=g.get("attrs"),t=b.clone(t),t.width=p,q.set("attrs",t),e=b.clone(e),e.width=c,g.set("attrs",e),3===n.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:n[2].charAt(0)+"/"+n[2].charAt(1)},type:"closed",level:3,parentModel:a}));else{var g=new tdcIFrameData.TdcModel({content:"",
tag:"vc_column_inner",type:"closed",level:3,parentModel:a}),n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1);c=n[1].charAt(0)+"/"+n[1].charAt(1);var q=d.at(0),t=q.get("attrs");b.isUndefined(t)?q.set("attrs",{width:p}):(t=b.clone(t),t.width=p,q.set("attrs",t));g.set("attrs",{width:c});d.add(g);3===n.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:n[2].charAt(0)+"/"+n[2].charAt(1)},type:"closed",level:3,parentModel:a}))}}},getChildCollectionWidths:function(a){if(!b.isUndefined(a)){var c;
...
tdcElementUI.bindEmptyElement(a);c.append(a)})};window.addZoneWrappers=function(a){a.find(".tdc-row").each(function(a,c){f(c).find(".tdc-column").wrapAll('<div class="tdc-columns"></div>')});a.find(".tdc-column").each(function(a,c){a=f(c);a.find(".tdc-inner-row").wrap('<div class="tdc-element-inner-row"></div>');a=a.find(".td_block_wrap");window.checkTdBlockWrap(a);a.addClass("tdc-element")});a.find(".tdc-inner-row").each(function(a,c){f(c).find(".tdc-inner-column").wrapAll('<div class="tdc-inner-columns"></div>').each(function(a,
c){a=f(c).find(".tdc-element");a.length?a.addClass("tdc-element-inner-column").wrapAll('<div class="tdc-elements"></div>'):(c=f(c).find(".wpb_wrapper"),c.length&&c.append('<div class="tdc-elements"></div>'))})});a.find(".tdc-element, .tdc-element-inner-row").each(function(a,c){a=f(c);a.length&&a.not(".tdc-element-inner-column").addClass("tdc-element-column")});a.find(".tdc-column").each(function(a,c){a=f(c).find(".tdc-element, .tdc-element-inner-row");a.length?a.not(".tdc-element-inner-column").wrapAll('<div class="tdc-elements"></div>'):
(c=f(c).find(".wpb_wrapper"),c.length&&c.append('<div class="tdc-elements"></div>'))});a.find(".tdc-elements:empty").each(function(a,c){a="";c=f(c);c.closest(".tdc-inner-column").length?a=" tdc-element-inner-column":c.closest(".tdc-column").length&&(a=" tdc-element-column");a=f('<div class="'+tdcOperationUI._emptyElementClass+a+'" title="Empty element that should be removed by composer"></div>');tdcElementUI.bindEmptyElement(a);c.append(a)})};window.addRowWrappers=function(a){a.find(".tdc-column").wrapAll('<div class="tdc-columns"></div>');
a.find(".tdc-column").each(function(a,c){a=f(c);a.find(".tdc-inner-row").wrap('<div class="tdc-element-inner-row"></div>');a=a.find(".td_block_wrap");window.checkTdBlockWrap(a);a.addClass("tdc-element")});a.find(".tdc-inner-row").each(function(a,c){f(c).find(".tdc-inner-column").wrapAll('<div class="tdc-inner-columns"></div>').each(function(a,c){a=f(c).find(".tdc-element");a.length?a.addClass("tdc-element-inner-column").wrapAll('<div class="tdc-elements"></div>'):(c=f(c).find(".wpb_wrapper"),c.length&&
c.append('<div class="tdc-elements"></div>'))})});a.find(".tdc-element, .tdc-element-inner-row").each(function(a,c){a=f(c);a.length&&a.not(".tdc-element-inner-column").addClass("tdc-element-column")});a.find(".tdc-column").each(function(a,c){a=f(c).find(".tdc-element, .tdc-element-inner-row");a.length?a.not(".tdc-element-inner-column").wrapAll('<div class="tdc-elements"></div>'):(c=f(c).find(".wpb_wrapper"),c.length&&c.append('<div class="tdc-elements"></div>'))});a.find(".tdc-elements:empty").each(function(a,
c){a="";c=f(c);c.closest(".tdc-inner-column").length?a=" tdc-element-inner-column":c.closest(".tdc-column").length&&(a=" tdc-element-column");a=f('<div class="'+tdcOperationUI._emptyElementClass+a+'" title="Empty element that should be removed by composer"></div>');tdcElementUI.bindEmptyElement(a);c.append(a)})};window.addColumnWrappers=function(a){a.find(".tdc-inner-row").wrap('<div class="tdc-element-inner-row"></div>');var c=a.find(".td_block_wrap");window.checkTdBlockWrap(c);c.addClass("tdc-element");
a.find(".tdc-inner-row").each(function(a,c){f(c).find(".tdc-inner-column").wrapAll('<div class="tdc-inner-columns"></div>').each(function(a,c){a=f(c).find(".tdc-element");a.length?a.addClass("tdc-element-inner-column").wrapAll('<div class="tdc-elements"></div>'):(c=f(c).find(".wpb_wrapper"),c.length&&c.append('<div class="tdc-elements"></div>'))})});a.find(".tdc-element, .tdc-element-inner-row").each(function(a,c){a=f(c);a.length&&a.not(".tdc-element-inner-column").addClass("tdc-element-column")});
...
c.append(a)})};window.addLoopWrappers=function(a){a.find(".td-main-content").wrap('<div class="tdc-loop-content"></div>')};window.addSidebarWrappers=function(a){a.find(".td-main-sidebar").wrap('<div class="tdc-sidebar-content"></div>')};window.checkTdBlockWrap=function(a){a.each(function(a,c){a=f(c);0===parseInt(a.height())?a.addClass("tdc-block-empty"):a.removeClass("tdc-block-empty")})};var a=window.tdcPostSettings.postMetaVcJsStatus,c=window.tdcPostSettings.postContent;"1"!==window.tdcPostSettings.postMetaDirtyContent&&
"true"!==a||""===c||new tdcNotice.showNotice("The current content hasn't been created by TagDiv Composer!",{type:"info"});tdcAdminIFrameUI.checkIframe(tdcAdminIFrameUI._$liveIframe)},loadIframe:function(){(tdDetect.isIe8||tdDetect.isIe9||tdDetect.isIe10)&&tdConfirm.showModalOk("Browser Information","TagDiv Composer does not work with Internet Explorer 8, 9, 10",function(){tb_remove()});var a=f(this).contents();"header"===window.tdcPostSettings.tdbTemplateType&&a.find(".tdc-content-wrap").html("");
tdcAdminIFrameUI.initContent(a);tdcAdminIFrameUI._liveIframeWindowObject=f(this).get(0).contentWindow;var c=f('<div id="tdc-recycle" class="tdc-recycle"><div class="tdc-delete-text"><span>Delete</span></div></div>');a.find("body").prepend(c);tdcAdminWrapperUI.$recycle=c;tdcIFrameData._postOriginalContentJSON=e;window.addWrappers(a,".td-main-content-wrap","tdc_content");window.addWrappers(a,".td-header-desktop-wrap","tdc_header_desktop");window.addWrappers(a,".td-header-desktop-sticky-wrap","tdc_header_desktop_sticky");
window.addWrappers(a,".td-header-mobile-wrap","tdc_header_mobile");window.addWrappers(a,".td-header-mobile-sticky-wrap","tdc_header_mobile_sticky");window.addWrappers(a,".td-footer-wrap","tdc_footer");tdcIFrameData.init(a,!0);tdcOperationUI.init(a,!0);a.on("click","a",function(a){a.preventDefault();"undefined"!==this.href&&window.open(this.href,"_blank")});a[0].addEventListener("mousedown",function(a){1!==a.which&&a.stopPropagation()},!0);a[0].addEventListener("mousemove",function(c){a.lastMouseEvent=
c},!0);a.on("click",function(a){tdcContextMenu.hide()});a.on("scroll",function(a){tdcContextMenu.hide()});a.bind("contextmenu",function(a){if(!a.ctrlKey){a.preventDefault();var c=a.pageX,b=a.pageY,e=0,d=f("#tdc-context-menu"),h=d.width();d=d.height();tdcMain.getSidebarInline()&&(e=tdcSidebar.$_sidebar.width());c+h+e>tdcWindowFrame.$_window.width()&&(c=tdcWindowFrame.$_window.width()-h-e);b+d>tdcAdminIFrameUI.getIframeWindow().scrollY+tdcWindowFrame.$_window.height()&&(b=tdcAdminIFrameUI.getIframeWindow().scrollY+
tdcWindowFrame.$_window.height()-d);e=tdcAdminIFrameUI.getLiveIframe();e=(e.parent().width()-e.width())/2;f(a.target).trigger(f.Event("contextmousedown",{pageX:c+e,pageY:b}))}})},checkIframe:function(a){if(b.isUndefined(a)){a=window.tdcPostSettings.postUrl;var c="";!1!==window.tdcPostSettings.tdbLoadDataFromId&&!1!==window.tdcPostSettings.tdbTemplateType?c="&tdbLoadDataFromId="+window.tdcPostSettings.tdbLoadDataFromId+"&tdbTemplateType="+window.tdcPostSettings.tdbTemplateType:!1!==window.tdcPostSettings.tdbTemplateType&&
(c="&tdbTemplateType="+window.tdcPostSettings.tdbTemplateType);a=0>a.indexOf("?")?a+("?td_action=tdc_edit&post_id="+window.tdcPostSettings.postId+c):a+("&td_action=tdc_edit&post_id="+window.tdcPostSettings.postId+c);a=f('<iframe id="tdc-live-iframe" name="tdc-live-iframe" src="'+a+'" scrolling="auto" style="width: 100%; height: 100%" class="tdc-responsive-all"></iframe>').load(tdcAdminIFrameUI.loadIframe);f("#tdc-live-iframe-wrapper").append(a)}else{var d=a;c=d.contents();tdcAdminIFrameUI.initContent(c);
tdcAdminIFrameUI._liveIframeWindowObject=d.get(0).contentWindow;d=f('<div id="tdc-recycle" class="tdc-recycle"><div class="tdc-delete-text"><span>Delete</span></div></div>');tdcDebug.log(tdcIFrameData.tdcTopCollection.models);c.find("body").prepend(d);tdcAdminWrapperUI.$recycle=d;tdcIFrameData._postOriginalContentJSON=e;window.addWrappers(c,".td-main-content-wrap","tdc_content");window.addWrappers(c,".td-header-desktop-wrap","tdc_header_desktop");window.addWrappers(c,".td-header-desktop-sticky-wrap",
"tdc_header_desktop_sticky");window.addWrappers(c,".td-header-mobile-wrap","tdc_header_mobile");window.addWrappers(c,".td-header-mobile-sticky-wrap","tdc_header_mobile_sticky");window.addWrappers(c,".td-footer-wrap","tdc_footer");tdcIFrameData.init(c,!0);tdcOperationUI.init(c,!0);c.find("a").each(function(a,c){c.setAttribute("target","_blank")});a.removeClass("tdc-live-iframe");a.removeClass("tdc-live-iframe-temp")}tdcAdminIFrameUI._$liveIframe=a}}})(jQuery,Backbone,_);var tdcMain={};
...
b.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(b.attr("name"),c,tdcSidebar.currentViewportSettings.name))}else if("text"===b.attr("type")){c=b.val().trim();e=b.prev('input[type="range"]');var d=b.data("default_value");if("all"===tdcSidebar.currentViewportSettings.name)""!==c||_.isUndefined(d)||""===d||(c=d,b.val(c));else if(""===c){var k=tdcSidebarPanel.getCurrentResponsiveValue(e.attr("name"),"all");"undefined"===typeof k?_.isUndefined(d)||""===d||(c=d,b.val(c)):(b.val(""),
b.attr("placeholder",k))}e.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(e.attr("name"),c,tdcSidebar.currentViewportSettings.name));"undefined"===typeof k?e.val(c):(e.val(k),a.addClass("tdc-css-inherited"));e=b.prev('input[type="range"]').get(0)}k=e;a=jQuery(k);b=a.data("data-to-save");a=tdcIFrameData.getModel(a.data("model_id"));k.oldValue!==b&&(tdcSidebarController.onUpdate(a,jQuery(k).data("param_name"),k.oldValue,_.escape(b)),k.oldValue=b)});d.on("keyup focus change input",
".tdc-tab-no-design .tdc-property-range_multiple input",function(b){var e=jQuery(this),a=this;if("range"===e.attr("type")){var c=e.closest(".tdc-property").find('input[type="radio"]:checked');e.closest(".tdc-property").find('input[type="text"]').val(e.val());c.data("last_value",e.val())}else if("text"===e.attr("type")){a=e.closest(".tdc-property").find('input[type="range"]');c=e.closest(".tdc-property").find('input[type="radio"]:checked');var d=c.data("default_value"),k=e.val().trim();""!==k||_.isUndefined(d)||
""===d||(k=d,e.val(k));a.val(k);c.data("last_value",k);a=a.get(0)}else if("radio"===e.attr("type")){a=e.closest(".tdc-property").find('input[type="range"]');c=e.closest(".tdc-property").find('input[type="text"]');e.closest(".tdc-property").find('input[type="radio"]:checked');k=e.data("last_value");d=e.data("default_value");var f=e.data("unit");e=a.data("min_"+f);var m=a.data("max_"+f);f=a.data("step_"+f);a.get(0).min=e;a.get(0).max=m;a.get(0).step=f;""===k?(c.val(d),a.val(d)):(c.val(k),a.val(k));
a=a.get(0)}d="";c=jQuery(a).parent().find('input[type="radio"]:checked');c.length&&(d=jQuery(c[0]).data("unit_value"));"focusin"===b.type?a.oldValue=a.value+d:(b=a.value+d,d=tdcIFrameData.getModel(jQuery(a).data("model_id")),tdcSidebarController.onUpdate(d,jQuery(a).data("param_name"),a.oldValue,_.escape(b)),a.oldValue=b)});d.on("keyup change input",".tdc-tab-no-design .tdc-property-range_multiple-responsive input",function(b){var d=jQuery(this),a=d.closest(".tdc-property-responsive"),c=a.find('input[type="range"]'),
h=a.find('input[type="radio"]:checked'),k=a.find('input[type="text"]'),f=c.get(0),m="",g=h.data("default_value"),n=tdcIFrameData.getModel(c.data("model_id")),p=c.data("param_name"),q=window.tdcAdminSettings.mappedShortcodes[n.attributes.tag],t=n="";var v=[];for(var u=0;u<q.params.length;u++)if(p===q.params[u].param_name){u=q.params[u].tdc_values;for(var r in u)u.hasOwnProperty(r)&&(v.push(u[r].unit),""===n||""===t)&&(n=u[r].value,t=u[r].unit);break}h.length&&(m=h.data("unit_value"));if("range"===
d.attr("type"))v=c.val(),k.val(v),h.data("last_value",v),k.val(v),c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+m,tdcSidebar.currentViewportSettings.name)),a.removeClass("tdc-css-inherited");else if("text"===d.attr("type")){if("input"===b.type||"change"===b.type)return;a.removeClass("tdc-css-inherited");v=k.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==v||_.isUndefined(g)||""===g?(c.val(v),h.data("last_value",v),c.data("data-to-save",
tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+m,tdcSidebar.currentViewportSettings.name))):(c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),c.data("range_value",n),c.data("range_unit",t),c.val(n),m=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=m.data("unit"),r=c.data("min_"+q),h=c.data("max_"+q),q=c.data("step_"+q),m.prop("checked",!0),f.min=r,f.max=h,f.step=q,f.value=n,m.data("last_value",n),k.val(n));
else if(""===v)if(m=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),"all"),"undefined"===typeof m)c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),c.data("range_value",n),c.data("range_unit",t),c.val(n),m=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=m.data("unit"),r=c.data("min_"+q),h=c.data("max_"+q),q=c.data("step_"+q),m.prop("checked",!0),f.min=r,f.max=h,f.step=q,f.value=n,m.data("last_value",n),k.val(n),a.addClass("tdc-css-inherited");
else for(u=0;u<q.params.length;u++){if(p===q.params[u].param_name){v=[];k=[];u=q.params[u].tdc_values;for(r in u)u.hasOwnProperty(r)&&v.push(u[r].unit);for(u=0;u<v.length&&!(k=m.split(v[u]),1<k.length);u++);k.length&&(n=k[0],t=v[u],c.data("range_value",n),c.data("range_unit",t),m=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=m.data("unit"),r=c.data("min_"+q),h=c.data("max_"+q),q=c.data("step_"+q),m.prop("checked",!0),f.min=r,f.max=h,f.step=q,f.value=n,m.data("last_value",n),a.find('input[type="text"]').val(n));
c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name));a.addClass("tdc-css-inherited");break}}else c.val(v),h.data("last_value",v),c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+m,tdcSidebar.currentViewportSettings.name))}else if("radio"===d.attr("type")){if("input"===b.type)return;p=h.data("last_value");q=h.data("unit");r=c.data("min_"+q);h=c.data("max_"+q);q=c.data("step_"+q);f.min=r;f.max=h;f.step=
q;""===p?(k.val(g),c.val(g),v=g):(k.val(p),c.val(p),v=p);c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+m,tdcSidebar.currentViewportSettings.name));a.removeClass("tdc-css-inherited")}m="";a=jQuery(f).parent().find('input[type="radio"]:checked');a.length&&(m=jQuery(a[0]).data("unit_value"));"focusin"===b.type?f.oldValue=f.value+m:(a=jQuery(f),b=a.data("data-to-save"),n=tdcIFrameData.getModel(a.data("model_id")),f.oldValue!==b&&(tdcSidebarController.onUpdate(n,
jQuery(f).data("param_name"),f.oldValue,_.escape(b)),f.oldValue=b))});d.on("focus change",".tdc-tab-no-design .tdc-property-checkbox input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this);var d=b.val();b.is(":checked")||(d="");var a=tdcIFrameData.getModel(b.data("model_id"));tdcSidebarController.onUpdate(a,b.data("param_name"),this.oldValue,d);this.oldValue=d}});d.on("focus change",".tdc-tab-no-design .tdc-property-checkbox-responsive input",function(b){if("focusin"===
b.type)this.oldValue=this.value;else{b=jQuery(this);var d=b.val(),a=tdcIFrameData.getModel(b.data("model_id")),c=b.data("param_name");b.is(":checked")||(d="");var h=b.attr("name"),k=b.closest(".tdc-property-responsive");d="all"===tdcSidebar.currentViewportSettings.name&&""===d?tdcSidebarPanel.deleteResponsiveValue(h,tdcSidebar.currentViewportSettings.name):tdcSidebarPanel.updateCheckboxResponsiveValues(h,d,tdcSidebar.currentViewportSettings.name);k.removeClass("tdc-css-inherited");k.find(".tdc-inherit-checkbox").hide();
"all"!==tdcSidebar.currentViewportSettings.name&&(h=tdcSidebarPanel.getCurrentResponsiveValue(b.attr("name"),tdcSidebar.currentViewportSettings.name),k=b.closest(".tdc-property-responsive"),"undefined"===typeof h?(h=tdcSidebarPanel.getCurrentResponsiveValue(b.attr("name"),"all"),"undefined"!==typeof h&&(k.addClass("tdc-css-inherited"),k.find(".tdc-inherit-checkbox").show())):(k.removeClass("tdc-css-inherited"),k.find(".tdc-inherit-checkbox").show()),k.find(".tdc-inherit-checkbox").show());tdcSidebarController.onUpdate(a,
c,this.oldValue,d);this.oldValue=d}});d.on("click",".tdc-tab-no-design .tdc-image-wrap",tdcSidebarPanel.tdcImageWrapHandler);d.on("click",".tdc-tab-no-design .tdc-image-remove",tdcSidebarPanel.tdcImageRemoveHandler);d.on("click",".tdc-tab-no-design .tdc-icon-wrap",tdcSidebarPanel.tdcIconWrapHandler);d.on("click",".tdc-tab-no-design .tdc-icon-remove",tdcSidebarPanel.tdcIconRemoveHandler);d.on("click",".tdc-tab-no-design .tdc-inherit-select",tdcSidebarPanel.tdcInheritSelectHandler);d.on("click",".tdc-tab-no-design .tdc-inherit-checkbox",
tdcSidebarPanel.tdcInheritCheckboxHandler);d.on("click",".tdc-icon-selector-content > span",function(b){b=jQuery("#tdc-icon-selector");b.length||(b=tdcSidebar.buildIconSelector());b.find(".selected").removeClass("selected");var d=jQuery(this),a=d.data("font_class"),c=tdcIFrameData.getModel(b.data("model_id"));d.addClass("selected");var h=b.prev(".tdc-property-wrap");h.find(".tdc-icon-wrap").html(d.html());h.find(".tdc-icon-remove").removeClass("tdc-hidden-button");tdcSidebarController.onUpdate(c,
b.data("param_name"),"",a)});d.on("change","#tdc-icon-selector .tdc-icon-selector-lib",function(){var b=jQuery("#tdc-icon-selector");b.length||(b=tdcSidebar.buildIconSelector());var d=jQuery(this).val(),a=b.find(".tdc-icon-selector-filter");b.find(".tdc-icon-selector-content").children(".tdc-font-separator").each(function(){var c=jQuery(this),b=c.data("font_id");""===d||d===b?(c.show(),c.nextAll("span").each(function(){var c=jQuery(this),b=c.data("font_class"),d=a.val().trim();""!==d&&-1===b.indexOf(d)?
...
d.on("click",".tdc-property-editor_css .tdc-property-title",function(b){tdcSidebarPanel.showHideTdcCssEditor.call(this,b)});d.on("mousedown",function(b){var d=jQuery("#tdc-sidebar"),a=jQuery("#tdc-icon-selector"),c=jQuery("#tdc-gradient"),h=jQuery("#tdc-palette"),k=jQuery("#tdc-font-list"),f=jQuery(".tdc-preset-values-list");a.length?a.get(0).contains(b.target)||(a.hide(),d.after(a)):a=tdcSidebar.buildIconSelector();c.length?c.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-gradient-wrap")||
(c.hide(),d.after(c))):c=tdcSidebar.buildGradient();h.length?h.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-colorpicker-wrap")||(h.hide(),d.after(h),h.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):h=tdcSidebar.buildPalette();k.length&&!k.get(0).contains(b.target)&&(k.hide(),d.after(k));!f.length||f.get(0).contains(b.target)||jQuery(".tdc-preset-values").get(0).contains(b.target)?f.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(b.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),
$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0)},100):f.is(":visible")&&(f.hide(),d=jQuery(b.target),jQuery(".tdc-top-buttons").get(0).contains(b.target)||d.hasClass("tdc-top-buttons")||jQuery(".tdc-sidebar-bottom").get(0).contains(b.target)||d.hasClass("tdc-sidebar-bottom")||jQuery(".tdc-current-element-head").get(0).contains(b.target)||
d.hasClass("tdc-current-element-head")?jQuery(".tdc-current-element-head").get(0).contains(b.target)||d.hasClass("tdc-current-element-head")?(tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0),jQuery(".tdc-current-element-head").trigger(b)):tdcSidebarPanel.clearPanel():
setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0)},100))});d.on("keyup focus paste cut change","input.tdc-icon-selector-filter",function(b){b=jQuery("#tdc-icon-selector");b.length||(b=tdcSidebar.buildIconSelector());var d=this.value.trim();
b.find(".tdc-icon-selector-content").find(".tdc-font-separator:visible").each(function(){jQuery(this).nextAll("span").each(function(){var a=jQuery(this);-1===a.data("font_class").indexOf(d)?a.hide():a.show()})})});d.on("change keyup focus",".tdc-tab-no-design .tdc-property-colorpicker input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var d=tdcIFrameData.getModel(jQuery(this).data("model_id"));tdcSidebarController.onUpdate(d,jQuery(this).data("param_name"),
...
var d=jQuery(this);tdcSidebarPanel.timerChangingColumns=setTimeout(function(){var a=d.val(),c=tdcSidebar.getCurrentRow().data("model_id");c=tdcIFrameData.getModel(c);var b=c.get("childCollection");this.oldValue="11";_.isUndefined(b)||(b=tdcIFrameData.getChildCollectionWidths(b),_.isUndefined(b)||(this.oldValue=b));"11"===this.oldValue&&("23_13"===a||"13_23"===a||"13_13_13"===a)||"23_13"===this.oldValue&&("11"===a||"13_23"===a||"13_13_13"===a)||"13_23"===this.oldValue&&("11"===a||"23_13"===a||"13_13_13"===
a)||"13_13_13"===this.oldValue&&("11"===a||"23_13"===a||"13_23"===a)?(tdcIFrameData.changeRowModel(c,this.oldValue,a),c.getShortcodeRender(1,null,!0)):this.oldValue!==a&&(tdcIFrameData.changeFluidStructureModel(c,this.oldValue,a),c.getShortcodeRender(1,null,!0));this.oldValue=a},300)});d.on("change",".tdc-tab-no-design .tdc-property-dropdown.tdc-add-class input.tdc-property-input-radio",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this);var d=b.val(),
a=tdcIFrameData.getModel(b.data("model_id"));tdcSidebarController.onUpdate(a,b.data("param_name"),this.oldValue,d);this.oldValue=d}});d.on("change focus",".tdc-tab-no-design .tdc-innerRow-col-dropdown select",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var d=tdcSidebar._$currentInnerRow.data("model_id");d=tdcIFrameData.getModel(d);tdcIFrameData.changeInnerRowModel(d,this.oldValue,b);d.getShortcodeRender(tdcIFrameData.getColumnNumber(d),null,
!0);this.oldValue=b}});d.on("change",".tdc-tab-no-design .tdc-innerRow-col-dropdown input.tdc-property-input-radio",function(b){"undefined"!==typeof tdcSidebarPanel.timerChangingInnerColumns&&clearTimeout(tdcSidebarPanel.timerChangingInnerColumns);var d=jQuery(this);tdcSidebarPanel.timerChangingInnerColumns=setTimeout(function(){var a=d.val(),c=tdcSidebar._$currentInnerRow.data("model_id");c=tdcIFrameData.getModel(c);var b=c.get("childCollection");this.oldValue="11";_.isUndefined(b)||(b=tdcIFrameData.getChildCollectionWidths(b),
...
b}});d.on("click",".tdc-tab-no-design .tdc-open-wpeditor",function(b){b.preventDefault();var d=jQuery(this);b=jQuery("#tdc-wpeditor");var a=b.children(".content"),c=d.data("mapped_parameter_name");d=d.data("model_id");var h=tdcIFrameData.getModel(d).get("parentModel").get("attrs"),k="tdc-three-column";if(_.has(h,"width"))switch(h.width){case "1/3":k="tdc-one-column";break;case "2/3":k="tdc-two-column"}a.addClass("tdc-dropped-wpeditor");a.html('<iframe id="tdc-iframe-wpeditor" class="'+k+'" src="'+
window.tdcAdminSettings.pluginUrl+"/includes/wpeditor.php?wp_path="+window.tdcAdminSettings.ABSPATH+'" scrolling="auto" style="width: 100%; height: 100%" data-model_id="'+d+'" data-mapped_parameter_name="'+c+'"></iframe>');b.show();tdcWindowFrame.setWindowFrame(b)});d.on("click","#tdc-wpeditor .tdc-iframe-close-button",function(b){b.preventDefault();jQuery("#tdc-wpeditor").hide()});d.on("click","#tdc-zone .tdc-iframe-close-button",function(b){b.preventDefault();jQuery("#tdc-zone").hide()});d.on("click",
".tdc-sidebar-shortcode-row",function(b){b=jQuery(b.currentTarget).data("model_id");b=tdcIFrameData.getModel(b);var d={error:f,getShortcode:""};_.isUndefined(b)||tdcIFrameData._checkModelData(b,d);_.isUndefined(d.getShortcode)||console.log(d.getShortcode)});d.on("click",".tdc-sidebar-current-styles-settings",function(b){b=tdcSidebarPanel.getCurrentStyleSettings(b);if(!_.isUndefined(b)){var d="",a;for(a in b)d+='"'+a+'" => "'+b[a]+'",\n';console.log(d)}});d.on("click",".tdc-sidebar-font-reset",function(b){tdConfirm.modal({caption:"Clear Font Settings",
htmlInfoContent:"This will clear all values for this font group settings.",textYes:"Yes",objectContext:this,callbackYes:function(){tb_remove();var b=jQuery(this),a=b.data("model_id"),c=tdcIFrameData.getModel(a),d=c.get("attrs");d=_.clone(d);for(var k="font-family font-size font-line-height font-style font-weight font-transform font-spacing".split(" "),f="",m=0;m<k.length;m++){var g=b.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+k[m]+":first");if(g.length){var n=g.find('[data-model_id="'+a+'"]');
n.length&&(n.val(""),n.data("responsive",""),g.removeClass("tdc-css-inherited"),f=g.find(".tdc-inherit"),f.length&&f.hide(),f=n.data("placeholder"),"undefined"!==typeof f&&n.attr("placeholder",f),f=n.data("param_name"),delete d[f],n=n.attr("name"),tdcSidebarPanel.deleteResponsiveValues(n))}}c.set("attrs",d);tdcSidebarController.onUpdate(c,f,"","")}})});d.on("click",".tdc-sidebar-font-save",function(b){b=jQuery(this);var d=b.data("model_id");d=tdcIFrameData.getModel(d).get("attrs");var a=b.data("param_name").replace("font_settings",
""),c="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" "),h={};_.each(d,function(b,d,e){if(0===d.indexOf(a))for(e=0;e<c.length;e++)if(0<d.indexOf(c[e])){h[c[e]]=b;break}});_.isEmpty(h)||tdConfirm.modal({caption:"Saving Font Settings",htmlInfoContent:function(){setTimeout(function(){jQuery("#TB_ajaxContent").find("input").focus()},100);return'<label>Font Name: </label><input type="text" autofocus><div class="info"></div>'},textYes:"Save",textNo:"Cancel",
...
"undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts)){var h=jQuery("#tdc-font-list");h.length||(h=tdcSidebar.buildFontList(a,c));h.html("");"undefined"!==typeof window.tdcAdminSettings.tdcSavings.fonts&&(jQuery('<div class="tdc-font-list-header"><span>Saved fonts</span></div>').appendTo(h),_.map(window.tdcAdminSettings.tdcSavings.fonts,function(b){jQuery('<div class="tdc-font-settings" data-value="'+b.value+'" data-model_id="'+a+'" data-param_name="'+c+'"><span class="tdc-font-name">'+
b.name+'</span><span class="tdc-font-delete"></span></div>').appendTo(h)}));if("undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts){jQuery('<div class="tdc-font-list-header"><span>Recent fonts</span></div>').appendTo(h);b=_.invert(window.tdcAdminSettings.mappedFontFamily);for(var f=window.tdcAdminSettings.tdcSavings.recentFonts.length;0<f;f--){var l=window.tdcAdminSettings.tdcSavings.recentFonts[f],m=b[l];_.isUndefined(m)||jQuery('<div class="tdc-recent-font-settings" data-value="'+
l+'" data-model_id="'+a+'" data-param_name="'+c+'"><span class="tdc-font-name">'+m+'</span><span class="tdc-recent-font-delete"></span></div>').appendTo(h)}}d.after(h);h.toggle()}});d.on("click",".tdc-font-delete",function(b){b.stopImmediatePropagation();var d=jQuery(this).closest(".tdc-font-settings");b=d.data("name");b=_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,{name:b});window.tdcAdminSettings.tdcSavings.fonts.splice(b,1);tdcUtil.updateTdcSavings(this,function(){d.remove()})});d.on("click",
".tdc-recent-font-delete",function(b){b.stopImmediatePropagation();var d=jQuery(this).closest(".tdc-recent-font-settings");b=d.data("name");b=_.findIndex(window.tdcAdminSettings.tdcSavings.recentFonts,{name:b});window.tdcAdminSettings.tdcSavings.recentFonts.splice(b,1);tdcUtil.updateTdcSavings(this,function(){d.remove()})});d.on("click",".tdc-font-settings",function(){var b=jQuery(this),d=b.data("value");d=JSON.parse(window.atob(d));var a=b.data("model_id");a=tdcIFrameData.getModel(a);var c=a.get("attrs"),
h=b.data("param_name").replace("font_settings",""),f="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" ");_.each(d,function(a,b,d){-1!==_.indexOf(f,b)&&(c[h+b]=a)});a.set({attrs:c,rebindToPanel:!0});tdcSidebarController.onUpdate(a)});d.on("click",".tdc-recent-font-settings",function(){var b=jQuery(this),d=b.data("value"),a=b.data("model_id");a=tdcIFrameData.getModel(a);var c=a.get("attrs");b=b.data("param_name").replace("font_settings","");c[b+"font_family"]=
d;a.set({attrs:c,rebindToPanel:!0});tdcSidebarController.onUpdate(a)});tdcSidebarPanel.$_paramNameSwitch=d.find(".tdc-param-name-switch");if(0<tdcSidebarPanel.$_paramNameSwitch.length)d.on("click",".tdc-param-name-switch",function(){jQuery(this).toggleClass("tdc-param-name-switch-active");jQuery(".tdc-param-name").toggleClass("tdc-param-name-active")})},getCurrentStyleSettings:function(d,b){_.isUndefined(b)&&(b=jQuery(d.currentTarget).data("model_id"),b=tdcIFrameData.getModel(b),d={error:f},_.isUndefined(b)||
tdcIFrameData._checkModelData(b,d));var e=b.get("tag");b=b.get("attrs");b=_.clone(b);if(!_.isUndefined(b)){var a={};d={};for(var c in b)0===c.indexOf("tds_")&&(a[c]=b[c]);c=window.tdcAdminSettings.mappedShortcodes[e].params;for(e=0;e<c.length;e++){var h=!1,k=c[e];if(0===k.param_name.indexOf("tds_")){for(var l in a)if(k.param_name===l){d[l]=a[l];h=!0;break}h||(d[k.param_name]="")}}for(l in a)switch(a=l.split("-"),a.length){case 2:if(!_.has(d,l)){c=a[0];a=!1;for(var m in d)if(c===d[m]&&1===m.split("-").length){a=
!0;break}if(!a){var g;for(g in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[g],c)){var n=g;break}_.has(d,n)&&""===d[n]&&window.tdcAdminSettings.globalStyle[n]===c&&(a=!0)}a||delete b[l]}break;case 3:c=a[0];e=a[2];for(g in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[g],c)){n=g;break}a=!1;for(m in d)if(c===d[m]&&m===n+"-"+e){a=!0;break}a||_.has(d,n+"-"+e)&&""===d[n+"-"+e]&&window.tdcAdminSettings.globalStyle[n]===c&&(a=
!0);a||delete b[l]}return b}},getCurrentListAtts:function(d,b,e){_.isUndefined(b)&&(d=jQuery(d.currentTarget).data("model_id"),b=tdcIFrameData.getModel(d),d={error:f},_.isUndefined(b)||tdcIFrameData._checkModelData(b,d));d=b.get("tag");b=b.get("attrs");var a=_.clone(b);if(!_.isUndefined(a)){var c={};b={};for(var h in a)0===h.indexOf("tds_")&&(c[h]=a[h]);h=window.tdcAdminSettings.mappedShortcodes[d].params;for(var k=0;k<h.length;k++){var l=!1,m=h[k];if(0===m.param_name.indexOf("tds_")){for(var g in c)if(m.param_name===
g){b[g]=c[g];l=!0;break}l||(b[m.param_name]="")}}for(g in c)switch(c=g.split("-"),c.length){case 2:if(!_.has(b,g)){h=c[0];c=!1;for(var n in b)if(h===b[n]&&1===n.split("-").length){c=!0;break}if(!c){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],h)){var q=p;break}_.has(b,q)&&""===b[q]&&window.tdcAdminSettings.globalStyle[q]===h&&(c=!0)}c||delete a[g]}break;case 3:h=c[0];l=c[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],
h)){q=p;break}c=!1;for(n in b)if(h===b[n]&&n===q+"-"+l){c=!0;break}c||_.has(b,q+"-"+l)&&""===b[q+"-"+l]&&window.tdcAdminSettings.globalStyle[q]===h&&(c=!0);c||delete a[g]}var t=[],v;for(v in window.tdcAdminSettings.listStyles[e])if(v===d){for(k=0;k<window.tdcAdminSettings.listStyles[e][v].length;k++)g=window.tdcAdminSettings.listStyles[e][v][k],_.isArray(g)?_.map(g,function(c){_.isUndefined(a[c])||(_.isUndefined(t[k])&&(t[k]=[]),t[k].push(a[c]))}):_.isUndefined(a[g])||(_.isArray(a[g])&&a[g].length?
t[k]=a[g][0]:t[k]=a[g]);break}return t}},showHideTdcCssEditor:function(d){d=jQuery("#tdc-editor-css");var b=jQuery(this).closest(".tdc-property-wrap"),e=b.find("textarea:first");d.length||tdcSidebar.buildEditorCss();tdcSidebar.$editorTextarea=e;b.next("#tdc-editor-css").length?d.toggle():(b.after(d),d.show(),tdcSidebar.editorCss.getSession().setValue(e.val()))},showHideTdcPalette:function(d){d=jQuery("#tdc-palette");var b=jQuery(this).closest(".tdc-property-wrap");d.length||tdcSidebar.buildPalette();
b.next("#tdc-palette").length?(d.toggle(),tdcSidebarPanel.saveTdcPalette()):(tdcSidebarPanel.saveTdcPalette(),b.after(d),d.show(),tdcSidebarPanel.openTdcPalette())},saveTdcPalette:function(){var d=jQuery("#tdc-palette"),b=d.prev(".tdc-property-wrap");d.length||tdcSidebar.buildPalette();b.length&&(b=b.find("input").val(),d=d.find("input.wp-color-picker"),d.tdPaletteColorPicker("open_palette",b),d.tdPaletteColorPicker("save_color"))},openTdcPalette:function(){var d=jQuery("#tdc-palette"),b=d.prev(".tdc-property-wrap");
d.length||tdcSidebar.buildPalette();b.length&&(b=b.find("input").val(),d.find("input.wp-color-picker").tdPaletteColorPicker("open_palette",b))},tdcIconWrapHandler:function(d){var b=jQuery(this),e=jQuery("#tdc-icon-selector");e.length||(e=tdcSidebar.buildIconSelector());var a=b.closest(".tdc-property-wrap");d=e.find(".tdc-icon-selector-filter");var c=e.find(".tdc-icon-selector-lib"),h=e.find(".tdc-icon-selector-content");c.val("");d.val("");h.children().each(function(){jQuery(this).show()});e.data("model_id",
b.data("model_id"));e.data("param_name",b.data("param_name"));e.show();a.after(e);b=e.data("param_name");e=tdcIFrameData.getModel(e.data("model_id")).get("attrs");var f="";_.has(e,b)&&(f=e[b].trim());d.focus();h.find("span").each(function(){var a=jQuery(this),b=a.data("font_class");if(f===b){for(a.addClass("selected");!a.prev(".tdc-font-separator").length;)a=a.prev();a=a.prev(".tdc-font-separator").data("font_id");c.val(a);c.trigger("change")}else a.removeClass("selected")})},tdcIconRemoveHandler:function(d){var b=
jQuery(d.currentTarget);d=b.closest(".tdc-property-wrap").find(".tdc-icon-wrap");b.addClass("tdc-hidden-button");d.addClass("tdc-no-icon-selected");d.html("");b=d.data("model_id");b=tdcIFrameData.getModel(b);tdcSidebarController.onUpdate(b,d.data("param_name"),"","")},tdcImageWrapHandler:function(d){var b=jQuery(d.currentTarget);b.closest(".tdc-tab-content");window.original_send_to_editor=window.send_to_editor;wp.media.editor.open(b);jQuery(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");
jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(d){var a=jQuery("img",d).attr("src"),c="",e="",f="";"undefined"===typeof a?(a=jQuery(d).attr("src"),c=jQuery(d).attr("class"),e=jQuery(d).attr("height"),f=jQuery(d).attr("width")):(c=jQuery("img",d).attr("class"),e=jQuery("img",d).attr("height"),f=jQuery("img",d).attr("width"));jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:c,action:"tdc_ajax_get_image_id"}}).done(function(c,d,h){"success"===d&&(_.isObject(c)&&_.has(c,"errors")?new tdcNotice.notice(c.errors,!0,!1):(b.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),b.attr("style","background-image: url( '"+a+"') "),b.data("image_link",a),b.data("image_id",c.image_id),b.data("image_height",
e),b.data("image_width",f),b.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,window.tb_remove(),d="",h=b.data("model_id"),h=tdcIFrameData.getModel(h),b.hasClass("tdc-no-image-selected")||(d=c.image_id.toString()),c=h.get("attrs"),c.media_size_image_height=e,c.media_size_image_width=f,h.set("attrs",c),tdcSidebarController.onUpdate(h,b.data("param_name"),"",d)))}).fail(function(a,c,b){})};return!1},tdcImageRemoveHandler:function(d){var b=jQuery(d.currentTarget);
d=b.closest(".tdc-property-wrap").find(".tdc-image-wrap");b.addClass("tdc-hidden-button");d.addClass("tdc-no-image-selected");jQuery.removeData(d,"image_link");d.attr("style","background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png'");b=d.data("model_id");b=tdcIFrameData.getModel(b);tdcSidebarController.onUpdate(b,d.data("param_name"),"","")},tdcInheritSelectHandler:function(d){d=jQuery(d.currentTarget);var b=d.closest(".tdc-property-wrap"),e=b.find("[data-responsive]"),
a=tdcSidebarPanel.getCurrentResponsiveValue(e.attr("name"),"all");b.hasClass("tdc-property-dropdown-responsive")&&("undefined"===typeof a?(b.removeClass("tdc-css-inherited"),e.find("option:selected").removeAttr("selected").find("option:first").attr("selected","selected")):(e.val(a),b.addClass("tdc-css-inherited")),b=tdcSidebarPanel.deleteResponsiveValue(e.attr("name"),tdcSidebar.currentViewportSettings.name),a=tdcIFrameData.getModel(e.data("model_id")),e=e.data("param_name"),tdcSidebarController.onUpdate(a,
e,"",b));d.hide()},tdcInheritCheckboxHandler:function(d){d=jQuery(d.currentTarget);var b=d.closest(".tdc-property-wrap"),e=b.find("[data-responsive]"),a=tdcSidebarPanel.getCurrentResponsiveValue(e.attr("name"),"all");b.hasClass("tdc-property-checkbox-responsive")&&("undefined"===typeof a?(b.removeClass("tdc-css-inherited"),e.removeAttr("checked")):(""===a?e.removeAttr("checked"):e.attr("checked","checked"),b.addClass("tdc-css-inherited")),b=tdcSidebarPanel.deleteResponsiveValue(e.attr("name"),tdcSidebar.currentViewportSettings.name),
a=tdcIFrameData.getModel(e.data("model_id")),e=e.data("param_name"),tdcSidebarController.onUpdate(a,e,"",b));d.hide()},bindPanelToModel:function(d,b){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==d.cid||!_.isUndefined(b)&&(_.isUndefined(b)||!0===b)){b=window.tdcAdminSettings.mappedShortcodes[d.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=d;for(var e=[],a=0;a<b.params.length;a++){var c=
tdcSidebarPanel._defaultGroupName;_.isEmpty(b.params[a].group)||(c=b.params[a].group);e.push(c)}e=_.uniq(e);var h=c="",f=tdcSidebar.getCurrentTabId(),l,m;c+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var g=m=l="";for(a=0;a<e.length;a++){h=tdcSidebarPanel._fixGroupName(e[a]);var n=tdcUtil.makeSafeForCSS(h);0===a?(l='<a href="#" data-tab-id="td-tab-'+n+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>',m='<a href="#" data-tab-id="td-tab-'+
n+'" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>'):_.isUndefined(f)||f!=="td-tab-"+n?g+='<a href="#" data-tab-id="td-tab-'+n+'" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>':(l=m,g+='<a href="#" data-tab-id="td-tab-'+n+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>')}h=n=m=a="";switch(tdcSidebar.currentViewportSettings.name){case "all":a="selected";break;case "landscape":m="selected";
break;case "portrait":n="selected";break;case "phone":h="selected"}c=c+(l+g)+'</div><div class="tdc-tab-responsive">';c+='<div class="tdc-responsive-buttons">';c+='<div class="tdc-responsive-all '+a+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>';"Newspaper"===window.tdcAdminSettings.themeName&&(c+='<div class="tdc-responsive-tablet-landscape '+m+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>');c+='<div class="tdc-responsive-tablet-portrait '+
n+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>';c+='<div class="tdc-responsive-phone '+h+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>';c+="</div>";c+="</div>";c+='<div class="tdc-search">';c+='<i class="td-icon-search"></i>';c+='<input type="text" placeholder="Search settings..." />';c+="</div></div>";c+='<div class="tdc-sidebar-sticky-a"></div>';c+='<div class="tdc-sidebar-sticky-b"></div>';c+='<div class="tdc-tab-content-wrap">';g=m=l=
"";for(a=0;a<e.length;a++){h=tdcSidebarPanel._fixGroupName(e[a]);n=tdcUtil.makeSafeForCSS(h);h="tdc-tab-no-design";var p=d.get("tag");"css"===n&&(h="tdc-tab-design");0===a?(l='<div class="tdc-tab-content tdc-tab-content-visible '+h+'" id="td-tab-'+n+'">',m='<div class="tdc-tab-content '+h+'" id="td-tab-'+n+'">',n=window.tdcAdminSettings.mappedShortcodes[p].tdc_start_values,d.unset("presetValues"),_.isUndefined(n)||(n=JSON.parse(window.atob(n)),_.isArray(n)&&1<n.length&&d.set("presetValues",n)),d.has("presetValues")&&
(n=d.get("presetValues"),g+=tdcSidebarPanel._addPresetValuesSelector(n,d))):_.isUndefined(f)||f!=="td-tab-"+n?g+='<div class="tdc-tab-content '+h+'" id="td-tab-'+n+'">':(l=m,g+='<div class="tdc-tab-content tdc-tab-content-visible '+h+'" id="td-tab-'+n+'">');g+=tdcSidebarPanel._bindGroupAndGetHtml(e[a],b,d);n=' data-model_id="'+d.cid+'" ';"dev"===window.tdcAdminSettings.deployMode&&(g+='<div class="tdc-sidebar-row-buttons">',g+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+n+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>',
g+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+n+' title="Get the current styles\' settings">CONSOLE: style presets</div>',g+="</div>");g+="</div>"}c=c+(l+g)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(c);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");tdcSidebarPanel._hook.addAction("panel_rendered",function(){"undefined"===typeof window.tdcResponsiveValues&&(window.tdcResponsiveValues={},"all"===tdcSidebar.currentViewportSettings.name?jQuery(".tdc-tab-content-wrap").removeClass("tdc-viewport-responsive"):
jQuery(".tdc-tab-content-wrap").addClass("tdc-viewport-responsive"),jQuery(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=jQuery(this),c=a.find("[data-responsive]"),b=c.attr("name"),d=c.data("responsive");try{var e=window.atob(d);window.tdcResponsiveValues[b]=JSON.parse(e)}catch(w){d={},a.hasClass("tdc-property-textfield-responsive")?""!==c.val()&&(d.all=c.val()):a.hasClass("tdc-property-dropdown-responsive")?c.find("option:first").val()!==c.val()&&(d.all=c.val()):a.hasClass("tdc-property-checkbox-responsive")?
c.is(":checked")&&(d.all=c.val()):a.hasClass("tdc-property-range-responsive")?d.all=c.data("value"):a.hasClass("tdc-property-range_multiple-responsive")&&(d.all=c.data("range_value")+c.data("range_unit")),window.tdcResponsiveValues[b]=d}tdcSidebarPanel.setViewportCurrentResponsiveValue(c)}))});tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-tab-content-wrap").find('select[name$="font_family"]').change(function(a){a=jQuery(this).val();""===window.tdcAdminSettings.tdcSavings&&
...
"11");var b=d.get("parentModel").get("attrs"),e="";_.has(b,"width")&&(e=b.width.replace("/",""));if(a.length)switch(a.val(c),e){case "":case "11":a.find("option[value=12_12]").addClass("tdc-block-col");a.find("option[value=23_13]").removeClass("tdc-block-col");a.find("option[value=13_23]").removeClass("tdc-block-col");a.find("option[value=13_13_13]").removeClass("tdc-block-col");break;case "13":a.find("option[value=12_12]").addClass("tdc-block-col");a.find("option[value=23_13]").addClass("tdc-block-col");
a.find("option[value=13_23]").addClass("tdc-block-col");a.find("option[value=13_13_13]").addClass("tdc-block-col");break;case "23":a.find("option[value=12_12]").removeClass("tdc-block-col"),a.find("option[value=23_13]").addClass("tdc-block-col"),a.find("option[value=13_23]").addClass("tdc-block-col"),a.find("option[value=13_13_13]").addClass("tdc-block-col")}else if(a=jQuery('body .tdc-innerRow-col-dropdown input[value="'+c+'"]'),a.length)switch(a.attr("checked","checked"),a.next("label").show(),
e){case "":case "11":a.parent().find("input[value=12_12] + label").addClass("tdc-block-col");a.parent().find("input[value=23_13] + label").removeClass("tdc-block-col");a.parent().find("input[value=13_23] + label").removeClass("tdc-block-col");a.parent().find("input[value=13_13_13] + label").removeClass("tdc-block-col");break;case "13":a.parent().find("input[value=12_12] + label").addClass("tdc-block-col");a.parent().find("input[value=23_13] + label").addClass("tdc-block-col");a.parent().find("input[value=13_23] + label").addClass("tdc-block-col");
a.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col");break;case "23":a.parent().find("input[value=12_12] + label").removeClass("tdc-block-col"),a.parent().find("input[value=23_13] + label").addClass("tdc-block-col"),a.parent().find("input[value=13_23] + label").addClass("tdc-block-col"),a.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})()}},_bindGroupAndGetHtml:function(d,b,e){var a="",c=e.get("attrs");if("tdc_zone"===e.get("tag"))var h=c.type;for(var f=
0;f<b.params.length;f++){var l=b.params[f].param_name,m=b.params[f].group;if(d===tdcSidebarPanel._defaultGroupName&&_.isEmpty(b.params[f].group)||b.params[f].group===d){if(!_.isUndefined(h)&&(!_.isUndefined(b.params[f].zone_group)&&h!==b.params[f].zone_group||"type"===l))continue;a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[f],e)}if("block_template_id"===l){m=c.block_template_id;_.isEmpty(m)&&(m=window.tdcAdminSettings.globalBlockTemplate);l=window.tdcAdminSettings.mappedBlockTemplates;for(var g=
0;g<l[m].params.length;g++)if(d===tdcSidebarPanel._defaultGroupName&&_.isEmpty(l[m].params[g].group)||l[m].params[g].group===d)a+=tdcSidebarPanel._bindParamAndGetHtml(l[m].params[g],e)}else if(0===l.indexOf("tds_")){var n=l.split("-");g=n[0];var p;2===n.length?p=n[1]:2<n.length&&new tdcNotice.notice('Param "'+l+'" must have up to at most one "-" separator ',!0,!1);l=c[l];_.isEmpty(l)&&(l=window.tdcAdminSettings.globalStyle[g]);n=window.tdcAdminSettings.settingsStyle[g];for(g=0;g<n[l].params.length;g++)if(m==
d||_.isUndefined(m)&&d===tdcSidebarPanel._defaultGroupName){var q=JSON.parse(JSON.stringify(n[l].params[g]));q.param_name=l+"-"+q.param_name;_.isUndefined(p)||(q.param_name+="-"+p);a+=tdcSidebarPanel._bindParamAndGetHtml(q,e)}}}return a},_bindParamAndGetHtml:function(d,b){switch(d.type){case "custom":return tdcSidebarPanel.addCustom(d,b);case "colorpicker":return tdcSidebarPanel.addColorpicker(d,b);case "gradient":return tdcSidebarPanel.addGradient(d,b);case "dropdown":return tdcSidebarPanel.addDropDown(d,
b);case "dropdown-responsive":return tdcSidebarPanel.addDropDownResponsive(d,b);case "checkbox":return tdcSidebarPanel.addCheckBox(d,b);case "checkbox-responsive":return tdcSidebarPanel.addCheckBoxResponsive(d,b);case "range":return tdcSidebarPanel.addRange(d,b);case "range-responsive":return tdcSidebarPanel.addRangeResponsive(d,b);case "range_multiple":return tdcSidebarPanel.addRangeMultiple(d,b);case "range_multiple-responsive":return tdcSidebarPanel.addRangeMultipleResponsive(d,b);case "icon":return tdcSidebarPanel.addIconSelector(d,
b);case "attach_image":return tdcSidebarPanel.addUploadImage(d,b);case "textfield":return tdcSidebarPanel.addTextField(d,b);case "do_shortcode_textfield":return tdcSidebarPanel.addDoShortcode(d,b);case "textfield-responsive":return tdcSidebarPanel.addTextFieldResponsive(d,b);case "textarea_html":return tdcSidebarPanel.addTextAreaHtml(d,b);case "textarea_raw_html":return tdcSidebarPanel.addTextAreaRawHtml(d,b);case "editor_css":return tdcSidebarPanel.addEditorCss(d,b);case "css_editor":return"";case "tdc_css_editor":return tdcCssEditor.init(),
tdcCssEditor.addComposerCssEditor(d,b);case "horizontal_separator":return tdcSidebarPanel.addSeparatorHorizontal(d,b);case "text_separator":return tdcSidebarPanel.addTextSeparatorHorizontal(d,b);case "font_header":return tdcSidebarPanel.addFontHeader(d,b);case "font_title":return tdcSidebarPanel.addFontTitle(d,b);case "font_reset":return tdcSidebarPanel.addFontReset(d,b);case "font_save":return tdcSidebarPanel.addFontSave(d,b);case "font_load":return tdcSidebarPanel.addFontLoad(d,b);case "font_settings":return tdcSidebarPanel.addFontSettings(d,
...
"menu_id"===d.param_name){var e=b.get("attrs");e.menu_id=window.tdcPostSettings.mobileMenuId;b.set("attrs",e)}var a=e=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",f="",k=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&k.length<=parseInt(d.tdc_min_options))return c;for(var l=0;l<k.length;l++){var m=!1,g="",n="",p=k[l],q=String(tdcSidebarPanel._getParameterCurrentValue(d,b)),t=String(d.value[k[l]]);
_.isObject(d.value[k[l]])&&(m=!0,t=_.values(d.value[k[l]])[0],p=_.keys(d.value[k[l]])[0]);if(e||a){0===l&&""===q&&(q=t);q===t&&(g=" checked ");n=_.uniqueId();q=t;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)q="col_"+q;f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+n+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+g+' value="'+t+'">';e?(g="",m&&(g="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+
g+'" for="'+n+'" title="'+p+'"><div class="'+q+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+n+'" title="'+p+'">'+t+"</label>"}else q===t&&(g=' selected="selected" '),"__"===t&&-1!==p.search("--")&&(n=" disabled "),f+="<option "+g+" "+n+' value="'+t+'">'+p+"</option>"}k="";_.has(d,"description")&&""!==d.description&&(k=' title="'+d.description+'" ');c+='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+
k+">"+d.heading+"</span></div>";c+='<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'">',c=c+f+"</select>");c=c+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return c+"</div>"},addDropDownResponsive:function(d,b){var e=!1,a=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",f="",k=Object.keys(d.value);
if(_.has(d,"tdc_min_options")&&k.length<=parseInt(d.tdc_min_options))return c;var l=' data-responsive="" ',m=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var g=JSON.parse(window.atob(m));l=' data-responsive="'+m+'" ';"undefined"!==typeof g[tdcSidebar.currentViewportSettings.name]&&(m=g[tdcSidebar.currentViewportSettings.name])}catch(r){}for(g=0;g<k.length;g++){var n=!1,p="",q=k[g],t=String(d.value[k[g]]);_.isObject(d.value[k[g]])&&(n=!0,t=_.values(d.value[k[g]])[0],q=_.keys(d.value[k[g]])[0]);
if(e||a){0===g&&""===m&&(m=t);m===t&&(p=" checked ");var v=_.uniqueId(),u=t;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)u="col_"+u;f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+p+' value="'+t+'" '+l+">";e?(p="",n&&(p="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+p+'" for="'+v+'" title="'+q+'"><div class="'+u+'"></div></label>'):f+=
'<label class="tdc-property-input-radio-label" for="'+v+'" title="'+q+'">'+t+"</label>"}else m===t&&(p=' selected="selected" '),f+="<option "+p+' value="'+t+'">'+q+"</option>"}k="";_.has(d,"description")&&""!==d.description&&(k=' title="'+d.description+'" ');c+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+k+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';
c+='<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+l+k+">",c=c+f+"</select>");c=c+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return c+"</div>"},addCheckBox:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(a=" checked ");var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+
'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";c=c+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="checkbox" value="yes" '+a+"/>");c=c+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return c+"</div>"},addCheckBoxResponsive:function(d,b){var e="",a=' data-responsive="" ',c=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var f=
JSON.parse(window.atob(c));a=' data-responsive="'+c+'" ';"undefined"!==typeof f[tdcSidebar.currentViewportSettings.name]&&(c=f[tdcSidebar.currentViewportSettings.name])}catch(k){}""!==c&&(e=" checked ");f="";_.has(d,"description")&&""!==d.description&&(f=' title="'+d.description+'" ');c='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+f+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';
...
var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);var k="";_.has(d,"value")&&""!==d.value&&(k=d.value);var l="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(l=tdcSidebarPanel._getParameterCurrentValue(d,b));var m='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';m+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";m=m+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+
'" type="range" data-value="'+l+'" data-min="'+c+'" data-max="'+a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+l+'" />');m=m+('<input type="text" class="tdc_range_value" data-default_value="'+k+'" value="'+l+'"/></div><span class="tdc-param-name">')+(d.param_name+"</span>");return m+="</div>"},addRangeResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";_.has(d,"range_max")&&""!==d.range_max&&(a=d.range_max);
var c="";_.has(d,"range_min")&&""!==d.range_min&&(c=d.range_min);var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);var k="";_.has(d,"value")&&""!==d.value&&(k=d.value);""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&tdcSidebarPanel._getParameterCurrentValue(d,b);var l="";_.has(d,"placeholder")&&""!==d.placeholder&&(l=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var m=' data-responsive="" ',g=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var n=
JSON.parse(window.atob(g));m=' data-responsive="'+g+'" ';g="undefined"===typeof n[tdcSidebar.currentViewportSettings.name]?"":n[tdcSidebar.currentViewportSettings.name]}catch(p){}n='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';n+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";n=n+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" data-value="'+
g+'" data-min="'+c+'" data-max="'+a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+g+'" '+m+" />");n=n+('<input type="text" class="tdc_range_value" data-default_value="'+k+'" '+l+' value="'+g+'"/></div><span class="tdc-param-name">')+(d.param_name+"</span>");return n+="</div>"},addRangeMultiple:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),f="",k="",l=[],m=
"",g="",n="",p="",q="",t="",v="",u;for(u in a)a.hasOwnProperty(u)&&(l.push(a[u].unit),""===g||""===m)&&(p=a[u].unit,g=' data-range_unit="'+p+'" ',n=a[u].value,m=' data-range_value="'+n+'" ',q=a[u].range_min,t=a[u].range_max,v=a[u].range_step);if(""!==c){for(var r=[],w=0;w<l.length&&!(r=c.split(l[w]),1<r.length);w++);r.length&&(p=l[w],g=' data-range_unit="'+p+'" ',n=r[0],m=' data-range_value="'+n+'" ')}for(u in a)a.hasOwnProperty(u)&&(c=_.uniqueId(),f+=" data-value_"+u+'="'+a[u].value+'" ',f+=" data-min_"+
u+'="'+a[u].range_min+'" ',f+=" data-max_"+u+'="'+a[u].range_max+'" ',f+=" data-step_"+u+'="'+a[u].range_step+'" ',l=a[u].value,r="",a[u].unit===p&&(l=n,q=a[u].range_min,t=a[u].range_max,v=a[u].range_step,r="checked"),k+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+u+'" data-unit_value="'+a[u].unit+'" type="radio" id="'+c+'" '+r+' data-default_value="'+a[u].value+'" data-last_value="'+l+'"/>',k+='<label for="'+c+'">'+a[u].unit+"</label>");a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+
'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+m+" "+g+" "+f+' min="'+q+'" max="'+t+'" step="'+v+'" value="'+n+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+k+'</div><input type="text" class="tdc_range_value" value="'+(n+'"/>');
a+="</div>";a+="</div>";a+='<span class="tdc-param-name">'+d.param_name+"</span>";return a+="</div>"},addRangeMultipleResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),f="",k="",l=[],m=' data-responsive="" ',g="",n="",p="",q="",t="",v="",u="",r;for(r in a)a.hasOwnProperty(r)&&(l.push(a[r].unit),""===n||""===g)&&(q=a[r].unit,n=' data-range_unit="'+q+'" ',p=a[r].value,g=
' data-range_value="'+p+'" ',t=a[r].range_min,v=a[r].range_max,u=a[r].range_step);if(""!==c){var w=c;try{var A=JSON.parse(window.atob(c));m=' data-responsive="'+c+'" ';w="undefined"===typeof A[tdcSidebar.currentViewportSettings.name]?"":A[tdcSidebar.currentViewportSettings.name]}catch(x){}if(""!==w){c=[];for(A=0;A<l.length&&!(c=w.split(l[A]),1<c.length);A++);c.length&&(q=l[A],n=' data-range_unit="'+q+'" ',p=c[0],g=' data-range_value="'+p+'" ')}}for(r in a)a.hasOwnProperty(r)&&(l=_.uniqueId(),f+=" data-value_"+
r+'="'+a[r].value+'" ',f+=" data-min_"+r+'="'+a[r].range_min+'" ',f+=" data-max_"+r+'="'+a[r].range_max+'" ',f+=" data-step_"+r+'="'+a[r].range_step+'" ',w=a[r].value,c="",a[r].unit===q&&(w=p,t=a[r].range_min,v=a[r].range_max,u=a[r].range_step,c="checked"),k+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+r+'" data-unit_value="'+a[r].unit+'" type="radio" id="'+l+'" '+c+' data-default_value="'+a[r].value+'" data-last_value="'+w+'"/>',k+='<label for="'+l+'">'+a[r].unit+
"</label>");a='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+g+" "+n+" "+f+" "+m+' min="'+t+'" max="'+v+'" step="'+u+'" value="'+p+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+
k+'</div><input type="text" class="tdc_range_value" value="'+(p+'"/>');a+="</div>";a+="</div>";a+='<span class="tdc-param-name">'+d.param_name+"</span>";return a+="</div>"},addIconSelector:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-icon-wrap tdc-no-icon-selected" '+
...
a=a+'</div><a class="tdc-image-remove tdc-hidden-button" href="#" >Remove</a></div><span class="tdc-param-name">'+(d.param_name+"</span>");a+="</div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-image-wrap").each(function(a,e){var c=jQuery(e);if(!c.parent().parent(".tdc-bg-upload").length&&d.param_name===c.data("param_name")){var f=tdcSidebarPanel._getParameterCurrentValue(d,b);""!==f&&jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_url",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_id:f,action:"tdc_ajax_get_image_url"}}).done(function(a,b,d){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(c.attr("style","background-image: url('"+a.image_url+"')").removeClass("tdc-no-image-selected"),c.data("image_link",a.image_url),c.data("image_id",f),c.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button")))}).fail(function(a,
c,b){})}})});return a},addTextField:function(d,b){var e="",a="";if(_.has(d,"description")&&""!==d.description){var c=jQuery("<div>"+d.description+"</div>");d.description===c.text()?e=' title="'+d.description+'" ':a='<div class="tdc-description">'+d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var f='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';f+='<div class="tdc-property-title"><span class="tdc-search-data"'+
e+">"+d.heading+"</span></div>";f=f+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" '+c+' value="'+tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');f=f+a+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return f+="</div>"},addDoShortcode:function(d,b){var e=_.uniqueId("tdc_textarea_"),a="";_.has(d,"description")&&""!==d.description&&(a=' title="'+d.description+'" ');var c='<div class="'+
...
a=atob(a.target.value);jQuery("#"+e).val(a).trigger("focusin")});d.on("keyup focusin","#"+e,function(a){var c=jQuery(a.target),b=tdcIFrameData.getModel(c.data("model_id")),d=window.btoa(encodeURIComponent(c.val())),e=window.btoa(encodeURIComponent(a.target.oldValue));setTimeout(function(){tdcSidebarController.onUpdate(b,c.data("param_name"),e,d)},500)});return c},addTextFieldResponsive:function(d,b){var e="",a="";if(_.has(d,"description")&&""!==d.description){var c=jQuery("<div>"+d.description+"</div>");
d.description===c.text()?e=' title="'+d.description+'" ':a='<div class="tdc-description">'+d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var f=' data-responsive="" ',k=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var l=JSON.parse(window.atob(k));f=' data-responsive="'+k+'" ';k="undefined"===typeof l[tdcSidebar.currentViewportSettings.name]?"":l[tdcSidebar.currentViewportSettings.name]}catch(m){}l=
'<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';l+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";l=l+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" value="'+k+'" '+c+f+e+"/>");l=l+a+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return l+="</div>"},addTextAreaHtml:function(d,b){_.has(d,"description");
...
action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(d,b)}}).done(function(a,c,b){"success"===c&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):jQuery("#"+e).html(a.parsed_content).addClass("tdc-textarea-visible"))}).fail(function(a,c,b){});jQuery("body").on("keyup focusin","#"+e,function(a){var c=jQuery(a.target),b=tdcIFrameData.getModel(c.data("model_id"));if("focusin"!==a.type&&a.target.oldValue!==a.target.value){var d=window.btoa(encodeURIComponent(c.val())),
e=window.btoa(encodeURIComponent(a.target.oldValue));tdcSidebarController.onUpdate(b,c.data("param_name"),e,d)}a.target.oldValue=a.target.value});return c},addEditorCss:function(d,b){var e=_.uniqueId("tdc_textarea_"),a="";_.has(d,"description")&&""!==d.description&&(a=' title="'+d.description+'" ');var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data tdc-open-csseditor"'+a+">"+d.heading+"</span></div>";c=c+'<div class="tdc-property"><textarea id="'+
...
"",_.isUndefined(d.data("placeholder"))||(a=d.data("placeholder")),c=d.next('input[type="text"]'),c.attr("placeholder",a),_.isUndefined(b)?(b=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),_.isUndefined(b)?(d.val(""),c.val("")):(d.val(b),c.val(b),c.attr("placeholder",b),e.addClass("tdc-css-inherited"))):(d.val(b),c.val(b),e.removeClass("tdc-css-inherited"));else if(e.hasClass("tdc-property-range_multiple-responsive")){a=tdcIFrameData.getModel(d.data("model_id"));var f=d.data("param_name"),
k=window.tdcAdminSettings.mappedShortcodes[a.attributes.tag];a=[];for(var l=c="",m=0;m<k.params.length;m++)if(f===k.params[m].param_name){f=k.params[m].tdc_values;for(var g in f)f.hasOwnProperty(g)&&(a.push(f[g].unit),""===c||""===l)&&(c=f[g].value,l=f[g].unit);break}_.isUndefined(b)?(b=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),_.isUndefined(b)&&(d.data("range_value",c),d.data("range_unit",l),d.val(c),g=e.find('input[type="radio"][data-unit_value="'+l+'"]'),m=g.data("unit"),
f=d.data("min_"+m),l=d.data("max_"+m),m=d.data("step_"+m),k=d.get(0),g.prop("checked",!0),k.min=f,k.max=l,k.step=m,k.value=c,g.data("last_value",c),e.find('input[type="text"]').val(c)),"all"===tdcSidebar.currentViewportSettings.name?e.removeClass("tdc-css-inherited"):e.addClass("tdc-css-inherited")):e.removeClass("tdc-css-inherited");if(!_.isUndefined(b)){c=[];for(m=0;m<a.length&&!(c=b.split(a[m]),1<c.length);m++);c.length&&(c=c[0],l=a[m],d.data("range_value",c),d.data("range_unit",l),d.val(c),g=
e.find('input[type="radio"][data-unit_value="'+l+'"]'),m=g.data("unit"),f=d.data("min_"+m),l=d.data("max_"+m),m=d.data("step_"+m),k=d.get(0),g.prop("checked",!0),k.min=f,k.max=l,k.step=m,k.value=c,g.data("last_value",c),e.find('input[type="text"]').val(c))}}},showShortcodeFromPath:function(d){if(!_.isUndefined(d)){d=d.toString().split("_");var b;d.forEach(function(a,d){""!==a&&(_.isUndefined(b)?b=tdcIFrameData.tdcTopCollection.at(a):(d=b.get("childCollection"),!_.isUndefined(d)&&d.length>a&&(b=d.at(a))))});
...
f("#tdc-zone");tdcSidebar.$_headerTemplateZones=tdcSidebar.$_tdcZone.find(".tdc-header-template-zones");tdcSidebar.$_headerTemplateList=tdcSidebar.$_tdcZone.find(".tdc-header-template-list");tdcSidebar.$_footerTemplateList=tdcSidebar.$_tdcZone.find(".tdc-footer-template-list");window.tdcAdminSettings.tdbHeaderTemplates.forEach(function(b){tdcSidebar.$_headerTemplateList.append('<option value="'+b.val+'">'+b.text+"</option>")});window.tdcAdminSettings.tdbFooterTemplates.forEach(function(b){tdcSidebar.$_footerTemplateList.append('<option value="'+
b.val+'">'+b.text+"</option>")});tdcState.isGlobalTemplate()?tdcSidebar.$_headerTemplateList.find("option:first").attr("selected",!0):tdcState.isNoHeader()?tdcSidebar.$_headerTemplateList.find('option[value="no_header"]').attr("selected",!0):tdcSidebar.$_headerTemplateList.find('option[value="tdb_template_'+tdcState.getHeaderTemplateId()+'"]').attr("selected",!0);tdcState.isGlobalFooterTemplate()?tdcSidebar.$_footerTemplateList.find("option:first").attr("selected",!0):tdcState.isNoFooter()?tdcSidebar.$_footerTemplateList.find('option[value="no_footer"]').attr("selected",
!0):tdcSidebar.$_footerTemplateList.find('option[value="tdb_template_'+tdcState.getFooterTemplateId()+'"]').attr("selected",!0);tdcSidebar.$_buttonZone.click(function(){tdcMain.getContentModified()?tdConfirm.showModal("TagDiv Composer detected unsaved changes?",tdcSidebar,function(){tb_remove();tdcSidebar.$_tdcZone.show();tdcWindowFrame.setWindowFrame(tdcSidebar.$_tdcZone)},b,"Do you want to continue? You can loose that unsaved work. Better save it."):(tdcSidebar.$_tdcZone.show(),tdcWindowFrame.setWindowFrame(tdcSidebar.$_tdcZone))});
tdcSidebar.$_tdcZone.on("click",".tdc-zone-icon",function(d){d=f(this).parent();var a=d.data("type");tdcSidebar.$_tdcZone.find(".tdc-zone").removeClass("tdc-zone-active");d.addClass("tdc-zone-active");"tdc_header_desktop_sticky"===a||"tdc_header_mobile_sticky"===a?(tdcIFrameData.activateZone(a,!0,!0),d.addClass("tdc-zone-sticky-active"),d.removeClass("tdc-zone-sticky-inactive"),"tdc_header_desktop_sticky"===a?d.hasClass("tdc-zone-sticky-active")?tdcState.setHeaderSticky():tdcState.unsetHeaderSticky():
d.hasClass("tdc-zone-sticky-active")?tdcState.setMobileHeaderSticky():tdcState.unsetMobileHeaderSticky()):tdcIFrameData.activateZone(a,b,!0)}).on("click",".tdc-zone-sticky-info",function(d){d=f(this).parent();var a=d.data("type");tdcSidebar.$_tdcZone.find(".tdc-zone").removeClass("tdc-zone-active");d.addClass("tdc-zone-active");"tdc_header_desktop_sticky"===a||"tdc_header_mobile_sticky"===a?(d.hasClass("tdc-zone-sticky-inactive")?tdcIFrameData.activateZone(a,!0,!0):tdcIFrameData.activateZone(a,!1),
d.toggleClass("tdc-zone-sticky-active"),d.toggleClass("tdc-zone-sticky-inactive"),"tdc_header_desktop_sticky"===a?d.hasClass("tdc-zone-sticky-active")?tdcState.setHeaderSticky():tdcState.unsetHeaderSticky():d.hasClass("tdc-zone-sticky-active")?tdcState.setMobileHeaderSticky():tdcState.unsetMobileHeaderSticky()):tdcIFrameData.activateZone(a,b,!0)}).on("change",".tdc-header-template-list",function(b){b=f(this);tdcSidebar.getHeaderTemplate(b.val().replace("tdb_template_",""))}).on("change",".tdc-footer-template-list",
function(b){b=f(this);tdcSidebar.getFooterTemplate(b.val().replace("tdb_template_",""))}).find(".tdc-zone").each(function(){var b=f(this),a=b.data("type");if(!d.isUndefined(a))switch(a){case "tdc_header_desktop_sticky":tdcState.isHeaderSticky()?b.addClass("tdc-zone-sticky-active").removeClass("tdc-zone-sticky-inactive"):b.addClass("tdc-zone-sticky-inactive").removeClass("tdc-zone-sticky-active");break;case "tdc_header_mobile_sticky":tdcState.isMobileHeaderSticky()?b.addClass("tdc-zone-sticky-active").removeClass("tdc-zone-sticky-inactive"):
b.addClass("tdc-zone-sticky-inactive").removeClass("tdc-zone-sticky-active")}});tdcSidebar.$_editZone.click(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone()})}).mouseenter(function(b){d.isUndefined(tdcSidebar._$currentElement)||(tdcMaskUI.setCurrentElement(tdcSidebar._$currentElement),tdcMaskUI.$wrapper.hide());d.isUndefined(tdcSidebar._$currentZone)||tdcMaskUI.setCurrentContainer(tdcSidebar._$currentZone)}).mouseleave(function(b){tdcMaskUI.hide()});tdcSidebar.$_editRow.click(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),
$currentRow:tdcSidebar.getCurrentRow()})}).mouseenter(function(b){d.isUndefined(tdcSidebar._$currentElement)||(tdcMaskUI.setCurrentElement(tdcSidebar._$currentElement),tdcMaskUI.$wrapper.hide());d.isUndefined(tdcSidebar._$currentRow)||tdcMaskUI.setCurrentContainer(tdcSidebar._$currentRow)}).mouseleave(function(b){tdcMaskUI.hide()});tdcSidebar.$_editColumn.click(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn()})}).mouseenter(function(b){d.isUndefined(tdcSidebar._$currentElement)||
...
(tdcMaskUI.setCurrentElement(tdcSidebar._$currentElement),tdcMaskUI.$wrapper.hide());d.isUndefined(tdcSidebar._$currentInnerColumn)||tdcMaskUI.setCurrentContainer(tdcSidebar._$currentInnerColumn)}).mouseleave(function(b){tdcMaskUI.hide()});f(".tdc-sidebar-element").each(function(b,a){tdcSidebar._bindElement(f(a))});tdcSidebar.$_sidebarClosePage.click(function(d){var a=window.tdcAdminSettings.previousUrl.split("#");!tdcSidebar.$_sidebarClosePage.hasClass("tdb-close-page")&&tdcMain.getContentModified()?
tdConfirm.showModal("Close tagDiv Composer?",tdcSidebar,function(){window.onbeforeunload=null;window.location=a[0];tb_remove()},b,"Unsaved content. Still want to close tagDiv Composer?"):(window.onbeforeunload=null,window.location=a[0])});"1"===window.localStorage.getItem("tdc_live_iframe_wrapper_inline")&&(tdcMain.setSidebarInline(),tdcSidebar.$_sidebar.addClass("tdc-sidebar-inline"),tdcSidebar.$_liveIframeWrapper.addClass("tdc-live-iframe-wrapper-inline").removeClass("tdc-live-iframe-wrapper-full"));
tdcSidebar.$_sidebarBullet.click(function(b){tdcSidebar.$_sidebar.toggleClass("tdc-sidebar-inline");tdcSidebar.$_liveIframeWrapper.toggleClass("tdc-live-iframe-wrapper-inline");tdcSidebar.$_liveIframeWrapper.hasClass("tdc-live-iframe-wrapper-inline")?(tdcSidebar.$_liveIframeWrapper.removeClass("tdc-live-iframe-wrapper-full"),tdcMain.setSidebarInline(),window.localStorage.setItem("tdc_live_iframe_wrapper_inline",1)):(tdcSidebar.$_liveIframeWrapper.addClass("tdc-live-iframe-wrapper-full"),tdcMain.resetSidebarInline(),
window.localStorage.setItem("tdc_live_iframe_wrapper_inline",0))});tdcSidebar.$_sidebarClose.click(function(b){tdcSidebar.$_sidebar.addClass("tdc-sidebar-hidden");tdcSidebar.$_sidebarOpen.addClass("tdc-sidebar-reopen");tdcSidebar.$_sidebar.hasClass("tdc-sidebar-inline")&&tdcSidebar.$_liveIframeWrapper.toggleClass("tdc-live-iframe-wrapper-inline");tdcSidebar.$_sidebar.hasClass("tdc-sidebar-hidden")?tdcSidebar.$_liveIframeWrapper.removeClass("tdc-live-iframe-wrapper-full"):tdcSidebar.$_liveIframeWrapper.hasClass("tdc-live-iframe-wrapper-inline")||
tdcSidebar.$_liveIframeWrapper.addClass("tdc-live-iframe-wrapper-full");tdcMain.setSidebarHidden()});tdcSidebar.$_sidebarOpen.click(function(b){tdcSidebar.$_sidebar.removeClass("tdc-sidebar-hidden");tdcSidebar.$_sidebarOpen.removeClass("tdc-sidebar-reopen");tdcSidebar.$_sidebar.hasClass("tdc-sidebar-inline")&&tdcSidebar.$_liveIframeWrapper.toggleClass("tdc-live-iframe-wrapper-inline");tdcSidebar.$_sidebar.hasClass("tdc-sidebar-hidden")?tdcSidebar.$_liveIframeWrapper.removeClass("tdc-live-iframe-wrapper-full"):
tdcSidebar.$_liveIframeWrapper.hasClass("tdc-live-iframe-wrapper-inline")||tdcSidebar.$_liveIframeWrapper.addClass("tdc-live-iframe-wrapper-full");tdcMain.resetSidebarHidden()});tdcSidebar.$_sidebarMenu.click(function(b){f(this).toggleClass("tdc-window-open");f(".tdc-sidebar-modal").each(function(a,c){a=f(c);c=a.data("button_class");a.hasClass("tdc-sidebar-modal-menu")?a.toggleClass("tdc-modal-open"):(a.removeClass("tdc-modal-open"),"undefined"!==typeof c&&""!==c&&(a=f("."+c),a.length&&a.removeClass("tdc-window-open")))})});
tdcSidebar.$_sidebarSearch.keyup(function(b){var a=f(this);f(".tdc-sidebar-element").each(function(c,b){c=f(b);-1===c.find(".tdc-element-id").html().toLowerCase().indexOf(a.val().trim().toLowerCase())?c.hide():c.show()});f(".tdc-sidebar-separator").each(function(a,b){a=f(b);a.nextUntil(".tdc-sidebar-separator").is(":visible")?a.show():a.hide()})});tdcSidebar.$_sidebar.on("mouseenter",function(){tdcSidebar.mouseOverSidebar=!0}).on("mouseleave",function(){tdcSidebar.mouseOverSidebar=!1});f("body").css("overflow",
"hidden");tdcSidebar._sidebarModal();tdcSidebar._liveInspectorTabs();tdcSidebar.updateSavedShortcodes();tdcSidebar.editTemplateName();tdcSidebarPanel.init()},hideWpeditor:function(){f("#tdc-wpeditor").hide()},setForcedHeaderZone:function(b){tdcSidebar._forcedHeaderZone=b},getForcedHeaderZone:function(){return tdcSidebar._forcedHeaderZone},changeZoneName:function(b){var a="CUSTOM";switch(b){case "tdc_content":a="CONTENT";break;case "tdc_header_desktop":a="HEADER MENU";break;case "tdc_header_desktop_sticky":a=
"HEADER MENU STICKY";break;case "tdc_header_mobile":a="MOBILE MENU";break;case "tdc_header_mobile_sticky":a="MOBILE MENU STICKY";break;case "tdc_footer":a="FOOTER"}tdcSidebar.$_editZone.find("a").html(a)},_activeBreadcrumbItem:function(){var b=tdcSidebar.getCurrentModel(),a=b.get("tag"),c=tdcIFrameData.getZoneParent(b).get("type_zone"),h="<span>"+window.tdcPostSettings.shortcodes[b.get("tag")]+"</span>",k="";tdcSidebar.changeZoneName(c);for(var l in window.tdcAdminSettings.mappedShortcodes)"undefined"===
typeof window.tdcAdminSettings.mappedShortcodes[l].tdc_category||"Blocks"!==window.tdcAdminSettings.mappedShortcodes[l].tdc_category&&"Big Grids"!==window.tdcAdminSettings.mappedShortcodes[l].tdc_category||window.tdcAdminSettings.mappedShortcodes[l].tdc_category!==window.tdcAdminSettings.mappedShortcodes[a].tdc_category||(c="",l===a&&(c="tdc-selected-option"),k+='<li class="'+c+'" data-block_type="'+window.tdcAdminSettings.mappedShortcodes[l].base+'"><div class="tdc-element-ico tdc-ico-'+window.tdcAdminSettings.mappedShortcodes[l].base+
'"></div><div class="tdc-element-id">'+window.tdcAdminSettings.mappedShortcodes[l].name+"</div></li>");""!==k?(k="<ul>"+k+"</ul>",tdcSidebar.$_currentElementHead.addClass("tdc-block-selection")):tdcSidebar.$_currentElementHead.removeClass("tdc-block-selection");switch(a){case "tdc_zone":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.hide();tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();var m=tdcSidebar.$_editZone;break;case "vc_row":tdcSidebar.$_editZone.show();
tdcSidebar.$_editRow.hide();tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();m=tdcSidebar.$_editRow;break;case "vc_column":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();m=tdcSidebar.$_editColumn;break;case "vc_row_inner":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.show();tdcSidebar.$_editInnerRow.hide();
tdcSidebar.$_editInnerColumn.hide();m=tdcSidebar.$_editInnerRow;break;case "vc_column_inner":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.show();tdcSidebar.$_editInnerRow.show();tdcSidebar.$_editInnerColumn.hide();m=tdcSidebar.$_editInnerColumn;break;default:tdcSidebar.$_editZone.show(),tdcSidebar.$_editRow.show(),tdcSidebar.$_editColumn.show(),m=tdcSidebar.getCurrentElement(),"vc_column_inner"===b.get("parentModel").get("tag")?(tdcSidebar.$_editInnerRow.show(),
tdcSidebar.$_editInnerColumn.show()):(tdcSidebar.$_editInnerRow.hide(),tdcSidebar.$_editInnerColumn.hide())}tdcSidebar.$_currentElementHead.html(h);tdcSidebar.$_currentElementSiblings.html(k);tdcSidebar.$_sidebar.find(".tdc-responsiveness").addClass(a);tdcSidebar.$_currentElementHead.off().mouseenter(function(a){a.preventDefault();m.trigger(a)}).mouseleave(function(a){a.preventDefault();m.trigger(a)}).mousedown(function(a){""!==k&&(tdcSidebar.$_currentElementSiblings.toggleClass("tdc-current-element-siblings-visible"),
...
tdcSidebar._setCurrentInnerRow(b),tdcSidebar._setCurrentInnerColumn(b),tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=b):d.has(e,"$currentZone")&&!d.isUndefined(e.$currentZone)?(tdcSidebar._setCurrentZone(e.$currentZone),d.has(e,"$currentRow")&&!d.isUndefined(e.$currentRow)?(tdcSidebar._setCurrentRow(e.$currentRow),d.has(e,"$currentColumn")&&!d.isUndefined(e.$currentColumn)?(tdcSidebar._setCurrentColumn(e.$currentColumn),d.has(e,"$currentInnerRow")&&!d.isUndefined(e.$currentInnerRow)?(tdcSidebar._setCurrentInnerRow(e.$currentInnerRow),
d.has(e,"$currentInnerColumn")&&!d.isUndefined(e.$currentInnerColumn)?(tdcSidebar._setCurrentInnerColumn(e.$currentInnerColumn),d.has(e,"$currentElement")&&!d.isUndefined(e.$currentElement)?(tdcSidebar._setCurrentElement(e.$currentElement),tdcSidebar._currentModel=tdcIFrameData.getModel(e.$currentElement.data("model_id"))):(tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=tdcIFrameData.getModel(e.$currentInnerColumn.data("model_id")))):(tdcSidebar._setCurrentInnerColumn(b),tdcSidebar._setCurrentElement(b),
tdcSidebar._currentModel=tdcIFrameData.getModel(e.$currentInnerRow.data("model_id")))):(tdcSidebar._setCurrentInnerRow(b),tdcSidebar._setCurrentInnerColumn(b),d.has(e,"$currentElement")&&!d.isUndefined(e.$currentElement)?(tdcSidebar._setCurrentElement(e.$currentElement),tdcSidebar._currentModel=tdcIFrameData.getModel(e.$currentElement.data("model_id"))):(tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=tdcIFrameData.getModel(e.$currentColumn.data("model_id"))))):(tdcSidebar._setCurrentColumn(b),
...
tdcSidebar._setCurrentInnerRow(b),tdcSidebar._setCurrentInnerColumn(b),tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=b),d.isUndefined(tdcSidebar._currentModel)?tdcSidebarPanel.clearPanel():(tdcSidebar._currentModel.set("current",!0),tdcSidebarPanel.bindPanelToModel(tdcSidebar._currentModel,a),tdcSidebar._activeBreadcrumbItem(),tdcSidebar.closeModals(),d.isUndefined(f)||d.isUndefined(f.callback)||(d.isUndefined(f.callbackContext)?f.callback.call(this):f.callback.call(f.callbackContext)))},
...
(tdcSidebar.$editorTextarea.val(c.css),tdcSidebarController.onUpdate(tdcIFrameData.getModel(tdcSidebar.$editorTextarea.data("model_id")),tdcSidebar.$editorTextarea.data("param_name"),"",window.btoa(encodeURIComponent(c.css))))})}),tdcSidebar.editorCss.setTheme("ace/theme/textmate"),tdcSidebar.editorCss.setShowPrintMargin(!1),tdcSidebar.editorCss.getSession().setMode("ace/mode/less"),tdcSidebar.editorCss.getSession().setUseWrapMode(!0),tdcSidebar.editorCss.setOptions({enableBasicAutocompletion:!0,
...
var a;d.each(tdcAdminSettings.tdcSavings,function(c,b,e){if(c.length&&"gradients"!==b&&"fonts"!==b){var f="",k="",h=!1,l=!1;"vc_row"===b?(f="tdc-row-temp",k=' data-shortcode-name="vc_row" ',h=!0):"vc_row_inner"===b?(f="tdc-element-inner-row-temp",k=' data-shortcode-name="vc_row_inner" ',h=!0):(f="tdc-element",k=' data-shortcode-name="'+b+'" ',l=!0);d.isUndefined(window.tdcAdminSettings.mappedShortcodes[b])||(a+='<div class="tdc-sidebar-separator tdc-sidebar-text-separator"><span>'+window.tdcAdminSettings.mappedShortcodes[b].name+
"</span></div>",d.each(c,function(c,e,g){g=e="";h&&(g=c.shortcode,g=window.atob(g),g=' data-template-content="'+window.btoa(g)+'" ');l&&(tdcIFrameData._getPostOriginalContentJSON(),e=tdcIFrameData._getContentJSON(5,window.atob(c.shortcode)),d.isUndefined(e[0].shortcode.content)||(e[0].shortcode.attrs.named.content=e[0].shortcode.content),e=' data-start-values="'+window.btoa(JSON.stringify([e[0].shortcode.attrs.named]))+'" ');a+='<div class="tdc-sidebar-element '+f+'" '+k+" "+g+" "+e+'><div class="tdc-element-ico tdc-ico-template"></div><div class="tdc-element-id">'+
c.name+' - template</div><div class="tdc-element-delete" data-type="'+b+'" data-name="'+c.name+'"></div></div>'}))}});var c=f(a);c.insertAfter(b);c.find(".tdc-element-delete").on("mousedown",function(a){a.preventDefault();a.stopImmediatePropagation()}).on("mouseup",function(a){if(1===a.which){var c=f(this);a=c.data("type");c=c.data("name");if("undefined"!==typeof window.tdcAdminSettings.tdcSavings[a])for(var b=window.tdcAdminSettings.tdcSavings[a],d=0;d<b.length;d++)if(b[d].name===c.toString()){b.splice(d,
1);b.length||delete window.tdcAdminSettings.tdcSavings[a];tdcUtil.updateTdcSavings();break}return!1}});b.nextAll(".tdc-sidebar-element").each(function(a,c){tdcSidebar._bindElement(f(c))})}else b.hide()},editTemplateName:function(){f("#tdb-template-name-edit").click(function(d){d.preventDefault();var a=f("#tdb-template-name");tdConfirm.modal({caption:"Change Template Name",objectContext:tdcSidebar,callbackYes:function(){var c=f("#tdb-new-template-name"),d=f("#tdc_post_id").val(),e=window.tdcPostSettings.tdbTemplateType;
...
d,e){var f={type:"AJAX ERROR",message:"Invalid reply from server endpoint.",debug_data:{endpoint:"td-composer/change_template_name",request:a}};console.log("td-composer/change_template_name - ERROR",f);c.siblings("#tdb-modal-notice").text(f.type+": "+f.message).fadeIn(50);a.responseText!==b?console.log("%cAPI ERROR td-composer/change_template_name","background: #ffaa00; color: #ffffff; padding:3px 6px","Error - check for php warnings:",a.responseText):console.log("%cAPI ERROR td-composer/change_template_name",
"background: #ffaa00; color: #ffffff; padding:3px 6px","Error - check for php warnings:",a,d,e)}):tb_remove()},htmlInfoContent:'Enter the template name: <input id="tdb-new-template-name" type="text" value="'+a.text()+'" onfocus="(function(e){ jQuery( e.target ).siblings(\'#tdb-modal-notice\').fadeOut(50); })(event)"/><em id="tdb-modal-notice"></em>',textYes:"Save",textNo:"Cancel"})})},updateHeaderTemplates:function(){tdcSidebar.$_headerTemplateList.find("option").each(function(b){b=f(this);""!==b.val()&&
"no_header"!==b.val()&&b.remove()});f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_header_templates","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(b){b.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{}}).done(function(b,a,c){f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===a&&d.isObject(b)&&(d.has(b,"errors")?new tdcNotice.notice(b.errors,!0,!1):d.has(b,"tdb_header_templates")&&b.tdb_header_templates.forEach(function(a){var c=
"";if(""!==tdcState.getHeaderTemplateId()&&"no_header"!==tdcState.getHeaderTemplateId()&&parseInt(tdcState.getHeaderTemplateId())===parseInt(a.id)||"no_header"===tdcState.getHeaderTemplateId()&&tdcState.getHeaderTemplateId()===a.id)c="selected";a=f('<option value="tdb_template_'+a.id+'" '+c+">"+a.title+"</option>");tdcSidebar.$_headerTemplateList.append(a)}))}).fail(function(b,a,c){})},getHeaderTemplate:function(b){f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_header_template",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{td_magic_token:tdcLivePanel.$token.val(),tdc_action:"get_header_template",tdc_header_template_id:b}}).done(function(a,c,b){"success"===c&&d.isObject(a)&&(d.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(a.global_template?tdcState.setGlobalTemplate():tdcState.unsetGlobalTemplate(),a.no_header?(tdcState.setNoHeader(),tdcState.setHeaderTemplateId("no_header"),
tdcState.setHeaderTemplateContent("")):(tdcState.unsetNoHeader(),tdcState.setHeaderTemplateId(a.template_id),tdcState.setHeaderTemplateContent(a.template_content)),tdcIFrameData.setHeaderTemplate(a.template_content)))}).fail(function(a,c,b){})},updateFooterTemplates:function(){tdcSidebar.$_footerTemplateList.find("option").each(function(b){b=f(this);""!==b.val()&&"no_footer"!==b.val()&&b.remove()});f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_footer_templates","uuid="+
tdcJobManager._getUniqueID()),beforeSend:function(b){b.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{}}).done(function(b,a,c){f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===a&&d.isObject(b)&&(d.has(b,"errors")?new tdcNotice.notice(b.errors,!0,!1):d.has(b,"tdb_footer_templates")&&b.tdb_footer_templates.forEach(function(a){var c="";if(""!==tdcState.getFooterTemplateId()&&"no_header"!==tdcState.getFooterTemplateId()&&parseInt(tdcState.getFooterTemplateId())===
parseInt(a.id)||"no_footer"===tdcState.getFooterTemplateId()&&tdcState.getFooterTemplateId()===a.id)c="selected";a=f('<option value="tdb_template_'+a.id+'" '+c+">"+a.title+"</option>");tdcSidebar.$_footerTemplateList.append(a)}))}).fail(function(b,a,c){})},getFooterTemplate:function(b){f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_footer_template","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},
data:{td_magic_token:tdcLivePanel.$token.val(),tdc_action:"get_footer_template",tdc_footer_template_id:b}}).done(function(a,c,b){"success"===c&&d.isObject(a)&&(d.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(a.global_template?tdcState.setGlobalFooterTemplate():tdcState.unsetGlobalFooterTemplate(),a.no_footer?(tdcState.setNoFooter(),tdcState.setFooterTemplateId("no_footer"),tdcState.setFooterTemplateContent("")):(tdcState.unsetNoFooter(),tdcState.setFooterTemplateId(a.template_id),tdcState.setFooterTemplateContent(a.template_content)),
tdcIFrameData.setFooterTemplate(a.template_content)))}).fail(function(a,c,b){})}};tdcSidebar.init()})(jQuery,_);var tdcSidebarController={};
(function(f){tdcSidebarController={updateJobBuffer:{},updateJobTimer:"",_updateJob:function(){this.value=this.oldValue=this.paramName=this.model=""},_getParamMap:function(d,b,e){for(var a=window.tdcAdminSettings.mappedShortcodes[d],c=0;c<a.params.length;c++)if(a.params[c].param_name===b)return a.params[c];a=window.tdcAdminSettings.mappedBlockTemplates[window.tdcAdminSettings.globalBlockTemplate];_.isEmpty(e.block_template_id)||(a=window.tdcAdminSettings.mappedBlockTemplates[e.block_template_id]);
for(c=0;c<a.params.length;c++)if(a.params[c].param_name===b)return a.params[c];if(0===b.indexOf("tds_")){c=b.split("-");var h=e=f;a=f;2>c.length?new tdcNotice.notice('Param "'+b+'" must have up at least one "-" separator',!0,!1):2===c.length?e=c[0]:3===c.length?(e=c[0],a=c[2]):3<c.length&&new tdcNotice.notice('Param "'+b+'" must have up to at most two "-" separator',!0,!1);if(_.isUndefined(h))for(var k in window.tdcAdminSettings.settingsStyle){if(!_.isUndefined(h))break;for(var l in window.tdcAdminSettings.settingsStyle[k])if(l===
e){h=k;break}}_.isUndefined(e)&&(e=window.tdcAdminSettings.globalStyle[h]);k=window.tdcAdminSettings.settingsStyle[h][e];for(c=0;c<k.params.length;c++)if(l=e+"-"+k.params[c].param_name,_.isUndefined(a)||(l+="-"+a),l===b)return d=JSON.parse(JSON.stringify(k.params[c])),d.param_name=e+"-"+d.param_name,_.isUndefined(a)||(d.param_name+="-"+a),d}new tdcNotice.notice("Map value not found for "+d+" "+b,!0,!1);return f},onUpdate:function(d,b,e,a){var c=new tdcSidebarController._updateJob;c.model=d;c.paramName=
...
f(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");f(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(b){var e=f("img",b).attr("src"),h="";"undefined"===typeof e?(e=f(b).attr("src"),h=f(b).attr("class")):h=f("img",b).attr("class");f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},
dataType:"json",data:{image_class:h,action:"tdc_ajax_get_image_id"}}).done(function(b,f,k){if("success"===f)if(d.isObject(b)&&d.has(b,"errors"))new tdcNotice.notice(b.errors,!0,!1);else{f=a.closest(".tdc-property-wrap");k=f.find(".tdc-css-image-remove");var h=f.find(".tdc-inherit-image");k.removeClass("tdc-hidden-button");"all"===tdcSidebar.currentViewportSettings.name?h.hide():h.show();a.attr("style","background-image: url( '"+e+"') ");a.data("image_link",e);a.data("image_id",b.image_id);window.send_to_editor=
window.original_send_to_editor;window.tb_remove();f.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);"undefined"===typeof a.data("model_id")?tdcCssEditor.saveWidgetForm(a):(b=tdcCssEditor._generateCssAttValue(c),f=tdcIFrameData.getModel(a.data("model_id")),tdcSidebarController.onUpdate(f,a.data("param_name"),"",b))}}).fail(function(a,c,b){})};return!1},tdcCssImageRemoveHandler:function(b){var a=f(b.currentTarget),c=a.closest(".tdc-property-wrap");b=c.find(".tdc-css-image-wrap");var e=c.find(".tdc-inherit-image");
...
tdcSidebarController.onUpdate(e,b.data("param_name"),"",a))},_updateColorField:function(b){var a=b.closest(".tdc-property-wrap"),c=a.data("tdc-for"),e=a.find(".tdc-inherit-color"),f=a.find(".tdc-colorpicker-wrap"),l=b.data("no_value"),m=b.data("default_value");d.isUndefined(l)||1!==l?("all"!==tdcSidebar.currentViewportSettings.name&&e.show(),tdcCssEditor._updateData(b),e={isInherited:!1},c=tdcCssEditor._getSettingsProperty(c,"",e),e.isInherited?(b.attr("placeholder",c),b.val(""),a.addClass(tdcCssEditor._INHERITED_CSS_CLASS),
f.attr("style","background-color: "+tdcCssEditor._getRgba(c))):(a.removeClass(tdcCssEditor._INHERITED_CSS_CLASS),tdcCssEditor._checkDefaultColor(b))):(b.val("no_value"),tdcCssEditor._updateData(b),b.val(""),d.isUndefined(m)||f.attr("style","background-color: "+tdcCssEditor._getRgba(m)),tdcCssEditor._checkDefaultColor(b))},_clearColorPicker:function(b){b=f(b.currentTarget).closest(".tdc-property-wrap");var a=b.closest(".tdc-tab-content"),c=b.find("input"),d=b.find(".tdc-inherit-color");b.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);
...
100):tdcCssEditor._updateColorField(a)},_inheritSelect:function(e){e=f(e.currentTarget);var a=e.closest(".tdc-property-wrap"),c=a.data("tdc-for");d.isUndefined(tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name][c])||delete tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name][c];var h={isInherited:!1};c=tdcCssEditor._getSettingsProperty(c,b,h);var k=a.find("select:first");h.isInherited?(a.addClass(tdcCssEditor._INHERITED_CSS_CLASS),e.hide()):(a.removeClass(tdcCssEditor._INHERITED_CSS_CLASS),
e.show());d.isUndefined(c)?(k.val(k.find("option:first").val()),e.hide()):k.val(c);tdcCssEditor._updateData(k)},_inheritColor:function(e){e=f(e.currentTarget);var a=e.closest(".tdc-property-wrap"),c=a.find("input"),h=a.find(".tdc-colorpicker-wrap"),k=a.data("tdc-for");d.isUndefined(tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name][k])||delete tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name][k];c.data("no_value",0);var l={isInherited:!1};k=tdcCssEditor._getSettingsProperty(k,
b,l);l.isInherited?(a.addClass(tdcCssEditor._INHERITED_CSS_CLASS),e.hide()):(a.removeClass(tdcCssEditor._INHERITED_CSS_CLASS),e.show());d.isUndefined(k)?(c.val(""),e.hide(),tdcCssEditor._updateData(c),tdcCssEditor._checkDefaultColor(c)):(c.val(""),c.attr("placeholder",k),h.attr("style","background-color: "+tdcCssEditor._getRgba(k)),tdcCssEditor._updateData(c))},_inheritImage:function(e){var a=f(e.currentTarget);e=a.closest(".tdc-property-wrap");var c=e.find(".tdc-css-image-wrap"),h=e.find(".tdc-css-image-remove");
e.find(".tdc-inherit-image").hide();h.addClass("tdc-hidden-button");c.data("image_link","");h=c.data("model_id");d.isUndefined(h)?tdcCssEditor.saveWidgetForm(a):(a=e.closest(".tdc-tab-content"),a=tdcCssEditor._generateCssAttValue(a),h=tdcIFrameData.getModel(h),tdcSidebarController.onUpdate(h,c.data("param_name"),"",a));h={isInherited:!1};a=tdcCssEditor._getSettingsProperty("background-image",b,h);h.isInherited?(e.addClass(tdcCssEditor._INHERITED_CSS_CLASS),c.attr("style","background-image: url('"+
a+"'")):c.attr("style","background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png'")},_clearCssProperties:function(d){d=f(d.currentTarget);var a=d.data("model_id");tdConfirm.showModal("Clear CSS settings",tdcCssEditor,function(a,d){tdcCssEditor._currentCssSettings=b;"undefined"===typeof d?(f(".tdc-responsiveness").replaceWith(tdcCssEditor.generateEditorResponsiveContent()),tdcCssEditor.doActionPanelRender(),tdcCssEditor.saveWidgetForm(f("."+a.get(0).className))):
(d=tdcIFrameData.getModel(d),tdcSidebarController.onUpdate(d,a.data("param_name"),"",""),f(".tdc-responsiveness").replaceWith(tdcCssEditor.generateEditorResponsiveContent()),tdcCssEditor.doActionPanelRender());tb_remove()},[d,a],"Are you sure you want to clear all the CSS settings of the selected component?")},_changeTextInput:function(b){var a=f(b.currentTarget),c=a.parent(),e=a;c.hasClass("tdc-box-margin")||c.hasClass("tdc-box-border")||c.hasClass("tdc-box-padding")||(e=a.closest(".tdc-property-wrap"));
c=a.val();var k=1;a.hasClass("tdc-css-opacity")&&(k=.01);var l=NaN;switch(b.type){case "keyup":switch(b.keyCode){case 38:f.isNumeric(c)&&(l=parseFloat(c)+k);break;case 40:f.isNumeric(c)&&(l=parseFloat(c)-k)}break;case "mousewheel":b.preventDefault(),b.stopImmediatePropagation(),f.isNumeric(c)&&(l=0<b.originalEvent.deltaY?parseFloat(c)-k:parseFloat(c)+k)}d.isNaN(l)||(1>k&&(l=l.toFixed(2)),a.val(l));tdcCssEditor._updateData(a);c=e.data("tdc-for");b={isInherited:!1};c=tdcCssEditor._getSettingsProperty(c,
"",b);b.isInherited?(a.attr("placeholder",c),a.val(""),e.addClass(tdcCssEditor._INHERITED_CSS_CLASS)):e.removeClass(tdcCssEditor._INHERITED_CSS_CLASS)},_keydownTextInput:function(b){if(38===b.keyCode||40===b.keyCode)return!1},_focusTextInput:function(b){b=f(b.currentTarget);for(var a=b.closest(".tdc-property-wrap"),c=a[0].classList,d=0;d<c.length;d++)0===c[d].indexOf("tdc-el-")&&a.removeClass(c[d]);a.addClass("tdc-el-"+b.data("tdc-for"))},_changeDropDown:function(b){b=f(b.currentTarget);var a=b.closest(".tdc-property-wrap"),
c=a.find(".tdc-inherit-select");a.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);tdcCssEditor._updateData(b);var e=a.data("tdc-for"),k={isInherited:!1};tdcCssEditor._getSettingsProperty(e,"",k);k.isInherited?(a.addClass(tdcCssEditor._INHERITED_CSS_CLASS),c.hide()):(a.removeClass(tdcCssEditor._INHERITED_CSS_CLASS),"all"===tdcSidebar.currentViewportSettings.name?c.hide():0===b[0].selectedIndex?d.isUndefined(tdcCssEditor._currentCssSettings.all)||d.isUndefined(tdcCssEditor._currentCssSettings.all[e])?
c.hide():c.show():c.show())},doActionPanelRender:function(){tdcSidebarPanel._hook.doAction("panel_rendered");tdcSidebarPanel._hook.doAction("panel_css")},_bindEvents:function(){var b=f("body");b.on("keydown",".tdc-tab-design input.tdc-css-box-input",tdcCssEditor._keydownTextInput);b.on("keyup mousewheel",".tdc-tab-design input.tdc-css-box-input",tdcCssEditor._changeTextInput);b.on("focus",".tdc-tab-design input.tdc-css-box-input",tdcCssEditor._focusTextInput);b.on("change keyup",".tdc-tab-design .tdc-css-bg-color",
...
a+'"></div>'),f("body").append(c),c.find("input").on("input",function(a){var b=f(this),e=tdcAdminIFrameUI.getLiveIframe(),h=b.data("scroll-bar-width");c.find("output").html(b.val());tdcCssEditor.timeoutMediaInterval=setTimeout(function(){d.isUndefined(tdcCssEditor.timeoutMediaInterval)||clearTimeout(tdcCssEditor.timeoutMediaInterval);e.css("width",parseInt(b.val())+parseInt(h))},200)}));""===b?c.hide():(c.show(),tdcCssEditor.timeoutIframeHtml=setTimeout(function(){d.isUndefined(tdcCssEditor.timeoutIframeHtml)||
...
var e=tdcCssEditor._generateCssAttValue(b);b.data("tdc_css",e);d.length?d.val(e):a.append('<input type="hidden" name='+c+' value="'+e+'">')}},addWidgetCssEditor:function(b,a){tdcCssEditor._mappedParameter=b;return tdcCssEditor._generateEditorContent(a)},addComposerCssEditor:function(b,a){tdcCssEditor._mappedParameter=b;tdcCssEditor._model=a;b=a.get("attrs")[b.param_name];return tdcCssEditor._generateEditorContent(b)},_checkDefaultColor:function(b){var a=b.closest(".tdc-property-wrap").find(".tdc-colorpicker-wrap");
""===b.val()&&(b=b.data("default_value"),d.isUndefined(b)?a.attr("style",""):a.attr("style","background-color: "+tdcCssEditor._getRgba(b)))},_generateEditorContent:function(e){if(d.isEmpty(e))tdcCssEditor._currentCssSettings=b;else try{var a=JSON.parse(window.atob(e));tdcDebug.log(a);d.isObject(a)?tdcCssEditor._currentCssSettings=a:tdcCssEditor._currentCssSettings=b}catch(c){tdcCssEditor._currentCssSettings=b,new tdcNotice.notice(c.message,!1,!1)}tdcSidebarPanel._hook.addAction("panel_rendered",function(){f(".tdc-css-image-wrap").each(function(a,
e){a=f(e);e=a.closest(".tdc-property-wrap");var c=e.find(".tdc-css-image-remove"),h=e.find(".tdc-inherit-image"),m={isInherited:!1},g=tdcCssEditor._getSettingsProperty("background-image",b,m);m.isInherited?e.addClass(tdcCssEditor._INHERITED_CSS_CLASS):e.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);d.isUndefined(g)?(c.addClass("tdc-hidden-button"),h.hide()):("no_value"===g?c.addClass("tdc-hidden-button"):(c.removeClass("tdc-hidden-button"),a.attr("style",'background-image: url("'+g+'")')),"all"!==
tdcSidebar.currentViewportSettings.name&&h.show());a.data("image_link",g)});f(".tdc-inherit").each(function(a,e){a=f(e);e=a.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||e.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))a.hide();else{var c=e.data("tdc-for");e={isInherited:!1};c=tdcCssEditor._getSettingsProperty(c,b,e);e.isInherited?a.hide():d.isUndefined(c)||a.show()}})});return tdcCssEditor.generateEditorResponsiveContent()},_cleanCss:function(e,a){if("undefined"===
typeof a)return b;if("no_value"===a)return a;if("background-image"===e)return e=/(url\s*\(\s*['"]?)(.*?)\s*(['"]?\s*\))/ig.exec(a),d.isEmpty(e)?"":e[2];a=a.toLowerCase();a=a.replace(/!important/g,"");return a.trim()},_getDataNoValue:function(b){var a="";"no_value"===b&&(a=' data-no_value="1" ');return a},callbackColorPicker:function(){f(".tdc-tab-design .tdc-property-colorpicker").each(function(){f("#tdc-palette-color-picker").tdPalette();var b=f(this),a=b.find("input"),c=b.closest(".tdc-property-wrap");
b=b.find(".tdc-colorpicker-wrap");d.isUndefined(a.val())||""===a.val()||b.attr("style","background: "+a.val());c.hasClass(tdcCssEditor._INHERITED_CSS_CLASS)?""!==a.attr("placeholder")&&b.attr("style","background-color: "+tdcCssEditor._getRgba(a.attr("placeholder"))):("no_value"===a.val()&&a.val(""),tdcCssEditor._checkDefaultColor(a))})},generateEditorResponsiveContent:function(){function e(){return m={isInherited:!1}}function a(a){return"all"!==tdcSidebar.currentViewportSettings.name?'placeholder="'+
a+'"':""}function c(){return m.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function h(a,b){b=tdcCssEditor._getSettingsProperty(a,b,e());var f="-",h="";m.isInherited&&(f=b,b="");d.isUndefined(l)||"margin-left"!==a&&"margin-right"!==a||(h=l.get("tag"),h="vc_column"===h||"vc_column_inner"===h?" "+tdcCssEditor._INACTIVE_CSS_CLASS:"");return'<input data-tdc-for="'+a+'" name="" type="text" value="'+b+'" class="tdc-css-box-input tdc-css-box-input-'+a+c()+h+'" title="Css '+a+'" placeholder="'+f+
'" '+tdcSidebarPanel._getParamterDataAtts(k,l)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var k=tdcCssEditor._mappedParameter,l=tdcCssEditor._model,m={isInherited:!1};var g='<div class="tdc-responsiveness"><div class="'+(tdcSidebarPanel._getParameterClasses(k)+'">');g=g+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+h("margin-top","");g+=h("margin-right","");g+=h("margin-bottom","");g+=h("margin-left","");g=g+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+
h("border-top-width","");g+=h("border-right-width","");g+=h("border-bottom-width","");g+=h("border-left-width","");g=g+'<div class="tdc-box-padding"><div class="tdc-padding-label">Padding</div>'+h("padding-top","");g+=h("padding-right","");g+=h("padding-bottom","");g+=h("padding-left","");g+="</div></div></div></div>";var n=tdcCssEditor._getSettingsProperty("border-style",b,e());g+='<div class="tdc-property-wrap tdc-border-style tdc-dropdown-big'+c()+'" data-tdc-for="border-style">';g=g+'<div class="tdc-property-title"><span title="Css border-style" class="tdc-search-data">Border style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-border-style" '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="">');g+=tdcCssEditor._generateDropdownOptions([{value:"solid",display:"Solid"},{value:"dotted",display:"Dotted"},{value:"dashed",display:"Dashed"},{value:"none",display:"None"},{value:"hidden",display:"Hidden"},{value:"double",display:"Double"},{value:"groove",display:"Groove"},{value:"ridge",display:"Ridge"},{value:"inset",display:"Inset"},{value:"outset",display:"Outset"},{value:"initial",display:"Initial"},{value:"inherit",display:"Inherit"}],
n);g+="</select></div></div>";n=d.uniqueId();var p=tdcCssEditor._getSettingsProperty("border-color","",e()),q="";m.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+c()+'" data-tdc-for="border-color">';g=g+'<div class="tdc-property-title"><span title="Css border-color" class="tdc-search-data">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(k,l)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("border-radius","",e());p="";m.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+c()+'" data-tdc-for="border-radius">';g=g+'<div class="tdc-property-title"><span title="Css border-radius" class="tdc-search-data">Border radius</span></div><div class="tdc-property"><input class="tdc-css-border-radius" '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("width","",e());p="";m.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+c()+'" data-tdc-for="width">';g=g+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Width</span></div><div class="tdc-property"><input class="tdc-css-width" '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("shadow-size","",e());p="";m.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-size">';g=g+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Shadow size</span></div><div class="tdc-property"><input class="tdc-css-shadow-size" '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+="</div></div>";n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("shadow-color","",e());q="";m.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+c()+'" data-tdc-for="shadow-color">';g=g+'<div class="tdc-property-title"><span title="Css shadow-color" class="tdc-search-data">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(k,l)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-h","",e());p="";m.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-h">';g=g+'<div class="tdc-property-title"><span title="Css shadow-offset-h" class="tdc-search-data">Shadow offset H</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-h" '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-v","",e());p="";m.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-v">';g=g+'<div class="tdc-property-title"><span title="Css shadow-offset-v" class="tdc-search-data">Shadow offset V</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-v" '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("background-color","",e());q="";m.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+c()+'" data-tdc-for="background-color">';g=g+'<div class="tdc-property-title"><span title="Css background-color" class="tdc-search-data">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(k,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",b,e());g+='<div class="tdc-property-wrap tdc-property-attach_image'+c()+'">';g=g+'<div class="tdc-property-title"><span title="Css background-image" class="tdc-search-data">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property"><div class="tdc-css-bg-image tdc-css-image-wrap " '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+" style=\"background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png' )\"></div>");g+='<a class="tdc-css-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';n=tdcCssEditor._getSettingsProperty("background-style",b,e());g+='<div class="tdc-property-wrap tdc-bg-style tdc-dropdown-big'+c()+'" data-tdc-for="background-style">';g=g+'<div class="tdc-property-title"><span title="Css background-size & background-repeat" class="tdc-search-data">Background style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-bg-style" '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="">');g+=tdcCssEditor._generateDropdownOptions([{value:"cover",display:"Cover"},{value:"contain",display:"Contain"},{value:"no-repeat",display:"No repeat"},{value:"repeat",display:"Repeat"}],n);g+="</select></div></div>";n=tdcCssEditor._getSettingsProperty("background-position",b,e());g+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="background-position">';g=g+'<div class="tdc-property-title"><span title="Css background-position" class="tdc-search-data">Background position<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-bg-position" '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="">');g+=tdcCssEditor._generateDropdownOptions([{value:"center top",display:"Center Top"},{value:"center center",display:"Center Center"},{value:"center bottom",display:"Center Bottom"},{value:"left top",display:"Left Top"},{value:"left center",display:"Left Center"},{value:"left bottom",display:"Left Bottom"},{value:"right top",display:"Right Top"},{value:"right center",display:"Right Center"},{value:"right bottom",display:"Right Bottom"}],n);g+=
"</select></div></div>";n=tdcCssEditor._getSettingsProperty("opacity","",e());p="";m.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="opacity">';g=g+'<div class="tdc-property-title"><span title="Css background-image opacity" class="tdc-search-data">Background opacity</span></div><div class="tdc-property"><input class="tdc-css-opacity" '+(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-1-overlay","",e());q="";m.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+c()+'" data-tdc-for="color-1-overlay">';g=g+'<div class="tdc-property-title"><span title="Css gradient color From" class="tdc-search-data">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(k,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-2-overlay","",e());q="";m.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+c()+'" data-tdc-for="color-2-overlay">';g=g+'<div class="tdc-property-title"><span  title="Css gradient color To" class="tdc-search-data">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(k,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("gradient-direction","",e());p="";m.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="gradient-direction">';g=g+'<div class="tdc-property-title"><span title="Css gradient direction" class="tdc-search-data">Gradient direction</span></div><div class="tdc-property"><input class="tdc-css-gradient-direction" '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=tdcCssEditor._getSettingsProperty("content-h-align",b,e());g+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="content-h-align">';g=g+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-content-h-align" '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="">');g+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],n);g+="</select></div></div>";n=tdcCssEditor._getSettingsProperty("z-index","",e());p="";m.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="z-index">';g=g+'<div class="tdc-property-title"><span title="Z-index" class="tdc-search-data">Z-index</span></div><div class="tdc-property"><input class="tdc-css-z-index" '+
(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsPropertyFromCssSettings("display",b);g+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+c()+'" data-tdc-for="display">';g=g+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">Display</span></div><div class="tdc-property"><select class="tdc-css-display" '+(tdcSidebarPanel._getParamterDataAtts(k,l)+' name="">');
g+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Show"},{value:"none",display:"Hidden"},{value:"inline",display:"Inline"},{value:"inline-block",display:"Inline-block"},{value:"block",display:"Block"},{value:"table",display:"Table"},{value:"inline-table",display:"Inline-table"}],n);g=g+'</select></div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div><div class="tdc-clear-css-properties" '+(tdcSidebarPanel._getParamterDataAtts(k,
l)+' title="Clear all tab css settings">Clear CSS settings</div>');g+="</div>";tdcSidebarPanel._hook.addAction("panel_css",tdcCssEditor.callbackColorPicker);tdcSidebarPanel._hook.addAction("panel_css",function(){f(".tdc-inherit").each(function(a,c){a=f(c);c=a.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||c.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))a.hide();else{var e=c.data("tdc-for");c={isInherited:!1};e=tdcCssEditor._getSettingsProperty(e,b,c);c.isInherited?
a.hide():d.isUndefined(e)||a.show()}})});return g},_getAvailableViewportSetting:function(b,a,c){if("undefined"!==typeof tdcCssEditor._currentCssSettings){var d;switch(b){case "all":"undefined"!==typeof tdcCssEditor._currentCssSettings[b]&&(d="all");break;case "landscape":case "portrait":case "phone":"undefined"!==typeof tdcCssEditor._currentCssSettings[b]?d=b:"undefined"!==typeof tdcCssEditor._currentCssSettings.all&&(d="all")}if("undefined"!==typeof d){if("undefined"!==typeof tdcCssEditor._currentCssSettings[d][a])return tdcSidebar.currentViewportSettings.name!==
...
d&&tdcDebug.log(b),tdcCssEditor._cleanCss(b,tdcCssEditor._currentCssSettings[d][b])}"undefined"===typeof c&&"undefined"!==typeof a&&(c=a);return c},_getSettingsProperty:function(b,a,c){var d;"undefined"===typeof c&&(c={isInherited:!1});"undefined"!==typeof tdcCssEditor._currentCssSettings&&(d=tdcCssEditor._getAvailableViewportSetting(tdcSidebar.currentViewportSettings.name,b,c));"undefined"===typeof d&&"undefined"!==typeof a&&(d=a);return d},_generateDropdownOptions:function(b,a,c){for(var e=[],f,
l=!1,m=0,g=0;g<b.length;g++)d.isUndefined(c)||c!==b[g].value||(m=g),f="",d.isUndefined(a)||a!==b[g].value||(f='selected="selected"',l=!0),e.push("<option "+f+' value="'+b[g].value+'">'+b[g].display+"</option>");l||(e[m]='<option selected="selected" value="'+b[m].value+'">'+b[m].display+"</option>");return e.join("")},_generateCssAttValue:function(b){var a={},c=b.find(".tdc-css-box-input-margin-top").val().trim(),e=b.find(".tdc-css-box-input-margin-right").val().trim(),f=b.find(".tdc-css-box-input-margin-bottom").val().trim(),
l=b.find(".tdc-css-box-input-margin-left").val().trim(),m=b.find(".tdc-css-box-input-border-top-width").val().trim(),g=b.find(".tdc-css-box-input-border-right-width").val().trim(),n=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),p=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),t=b.find(".tdc-css-box-input-padding-right").val().trim(),v=b.find(".tdc-css-box-input-padding-bottom").val().trim(),u=b.find(".tdc-css-box-input-padding-left").val().trim(),
r=b.find(".tdc-css-border-radius").val().trim(),w=b.find(".tdc-css-width").val().trim(),A=b.find(".tdc-css-shadow-size").val().trim(),x=b.find(".tdc-css-shadow-offset-h").val().trim(),z=b.find(".tdc-css-shadow-offset-v").val().trim(),y=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim(),C=b.find(".tdc-css-z-index").val().trim();""!==c&&(a["margin-top"]=c);""!==e&&(a["margin-right"]=e);""!==f&&(a["margin-bottom"]=f);""!==l&&(a["margin-left"]=l);""!==m&&(a["border-top-width"]=
m);""!==g&&(a["border-right-width"]=g);""!==n&&(a["border-bottom-width"]=n);""!==p&&(a["border-left-width"]=p);""!==q&&(a["padding-top"]=q);""!==t&&(a["padding-right"]=t);""!==v&&(a["padding-bottom"]=v);""!==u&&(a["padding-left"]=u);c=b.find(".tdc-css-border-style");e=c.val().trim();""===e||c.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=e);c=b.find(".tdc-css-border-color");e=c.val().trim();""!==e?a["border-color"]=e:(c=c.data("no_value"),d.isUndefined(c)||
1!==c||(a["border-color"]="no_value"));""!==r&&(a["border-radius"]=r);""!==w&&(a.width=w);""!==A&&(a["shadow-size"]=A);r=b.find(".tdc-css-shadow-color");w=r.val().trim();""!==w?a["shadow-color"]=w:(r=r.data("no_value"),d.isUndefined(r)||1!==r||(a["shadow-color"]="no_value"));""!==x&&(a["shadow-offset-h"]=x);""!==z&&(a["shadow-offset-v"]=z);x=b.find(".tdc-css-bg-color");z=x.val().trim();""!==z?a["background-color"]=z:(x=x.data("no_value"),d.isUndefined(x)||1!==x||(a["background-color"]="no_value"));
x=b.find(".tdc-css-bg-image");x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(x=x.data("image_link"),d.isUndefined(x)||("no_value"===x?a["background-image"]="no_value":""!==x&&(a["background-image"]='url("'+x+'")')));x=b.find(".tdc-css-bg-style");z=x.val().trim();""===z||x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["background-style"]=z);x=b.find(".tdc-css-bg-position");z=x.val().trim();""===z||x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||
...
"_max_width"]=tdcSidebar.currentViewportSettings.settings.limitTop,tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name+"_min_width"]=tdcSidebar.currentViewportSettings.settings.limitBottom));tdcDebug.log(tdcCssEditor._currentCssSettings);tdcDebug.log("JSON.stringify");tdcDebug.log(JSON.stringify(tdcCssEditor._currentCssSettings));return d.isEmpty(tdcCssEditor._currentCssSettings)?"":window.btoa(JSON.stringify(tdcCssEditor._currentCssSettings))},_getRgba:function(b){return-1!==
b.indexOf("rgb")?b:(b=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(b))?"rgb("+parseInt(b[1],16)+", "+parseInt(b[2],16)+", "+parseInt(b[3],16)+")":""}}})(jQuery,_);var tdcContextMenu={};
...
if(!_.isUndefined(a))for(var c=0;c<a.length;c++)d.hasOwnProperty(a[c])&&(e[a[c]]=d[a[c]]);tdcContextMenu._model.set("attrs",e);tdcSidebarController.onUpdate(tdcContextMenu._model);tdcSidebarPanel.clearPanel()}tdcContextMenu.hide()}else if(f.hasClass("tdc-paste-list-style")){a=f.data("list-style");console.log(a);var h=tdcUtil.getStorageItem("copyAttrs-"+a);if(!_.isUndefined(h)&&!_.isUndefined(tdcContextMenu._model)){d=tdcContextMenu._model.get("attrs");f=tdcContextMenu._model.get("tag");e=_.clone(d);
console.log("copyListAttrs");console.log(h);for(c=0;c<h.length;c++)null!==h[c]&&c<window.tdcAdminSettings.listStyles[a][f].length&&""!==window.tdcAdminSettings.listStyles[a][f][c]&&(_.isArray(window.tdcAdminSettings.listStyles[a][f][c])?_.map(window.tdcAdminSettings.listStyles[a][f][c],function(a,b){_.isArray(h[c])?_.isUndefined(h[c][b])||(e[a]=h[c][b]):e[a]=h[c]}):_.isArray(h[c])?_.isUndefined(h[c][0])||(e[window.tdcAdminSettings.listStyles[a][f][c]]=h[c][0]):e[window.tdcAdminSettings.listStyles[a][f][c]]=
h[c]);console.log("newAttrs");console.log(e);tdcContextMenu._model.set("attrs",e);tdcSidebarController.onUpdate(tdcContextMenu._model);tdcSidebarPanel.clearPanel()}tdcContextMenu.hide()}});tdcContextMenu.$_resetStyle.on("click",function(f){if(!_.isUndefined(tdcContextMenu._model)){var d=tdcContextMenu._model.get("tag"),b=tdcContextMenu._model.get("attrs");f=_.clone(b);var e=window.tdcAdminSettings.mappedShortcodes[d].tdc_style_params;if(!_.isUndefined(e)){for(var a in b){b=!1;for(var c=0;c<e.length;c++)if(a===
e[c]){b=!0;break}if("tdc_zone"!==d||"type"!==a)b||delete f[a]}if(!_.isUndefined(window.tdcAdminSettings.mappedShortcodes[d].tdc_start_values)){a=JSON.parse(tdcUtil.b64DecodeUnicode(window.tdcAdminSettings.mappedShortcodes[d].tdc_start_values));Array.isArray(a)&&(a=a[0]);for(var h in a)f.hasOwnProperty(h)||(f[h]=a[h])}}tdcContextMenu._model.set("attrs",f);tdcSidebarController.onUpdate(tdcContextMenu._model)}tdcContextMenu.hide()});tdcContextMenu.$_copyStyle.on("mouseover",function(f){""!==tdcContextMenu.$_copyListAttrs.html()&&
...
tdcContextMenu._model.get("tag");var b=tdcContextMenu._model.get("childCollection");if(!_.isUndefined(b))if("vc_column"===f||"vc_column_inner"===f)b.reset();else if("vc_row"===f||"vc_row_inner"===f)_.map(b.models,function(a,b){a=a.get("childCollection");_.isUndefined(a)||a.reset()});else if("tdc_zone"===f){var e;_.map(b.models,function(a,b){_.isUndefined(e)&&(e=a);a=a.get("childCollection");_.map(a.models,function(a,b){a=a.get("childCollection");_.isUndefined(a)||a.reset()})});b=new tdcIFrameData.TdcCollection;
...
"vc_column_inner"===d){var a="";f=tdcContextMenu._model.get("childCollection");_.isUndefined(f)||_.map(f.models,function(b,d){d={error:void 0,getShortcode:""};tdcIFrameData._checkModelData(b,d);_.isUndefined(d.getShortcode)||(a+=d.getShortcode)});tdcUtil.setStorageItem("copyShortcode",tdcUtil.b64EncodeUnicode(a))}else tdcUtil.setStorageItem("copyShortcode",tdcUtil.b64EncodeUnicode(f.getShortcode));tdcContextMenu.hide()},cutShortcodeHandler:function(f){tdcContextMenu.copyShortcodeHandler(f);tdcContextMenu.deleteHandler(f,
...
tdcContextMenu.hide()},setContextMenu:function(f,d){var b="",e=!0,a=!0;if(_.isUndefined(d))return!1;tdcOperationUI.isZone(d)?(b="Zone",e=!1,a=!0):tdcOperationUI.isRow(d)?b="Row":tdcOperationUI.isColumn(d)?(b="Column",e=!1):tdcOperationUI.isInnerRow(d)?b="Inner Row":tdcOperationUI.isInnerColumn(d)?(b="Inner Column",e=!1):tdcOperationUI.isElement(d)&&(b="Element",a=!1);if(""!==b){var c=d.data("model_id"),h=tdcIFrameData.getModel(c);c=h.get("tag");var k=0,l=tdcUtil.getStorageItem("copyShortcodeType"),
m=tdcUtil.getStorageItem("copyShortcode");tdcContextMenu._setCurrentElementOver(d);_.isUndefined(l)||_.isUndefined(m)||""===m?(tdcContextMenu._disable(tdcContextMenu.$_pasteShortcodeBefore),tdcContextMenu._disable(tdcContextMenu.$_pasteShortcodeAfter)):(m="tdc_zone"!==l&&"vc_row"!==l&&"vc_column"!==l&&"vc_row_inner"!==l&&"vc_column_inner"!==l,tdcOperationUI.isRow(d)&&"vc_row"===l||tdcOperationUI.isColumn(d)&&(m||"vc_row_inner"===l||"vc_column"===l)||tdcOperationUI.isInnerRow(d)&&(m||"vc_row_inner"===
l)||tdcOperationUI.isInnerColumn(d)&&(m||"vc_column_inner"===l)||tdcOperationUI.isElement(d)&&m||tdcOperationUI.isElement(d)&&"vc_row_inner"===l&&!d.hasClass("tdc-element-inner-column")?(tdcContextMenu._enable(tdcContextMenu.$_pasteShortcodeBefore),tdcContextMenu._enable(tdcContextMenu.$_pasteShortcodeAfter)):(tdcContextMenu._disable(tdcContextMenu.$_pasteShortcodeBefore),tdcContextMenu._disable(tdcContextMenu.$_pasteShortcodeAfter)));"Element"===b&&(b=window.tdcAdminSettings.mappedShortcodes[c].name);
tdcContextMenu._type=b;tdcContextMenu._model=h;!0===tdcMain.getSidebarInline()&&!1===tdcMain.getSidebarHidden()&&(k=tdcSidebar.$_sidebar.width());tdcContextMenu.$_currentType.html(b);"contextmousedown"===f.type&&tdcContextMenu.$_context.show().css({left:f.pageX+k,top:f.pageY-tdcAdminIFrameUI._liveIframeWindowObject.scrollY});tdcContextMenu.$_context.find(".tdc-copy-list-style, .tdc-paste-list-style").remove();f=!1;if(!_.isUndefined(window.tdcAdminSettings.listStyles))for(var g in window.tdcAdminSettings.listStyles)for(var n in window.tdcAdminSettings.listStyles[g])n===
c&&(tdcContextMenu.$_copyListAttrs.append('<li class="tdc-copy-list-style active" data-list-style="'+g+'">Copy '+g+"</li>"),tdcContextMenu.$_pasteListAttrs.append('<li class="tdc-paste-list-style active" data-list-style="'+g+'">Paste '+g+"</li>"),f=!0);f?(tdcContextMenu.$_copyAttrs.show(),tdcContextMenu.$_copyStyle.find("i").show(),tdcContextMenu.$_pasteStyle.find("i").show()):(tdcContextMenu.$_copyAttrs.hide(),tdcContextMenu.$_copyStyle.find("i").hide(),tdcContextMenu.$_pasteStyle.find("i").hide());
g=tdcUtil.getStorageItem("copyStyleType");n=tdcUtil.getStorageItem("copyStyleAttrs");_.isUndefined(window.tdcAdminSettings.mappedShortcodes[c].tdc_style_params)&&!f?(tdcContextMenu._disable(tdcContextMenu.$_copyStyle),tdcContextMenu._disable(tdcContextMenu.$_resetStyle)):(tdcContextMenu._enable(tdcContextMenu.$_copyStyle),tdcContextMenu._enable(tdcContextMenu.$_resetStyle));_.isUndefined(g)||_.isUndefined(n)?tdcContextMenu._disable(tdcContextMenu.$_pasteStyle):tdcContextMenu._enable(tdcContextMenu.$_pasteStyle);
...
this.button.removeClass("hidden");this.wrap.addClass("wp-picker-active");this.toggler.addClass("wp-picker-open");this.element.tdPalette().get(0).init(a)},save_color:function(){var a=this.element.tdPalette().get(0).color;if("undefined"!==typeof a){""===d.tdcAdminSettings.tdcSavings&&(d.tdcAdminSettings.tdcSavings={});"undefined"===typeof d.tdcAdminSettings.tdcSavings.recentColors&&(d.tdcAdminSettings.tdcSavings.recentColors=[]);var b=d.btoa(JSON.stringify(a)),e=d.tdcAdminSettings.tdcSavings.recentColors.indexOf(b),
k=f(".tdc-gradient-color-values"),l=f(".tdc-color-values");-1!==e&&(d.tdcAdminSettings.tdcSavings.recentColors.splice(e,1),f('.tdc-color-value[data-color="'+a+'"]').remove(),f('.tdc-gradient-color-value[data-color="'+a+'"]').remove());d.tdcAdminSettings.tdcSavings.recentColors.push(b);23<=d.tdcAdminSettings.tdcSavings.recentColors.length&&(l.find(".tdc-color-value:last").remove(),k.find(".tdc-gradient-color-value:last").remove(),d.tdcAdminSettings.tdcSavings.recentColors.splice(0,1));tdcUtil.updateTdcSavings();
l.prepend('<div class="tdc-color-value" data-color="'+a+'" style="background-color:'+a+'"><div class="tdc-color-value-delete"></div>');k.prepend('<div class="tdc-gradient-color-value" data-color="'+a+'" style="background-color:'+a+'"><div class="tdc-gradient-color-value-delete"></div>')}}});"undefined"===typeof f.fn.tdGradient&&(f.fn.tdGradient=function(){return this.each(function(){var a=this,b=f(this);a.$this=b;if(!1!==b.data("rgba")){var h=f.cs_ParseColorValue(b.val());b.tdGradientColorPicker({clear:function(){b.trigger("keyup")},
change:function(c,d){c=d.color.toString();b.closest(".wp-picker-container").find(".cs-alpha-slider-offset").css("background-color",c);b.val(c).trigger("change");a.triggerSelection?a.setColor(c,!0):a.setColor(c)},create:function(){var c=b.data("a8cIris"),l=b.closest(".wp-picker-container"),m=f('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(l.find(".wp-picker-holder")),g=m.find(".cs-alpha-slider"),
n=m.find(".cs-alpha-text"),p=m.find(".cs-alpha-slider-offset"),q=f('<div class="tdc-gradient-result-wrap"></div>').prependTo(l);q=f('<div class="tdc-gradient-result"><div class="tdc-gradient-color tdc-gradient-left-color"></div><div class="tdc-gradient-color tdc-gradient-right-color"></div></div>').prependTo(q);f('<div class="tdc-gradient-degree-label">deg.</div><input class="tdc-gradient-degree" placeholder="0">').appendTo(l.find(".wp-picker-input-wrap"));f('<div class="tdc-gradient-result-labels"><div class="tdc-gradient-result-label">Solid color</div><div class="tdc-gradient-result-label tdc-gradient-result-percentage"></div><div class="tdc-gradient-result-label">Gradient</div></div>').prependTo(l);
f('<div class="tdc-gradient-save">Save Gradient</div>').appendTo(l);var t=f('<div class="tdc-gradient-presets">Gradient presets</div>').appendTo(l),v=f('<div class="tdc-gradient-values-wrapper"></div>').appendTo(l);v=f('<div class="tdc-gradient-values"></div>').appendTo(v);var u=f('<div class="tdc-gradient-color-values-wrapper"></div>').appendTo(l);u=f('<div class="tdc-gradient-color-values"></div>').appendTo(u);if("undefined"!==typeof d.tdcAdminSettings.tdcSavings.gradients&&d.tdcAdminSettings.tdcSavings.gradients.length)for(var r=
!1,w=d.tdcAdminSettings.tdcSavings.gradients.length-1;0<=w;w--){var A=d.tdcAdminSettings.tdcSavings.gradients[w];try{var x=JSON.parse(d.atob(A));"undefined"!==typeof x.css&&(r=!0,f('<div class="tdc-gradient-value" style="'+x.css+'" data-gradient="'+A+'"><div class="tdc-gradient-value-delete"></div></div>').appendTo(v))}catch(z){}}r||t.hide();a.$container=l;a.$gradientResult=q;g.slider({slide:function(a,d){a=parseFloat(d.value/100);c._color._alpha=a;b.tdGradientColorPicker("color",c._color.toString());
n.text(1>a?a:"")},create:function(){var d=parseFloat(h.alpha/100);n.text(1>d?d:"");p.css("background-color",h.value);l.on("click",".wp-picker-clear",function(){c._color._alpha=1;n.text("");g.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(e,!0):a.setColor(e)});l.on("click",".wp-picker-default",function(){var a=f.cs_ParseColorValue(b.data("default-color")),d=parseFloat(a.alpha/100);c._color._alpha=d;n.text(1>d?d:"");g.slider("option","value",a.alpha).trigger("slide")});
l.on("click",".wp-color-result",function(a){m.toggle()});f("body").on("click.wpcolorpicker",function(){m.hide()});l.on("change keyup",".tdc-gradient-degree",function(b){b=f(this);a.degree=b.val().trim();a.mixedColors=a._getMixedColors();a._updateGradient();a._saveValue()})},value:h.alpha,step:1,min:0,max:100});if("undefined"!==typeof d.tdcAdminSettings.tdcSavings.recentColors&&d.tdcAdminSettings.tdcSavings.recentColors.length)for(w=d.tdcAdminSettings.tdcSavings.recentColors.length-1;0<=w;w--){r=d.tdcAdminSettings.tdcSavings.recentColors[w];
try{x=JSON.parse(d.atob(r)),"undefined"!==typeof x&&f('<div class="tdc-gradient-color-value" style="background-color: '+x+'" data-color="'+x+'"><div class="tdc-gradient-color-value-delete"></div></div>').appendTo(u)}catch(z){}}}})}else b.tdGradientColorPicker({clear:function(){b.trigger("keyup")},change:function(a,c){b.val(c.color.toString()).trigger("change")}});"undefined"===typeof a.setColor&&(a.setColor=function(b,c){"undefined"===typeof a.currentColor&&(a.currentColor="left",a.$gradientResult.find(".tdc-gradient-selected-color").remove(),
...
c.data("percentage"))+"%")):d.html("");b=f(b.currentTarget);if(b.hasClass("tdc-gradient-left-color")){if(a.currentColor="left","undefined"!==typeof a.color1)var e=a.color1}else b.hasClass("tdc-gradient-right-color")?(a.currentColor="right","undefined"!==typeof a.color2&&(e=a.color2)):(a.currentColor="mixed",b=a._getCurrentMixedColor(),"undefined"!==typeof b&&(e=b.color));"undefined"!==typeof e&&a._showColor(e)}),a.$container.on("mousedown",".tdc-gradient-result",function(b){if(b.target===b.currentTarget){var c=
f(b.target);c.find(".tdc-gradient-selected-color").remove();var d=f('<div class="tdc-gradient-mix-color tdc-gradient-color"><div class="tdc-gradient-selected-color"></div></div>').appendTo(c);b=b.pageX-c.offset().left-d.outerWidth(!0)/2;c=Math.round(100-100*b/(c.width()-d.outerWidth(!0)));d.css("left",b);d.data("percentage",c);a.currentColor="mixed"}}),a.$container.on("mouseup",".tdc-gradient-mix-color",function(b){f(this).removeClass("tdc-gradient-current-mix");a.eventOffsetX=e}),a.$container.on("mousemove",
".tdc-gradient-result",function(b){var c=a.$container.find(".tdc-gradient-result-percentage"),d=a.$container.find(".tdc-gradient-result"),e=d.find(".tdc-gradient-right-color"),f=d.find(".tdc-gradient-current-mix");if(f.length){var k=0;"undefined"!==typeof a.eventOffsetX&&(k=a.eventOffsetX);b=b.pageX-d.offset().left-f.width()/2-k;k=100*b/(d.width()-f.outerWidth(!0));0>k?b=k=0:100<k&&(k=100,b=d.width()-e.outerWidth(!0));c.html(Math.round(k)+"%");f.css("left",b);f.data("percentage",Math.round(100-k));
...
c="",d=c="",h=["-webkit-linear-gradient","linear-gradient"];c="undefined"!==typeof a.degree&&""!==a.degree.trim()?a.degree+"deg,":"0deg,";for(var n=0;n<h.length;n++){var p="";if("undefined"!==typeof a.mixedColors)for(var q=0;q<a.mixedColors.length;q++){var t="";"undefined"!==typeof a.mixedColors[q].percentage&&(t=a.mixedColors[q].percentage+"%");"undefined"!==typeof a.mixedColors[q].color&&(p+=a.mixedColors[q].color+" "+t+",")}b+="background: "+h[n]+"("+c+a.color2+","+p+a.color1+");";d+="background: "+
h[n]+"( -90deg,"+a.color2+","+p+a.color1+");"}c=c+a.color2+","+p+a.color1;a.result={type:"gradient",color1:a.color1,color2:a.color2,mixedColors:a.mixedColors,degree:a.degree,css:b,cssParams:c};a.$gradientResult.attr("style",d)}else if("undefined"!==typeof a.color1||"undefined"!==typeof a.color2){b="color1";var v="color2";"undefined"!==typeof a.color2&&(b="color2",v="color1");if(a.mixedColors.length){var u=a.mixedColors[0];"undefined"!==typeof a.color2&&(u=a.mixedColors[a.mixedColors.length-1]);b=
...
e+'"><div class="tdc-gradient-value-delete"></div></div>').prependTo(c);a.$container.find(".tdc-gradient-presets").show()}))}}),a.$container.on("mousedown",".tdc-gradient-value",function(b){b=jQuery(b.currentTarget).data("gradient");var c=a.$container.parent().prev(".tdc-property-gradient"),d=c.find("input");c=c.find(".tdc-gradient-wrap");a.init(b);d.val(b);c.attr("style",a.result.css);d.trigger("change")}),a.$container.on("mousedown",".tdc-gradient-color-value",function(b){var c=jQuery(b.currentTarget).data("color"),
...
a.mixedColors=b.mixedColors;if("undefined"!==typeof a.mixedColors)for(var h=0;h<a.mixedColors.length;h++){var k=f('<div class="tdc-gradient-color tdc-gradient-mix-color"></div>').appendTo(c),n=(c.width()-k.outerWidth(!0))*(100-a.mixedColors[h].percentage)/100;k.css("left",n);k.data("percentage",a.mixedColors[h].percentage);"undefined"!==typeof a.mixedColors[h].color&&k.data("color",a.mixedColors[h].color)}a._updateGradient()}catch(p){a.setColor(b),a.$this.tdGradientColorPicker("color",b)}b=f.cs_ParseColorValue(a.color1);
c=parseFloat(b.alpha/100);c=1>c?c:"";a.$container.find(".cs-alpha-text").text(c);a.$container.find(".cs-alpha-slider-offset").css("background-color",b.value);a.$container.find(".cs-alpha-slider").slider("option","value",b.alpha).trigger("slide")}else a.setColor(e),a.$container.find(".wp-picker-clear").trigger("click");a.triggerSelection=!0})})});"undefined"===typeof f.fn.tdPalette&&(f.fn.tdPalette=function(){return this.each(function(){var a=this,b=f(this);a.$this=b;if(!1!==b.data("rgba")){var h=
f.cs_ParseColorValue(b.val());b.tdPaletteColorPicker({clear:function(){b.trigger("keyup")},change:function(c,d){c=d.color.toString();b.closest(".wp-picker-container").find(".cs-alpha-slider-offset").css("background-color",c);b.val(c).trigger("change");a.triggerSelection?a.setColor(c,!0):a.setColor(c)},create:function(){var c=b.data("a8cIris"),l=b.closest(".wp-picker-container"),m=f('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(l.find(".wp-picker-holder")),
g=m.find(".cs-alpha-slider"),n=m.find(".cs-alpha-text"),p=m.find(".cs-alpha-slider-offset"),q=f('<div class="tdc-color-values"></div>').appendTo(l.find(".wp-picker-holder"));a.$container=l;if("undefined"!==typeof d.tdcAdminSettings.tdcSavings.recentColors&&d.tdcAdminSettings.tdcSavings.recentColors.length)for(var t=d.tdcAdminSettings.tdcSavings.recentColors.length-1;0<=t;t--){var v=d.tdcAdminSettings.tdcSavings.recentColors[t];try{var u=JSON.parse(d.atob(v));"undefined"!==typeof u&&f('<div class="tdc-color-value" style="background-color: '+
u+'" data-color="'+u+'"><div class="tdc-color-value-delete"></div></div>').appendTo(q)}catch(r){}}g.slider({slide:function(a,d){a=parseFloat(d.value/100);c._color._alpha=a;b.tdPaletteColorPicker("color",c._color.toString());n.text(1>a?a:"")},create:function(){var d=parseFloat(h.alpha/100);n.text(1>d?d:"");p.css("background-color",h.value);l.on("click",".wp-picker-clear",function(){c._color._alpha=1;n.text("");g.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(e,!0):a.setColor(e)});
l.on("click",".wp-picker-default",function(){var a=f.cs_ParseColorValue(b.data("default-color")),d=parseFloat(a.alpha/100);c._color._alpha=d;n.text(1>d?d:"");g.slider("option","value",a.alpha).trigger("slide")});l.on("click",".wp-color-result",function(a){m.toggle()});f("body").on("click.wpcolorpicker",function(){m.hide()})},value:h.alpha,step:1,min:0,max:100})}})}else b.tdPaletteColorPicker({clear:function(){b.trigger("keyup")},change:function(a,c){b.val(c.color.toString()).trigger("change")}});
"undefined"===typeof a.setColor&&(a.setColor=function(b,c){a.color=b;!0===c&&a._saveValue()},a._saveValue=function(){var b=a.$container.parent().prev(".tdc-property-colorpicker"),c=b.find("input");b=b.find(".tdc-colorpicker-wrap");"undefined"===typeof a.color?(c.val(""),b.removeAttr("style")):(c.val(a.color),b.attr("style","background: "+a.color));c.trigger("change")},a.$container.on("mousedown",".tdc-color-value",function(b){b=jQuery(b.currentTarget).data("color");a.init(b);a._saveValue()}),a.$container.on("mousedown",
".tdc-color-value-delete",function(a){a.preventDefault();a.stopImmediatePropagation();var b=f(this).parent();a=b.data("color");a=d.btoa(JSON.stringify(a));a=d.tdcAdminSettings.tdcSavings.recentColors.indexOf(a);d.tdcAdminSettings.tdcSavings.recentColors.splice(a,1);a=!0;for(var c in d.tdcAdminSettings.tdcSavings)if(d.tdcAdminSettings.tdcSavings[c].length){a=!1;break}a&&(d.tdcAdminSettings.tdcSavings="");tdcUtil.updateTdcSavings(this,function(){b.remove()})}),a.init=function(b){a.triggerSelection=
...
"value",b.alpha).trigger("slide")}else a.setColor(e),a.$container.find(".wp-picker-clear").trigger("click");a.triggerSelection=!0})})})})(jQuery,window,document);
...
function(b){return b.replace(new RegExp(this.cssCommentsRegex,"gi"),"")};d.prototype.parseCSS=function(b){if(void 0===b)return[];for(var d=[];;){var a=this.cssImportStatementRegex.exec(b);if(null!==a)this.cssImportStatements.push(a[0]),d.push({selector:"@imports",type:"imports",styles:a[0]});else break}b=b.replace(this.cssImportStatementRegex,"");a=new RegExp(this.cssKeyframeRegex,"gi");for(var c;;){c=a.exec(b);if(null===c)break;d.push({selector:"@keyframes",type:"keyframes",styles:c[0]})}b=b.replace(a,
"");for(a=new RegExp(this.combinedCSSRegex,"gi");;){c=a.exec(b);if(null===c)break;var f=void 0===c[2]?c[5].split("\r\n").join("\n").trim():c[2].split("\r\n").join("\n").trim();var k=new RegExp(this.cssCommentsRegex,"gi"),l=k.exec(f);null!==l&&(f=f.replace(k,"").trim());f=f.replace(/\n+/,"\n");-1!==f.indexOf("@media")?(f={selector:f,type:"media",subStyles:this.parseCSS(c[3]+"\n}")},null!==l&&(f.comments=l[0]),d.push(f)):(c=this.parseRules(c[6]),c={selector:f,rules:c},"@font-face"===f&&(c.type="font-face"),
null!==l&&(c.comments=l[0]),d.push(c))}return d};d.prototype.parseRules=function(b){b=b.split("\r\n").join("\n");var d=[];b=b.split(";");for(var a=0;a<b.length;a++){var c=b[a];c=c.trim();if(-1!==c.indexOf(":")){c=c.split(":");var f=c[0].trim();c=c.slice(1).join(":").trim();1>f.length||1>c.length||d.push({directive:f,value:c})}else"base64,"===c.trim().substr(0,7)?d[d.length-1].value+=c.trim():0<c.length&&d.push({directive:"",value:c,defective:!0})}return d};d.prototype.findCorrespondingRule=function(b,
d,a){void 0===a&&(a=!1);for(var c=!1,e=0;e<b.length&&(b[e].directive!==d||(c=b[e],a!==b[e].value));e++);return c};d.prototype.findBySelector=function(b,d,a){void 0===a&&(a=!1);for(var c=[],e=0;e<b.length;e++)!1===a?b[e].selector===d&&c.push(b[e]):-1!==b[e].selector.indexOf(d)&&c.push(b[e]);if(2>c.length)return c;b=c[0];for(e=1;e<c.length;e++)this.intelligentCSSPush([b],c[e]);return[b]};d.prototype.deleteBySelector=function(b,d){for(var a=[],c=0;c<b.length;c++)b[c].selector!==d&&a.push(b[c]);return a};
d.prototype.compressCSS=function(b){for(var d=[],a={},c=0;c<b.length;c++){var f=b[c];if(!0!==a[f.selector]){var k=this.findBySelector(b,f.selector);0!==k.length&&(d.push(k[0]),a[f.selector]=!0)}}return d};d.prototype.cssDiff=function(b,d){if(b.selector!==d.selector||"media"===b.type||"media"===d.type)return!1;for(var a={selector:b.selector,rules:[]},c,e,f=0;f<b.rules.length;f++)c=b.rules[f],e=this.findCorrespondingRule(d.rules,c.directive,c.value),!1===e?a.rules.push(c):c.value!==e.value&&a.rules.push(c);
for(f=0;f<d.rules.length;f++)e=d.rules[f],c=this.findCorrespondingRule(b.rules,e.directive),!1===c&&(e.type="DELETED",a.rules.push(e));return 0===a.rules.length?!1:a};d.prototype.intelligentMerge=function(b,d,a){void 0===a&&(a=!1);for(var c=0;c<d.length;c++)this.intelligentCSSPush(b,d[c],a);for(c=0;c<b.length;c++)d=b[c],"media"!==d.type&&"keyframes"!==d.type&&(d.rules=this.compactRules(d.rules))};d.prototype.intelligentCSSPush=function(b,d,a){var c=!1;void 0===a&&(a=!1);if(!1===a)for(a=0;a<b.length;a++){if(b[a].selector===
d.selector){c=b[a];break}}else for(a=b.length-1;-1<a;a--)if(b[a].selector===d.selector){c=b[a];break}if(!1===c)b.push(d);else if("media"!==d.type)for(b=0;b<d.rules.length;b++){a=d.rules[b];var e=this.findCorrespondingRule(c.rules,a.directive);!1===e?c.rules.push(a):"DELETED"===a.type?e.type="DELETED":e.value=a.value}else c.subStyles=c.subStyles.concat(d.subStyles)};d.prototype.compactRules=function(b){for(var d=[],a=0;a<b.length;a++)"DELETED"!==b[a].type&&d.push(b[a]);return d};d.prototype.getCSSForEditor=
function(b,d){void 0===d&&(d=0);var a="";void 0===b&&(b=this.css);for(var c=0;c<b.length;c++)"imports"===b[c].type&&(a+=b[c].styles+"\n\n");for(c=0;c<b.length;c++){var e=b[c];if(void 0!==e.selector){var f="";void 0!==e.comments&&(f=e.comments+"\n");"media"===e.type?(a+=f+e.selector+"{\n",a+=this.getCSSForEditor(e.subStyles,d+1),a+="}\n\n"):"keyframes"!==e.type&&"imports"!==e.type&&(a+=this.getSpaces(d)+f+e.selector+" {\n",a+=this.getCSSOfRules(e.rules,d+1),a+=this.getSpaces(d)+"}\n\n")}}for(c=0;c<
b.length;c++)"keyframes"===b[c].type&&(a+=b[c].styles+"\n\n");return a};d.prototype.getImports=function(b){for(var d=[],a=0;a<b.length;a++)"imports"===b[a].type&&d.push(b[a].styles);return d};d.prototype.getCSSOfRules=function(b,d){for(var a="",c=0;c<b.length;c++)void 0!==b[c]&&(a=void 0===b[c].defective?a+(this.getSpaces(d)+b[c].directive+": "+b[c].value+";\n"):a+(this.getSpaces(d)+b[c].value+";\n"));return a||"\n"};d.prototype.getSpaces=function(b){for(var d="",a=0;a<4*b;a++)d+=" ";return d};d.prototype.applyNamespacing=
function(b,d){var a=b,c="."+this.cssPreviewNamespace;void 0!==d&&(c=d);"string"===typeof b&&(a=this.parseCSS(b));for(b=0;b<a.length;b++){var e=a[b];if(!(-1<e.selector.indexOf("@font-face")||-1<e.selector.indexOf("keyframes")||-1<e.selector.indexOf("@import")||-1<e.selector.indexOf(".form-all")||-1<e.selector.indexOf("#stage")))if("media"!==e.type){for(var f=e.selector.split(","),l=[],m=0;m<f.length;m++)-1===f[m].indexOf(".supernova")?l.push(c+" "+f[m]):l.push(f[m]);e.selector=l.join(",")}else e.subStyles=
this.applyNamespacing(e.subStyles,d)}return a};d.prototype.clearNamespacing=function(b,d){void 0===d&&(d=!1);var a=b,c="."+this.cssPreviewNamespace;"string"===typeof b&&(a=this.parseCSS(b));for(b=0;b<a.length;b++){var e=a[b];if("media"!==e.type){for(var f=e.selector.split(","),l=[],m=0;m<f.length;m++)l.push(f[m].split(c+" ").join(""));e.selector=l.join(",")}else e.subStyles=this.clearNamespacing(e.subStyles,!0)}return!1===d?this.getCSSForEditor(a):a};d.prototype.createStyleElement=function(b,d,a){void 0===
a&&(a=!1);!1===this.testMode&&"nonamespace"!==a&&(d=this.applyNamespacing(d));"string"!==typeof d&&(d=this.getCSSForEditor(d));!0===a&&(d=this.getCSSForEditor(this.parseCSS(d)));if(!1!==this.testMode)return this.testMode("create style #"+b,d);(a=document.getElementById(b))&&a.parentNode.removeChild(a);a=document.head||document.getElementsByTagName("head")[0];var c=document.createElement("style");c.id=b;c.type="text/css";a.appendChild(c);c.styleSheet&&!c.sheet?c.styleSheet.cssText=d:c.appendChild(document.createTextNode(d))};
f.cssjs=d})(this);jQuery("#tdc-live-iframe").load(function(){jQuery("body").addClass("tdcComposerLoaded")});var tdcLivePanel;
