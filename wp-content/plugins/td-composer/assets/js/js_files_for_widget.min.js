...
(function(k,a,c){tdcCssEditor={_mappedParameter:c,_model:c,_currentCssSettings:c,_INHERITED_CSS_CLASS:"tdc-css-inherited",_INACTIVE_CSS_CLASS:"tdc-css-inactive",_isInitialized:!1,init:function(){tdcCssEditor._isInitialized||(tdcCssEditor._bindEvents(),tdcCssEditor._isInitialized=!0)},tdcCssImageWrapHandler:function(b){var c=k(b.currentTarget),d=c.closest(".tdc-tab-content");window.original_send_to_editor=window.send_to_editor;wp.media.editor.open(c);k(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");
k(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");k(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(b){var e=k("img",b).attr("src"),f="";"undefined"===typeof e?(e=k(b).attr("src"),f=k(b).attr("class")):f=k("img",b).attr("class");k.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},
dataType:"json",data:{image_class:f,action:"tdc_ajax_get_image_id"}}).done(function(b,f,g){if("success"===f)if(a.isObject(b)&&a.has(b,"errors"))new tdcNotice.notice(b.errors,!0,!1);else{f=c.closest(".tdc-property-wrap");g=f.find(".tdc-css-image-remove");var h=f.find(".tdc-inherit-image");g.removeClass("tdc-hidden-button");"all"===tdcSidebar.currentViewportSettings.name?h.hide():h.show();c.attr("style","background-image: url( '"+e+"') ");c.data("image_link",e);c.data("image_id",b.image_id);window.send_to_editor=
window.original_send_to_editor;window.tb_remove();f.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);"undefined"===typeof c.data("model_id")?tdcCssEditor.saveWidgetForm(c):(b=tdcCssEditor._generateCssAttValue(d),f=tdcIFrameData.getModel(c.data("model_id")),tdcSidebarController.onUpdate(f,c.data("param_name"),"",b))}}).fail(function(a,b,c){})};return!1},tdcCssImageRemoveHandler:function(b){var c=k(b.currentTarget),d=c.closest(".tdc-property-wrap");b=d.find(".tdc-css-image-wrap");var f=d.find(".tdc-inherit-image");
...
tdcSidebarController.onUpdate(f,b.data("param_name"),"",c))},_updateColorField:function(b){var c=b.closest(".tdc-property-wrap"),d=c.data("tdc-for"),f=c.find(".tdc-inherit-color"),g=c.find(".tdc-colorpicker-wrap"),l=b.data("no_value"),n=b.data("default_value");a.isUndefined(l)||1!==l?("all"!==tdcSidebar.currentViewportSettings.name&&f.show(),tdcCssEditor._updateData(b),f={isInherited:!1},d=tdcCssEditor._getSettingsProperty(d,"",f),f.isInherited?(b.attr("placeholder",d),b.val(""),c.addClass(tdcCssEditor._INHERITED_CSS_CLASS),
...
d=c.val();var g=1;c.hasClass("tdc-css-opacity")&&(g=.01);var l=NaN;switch(b.type){case "keyup":switch(b.keyCode){case 38:k.isNumeric(d)&&(l=parseFloat(d)+g);break;case 40:k.isNumeric(d)&&(l=parseFloat(d)-g)}break;case "mousewheel":b.preventDefault(),b.stopImmediatePropagation(),k.isNumeric(d)&&(l=0<b.originalEvent.deltaY?parseFloat(d)-g:parseFloat(d)+g)}a.isNaN(l)||(1>g&&(l=l.toFixed(2)),c.val(l));tdcCssEditor._updateData(c);d=f.data("tdc-for");b={isInherited:!1};d=tdcCssEditor._getSettingsProperty(d,
...
a+'"':""}function d(){return n.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function f(c,e){e=tdcCssEditor._getSettingsProperty(c,e,b());var f="-",h="";n.isInherited&&(f=e,e="");a.isUndefined(l)||"margin-left"!==c&&"margin-right"!==c||(h=l.get("tag"),h="vc_column"===h||"vc_column_inner"===h?" "+tdcCssEditor._INACTIVE_CSS_CLASS:"");return'<input data-tdc-for="'+c+'" name="" type="text" value="'+e+'" class="tdc-css-box-input tdc-css-box-input-'+c+d()+h+'" title="Css '+c+'" placeholder="'+f+
'" '+tdcSidebarPanel._getParamterDataAtts(g,l)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var g=tdcCssEditor._mappedParameter,l=tdcCssEditor._model,n={isInherited:!1};var h='<div class="tdc-responsiveness"><div class="'+(tdcSidebarPanel._getParameterClasses(g)+'">');h=h+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+f("margin-top","");h+=f("margin-right","");h+=f("margin-bottom","");h+=f("margin-left","");h=h+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+
f("border-top-width","");h+=f("border-right-width","");h+=f("border-bottom-width","");h+=f("border-left-width","");h=h+'<div class="tdc-box-padding"><div class="tdc-padding-label">Padding</div>'+f("padding-top","");h+=f("padding-right","");h+=f("padding-bottom","");h+=f("padding-left","");h+="</div></div></div></div>";var m=tdcCssEditor._getSettingsProperty("border-style",c,b());h+='<div class="tdc-property-wrap tdc-border-style tdc-dropdown-big'+d()+'" data-tdc-for="border-style">';h=h+'<div class="tdc-property-title"><span title="Css border-style" class="tdc-search-data">Border style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-border-style" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"solid",display:"Solid"},{value:"dotted",display:"Dotted"},{value:"dashed",display:"Dashed"},{value:"none",display:"None"},{value:"hidden",display:"Hidden"},{value:"double",display:"Double"},{value:"groove",display:"Groove"},{value:"ridge",display:"Ridge"},{value:"inset",display:"Inset"},{value:"outset",display:"Outset"},{value:"initial",display:"Initial"},{value:"inherit",display:"Inherit"}],
m);h+="</select></div></div>";m=a.uniqueId();var q=tdcCssEditor._getSettingsProperty("border-color","",b()),p="";n.isInherited&&(p=q,q="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+d()+'" data-tdc-for="border-color">';h=h+'<div class="tdc-property-title"><span title="Css border-color" class="tdc-search-data">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(q)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+e(p)+' value="'+q+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("border-radius","",b());q="";n.isInherited&&(q=m,m="");h+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+d()+'" data-tdc-for="border-radius">';h=h+'<div class="tdc-property-title"><span title="Css border-radius" class="tdc-search-data">Border radius</span></div><div class="tdc-property"><input class="tdc-css-border-radius" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("width","",b());q="";n.isInherited&&(q=m,m="");h+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+d()+'" data-tdc-for="width">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Width</span></div><div class="tdc-property"><input class="tdc-css-width" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("shadow-size","",b());q="";n.isInherited&&(q=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-size">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Shadow size</span></div><div class="tdc-property"><input class="tdc-css-shadow-size" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+m+'"/>');h+="</div></div>";m=a.uniqueId();q=tdcCssEditor._getSettingsProperty("shadow-color","",b());p="";n.isInherited&&(p=q,q="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+d()+'" data-tdc-for="shadow-color">';h=h+'<div class="tdc-property-title"><span title="Css shadow-color" class="tdc-search-data">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(q)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+e(p)+' value="'+q+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-h","",b());q="";n.isInherited&&(q=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-offset-h">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-h" class="tdc-search-data">Shadow offset H</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-h" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+m+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-v","",b());q="";n.isInherited&&(q=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-offset-v">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-v" class="tdc-search-data">Shadow offset V</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-v" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=a.uniqueId();q=tdcCssEditor._getSettingsProperty("background-color","",b());p="";n.isInherited&&(p=q,q="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+d()+'" data-tdc-for="background-color">';h=h+'<div class="tdc-property-title"><span title="Css background-color" class="tdc-search-data">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(q)+' id="'+m+'" name="" type="text" '+e(p)+' value="'+q+'"/>');h+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",c,b());h+='<div class="tdc-property-wrap tdc-property-attach_image'+d()+'">';h=h+'<div class="tdc-property-title"><span title="Css background-image" class="tdc-search-data">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property"><div class="tdc-css-bg-image tdc-css-image-wrap " '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+" style=\"background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png' )\"></div>");h+='<a class="tdc-css-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';m=tdcCssEditor._getSettingsProperty("background-style",c,b());h+='<div class="tdc-property-wrap tdc-bg-style tdc-dropdown-big'+d()+'" data-tdc-for="background-style">';h=h+'<div class="tdc-property-title"><span title="Css background-size & background-repeat" class="tdc-search-data">Background style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-bg-style" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"cover",display:"Cover"},{value:"contain",display:"Contain"},{value:"no-repeat",display:"No repeat"},{value:"repeat",display:"Repeat"}],m);h+="</select></div></div>";m=tdcCssEditor._getSettingsProperty("background-position",c,b());h+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+d()+'" data-tdc-for="background-position">';h=h+'<div class="tdc-property-title"><span title="Css background-position" class="tdc-search-data">Background position<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-bg-position" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"center top",display:"Center Top"},{value:"center center",display:"Center Center"},{value:"center bottom",display:"Center Bottom"},{value:"left top",display:"Left Top"},{value:"left center",display:"Left Center"},{value:"left bottom",display:"Left Bottom"},{value:"right top",display:"Right Top"},{value:"right center",display:"Right Center"},{value:"right bottom",display:"Right Bottom"}],m);h+=
"</select></div></div>";m=tdcCssEditor._getSettingsProperty("opacity","",b());q="";n.isInherited&&(q=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+d()+'" data-tdc-for="opacity">';h=h+'<div class="tdc-property-title"><span title="Css background-image opacity" class="tdc-search-data">Background opacity</span></div><div class="tdc-property"><input class="tdc-css-opacity" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
m=a.uniqueId();q=tdcCssEditor._getSettingsProperty("color-1-overlay","",b());p="";n.isInherited&&(p=q,q="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+d()+'" data-tdc-for="color-1-overlay">';h=h+'<div class="tdc-property-title"><span title="Css gradient color From" class="tdc-search-data">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(q)+' id="'+m+'" name="" type="text" '+e(p)+' value="'+q+'"/>');h+="</div></div>";m=a.uniqueId();q=tdcCssEditor._getSettingsProperty("color-2-overlay","",b());p="";n.isInherited&&(p=q,q="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+d()+'" data-tdc-for="color-2-overlay">';h=h+'<div class="tdc-property-title"><span  title="Css gradient color To" class="tdc-search-data">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(q)+' id="'+m+'" name="" type="text" '+e(p)+' value="'+q+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("gradient-direction","",b());q="";n.isInherited&&(q=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+d()+'" data-tdc-for="gradient-direction">';h=h+'<div class="tdc-property-title"><span title="Css gradient direction" class="tdc-search-data">Gradient direction</span></div><div class="tdc-property"><input class="tdc-css-gradient-direction" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=tdcCssEditor._getSettingsProperty("content-h-align",c,b());h+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+d()+'" data-tdc-for="content-h-align">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-content-h-align" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],m);h+="</select></div></div>";m=tdcCssEditor._getSettingsProperty("z-index","",b());q="";n.isInherited&&(q=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+d()+'" data-tdc-for="z-index">';h=h+'<div class="tdc-property-title"><span title="Z-index" class="tdc-search-data">Z-index</span></div><div class="tdc-property"><input class="tdc-css-z-index" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+m+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsPropertyFromCssSettings("display",c);h+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+d()+'" data-tdc-for="display">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">Display</span></div><div class="tdc-property"><select class="tdc-css-display" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');
h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Show"},{value:"none",display:"Hidden"},{value:"inline",display:"Inline"},{value:"inline-block",display:"Inline-block"},{value:"block",display:"Block"},{value:"table",display:"Table"},{value:"inline-table",display:"Inline-table"}],m);h=h+'</select></div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div><div class="tdc-clear-css-properties" '+(tdcSidebarPanel._getParamterDataAtts(g,
l)+' title="Clear all tab css settings">Clear CSS settings</div>');h+="</div>";tdcSidebarPanel._hook.addAction("panel_css",tdcCssEditor.callbackColorPicker);tdcSidebarPanel._hook.addAction("panel_css",function(){k(".tdc-inherit").each(function(b,e){b=k(e);e=b.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||e.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))b.hide();else{var d=e.data("tdc-for");e={isInherited:!1};d=tdcCssEditor._getSettingsProperty(d,c,e);e.isInherited?
...
".tdc-tab-no-design .tdc-property-range_multiple input",function(a){var b=jQuery(this),c=this;if("range"===b.attr("type")){var d=b.closest(".tdc-property").find('input[type="radio"]:checked');b.closest(".tdc-property").find('input[type="text"]').val(b.val());d.data("last_value",b.val())}else if("text"===b.attr("type")){c=b.closest(".tdc-property").find('input[type="range"]');d=b.closest(".tdc-property").find('input[type="radio"]:checked');var f=d.data("default_value"),g=b.val().trim();""!==g||_.isUndefined(f)||
""===f||(g=f,b.val(g));c.val(g);d.data("last_value",g);c=c.get(0)}else if("radio"===b.attr("type")){c=b.closest(".tdc-property").find('input[type="range"]');d=b.closest(".tdc-property").find('input[type="text"]');b.closest(".tdc-property").find('input[type="radio"]:checked');g=b.data("last_value");f=b.data("default_value");var l=b.data("unit");b=c.data("min_"+l);var n=c.data("max_"+l);l=c.data("step_"+l);c.get(0).min=b;c.get(0).max=n;c.get(0).step=l;""===g?(d.val(f),c.val(f)):(d.val(g),c.val(g));
c=c.get(0)}f="";d=jQuery(c).parent().find('input[type="radio"]:checked');d.length&&(f=jQuery(d[0]).data("unit_value"));"focusin"===a.type?c.oldValue=c.value+f:(a=c.value+f,f=tdcIFrameData.getModel(jQuery(c).data("model_id")),tdcSidebarController.onUpdate(f,jQuery(c).data("param_name"),c.oldValue,_.escape(a)),c.oldValue=a)});a.on("keyup change input",".tdc-tab-no-design .tdc-property-range_multiple-responsive input",function(a){var b=jQuery(this),c=b.closest(".tdc-property-responsive"),d=c.find('input[type="range"]'),
f=c.find('input[type="radio"]:checked'),g=c.find('input[type="text"]'),l=d.get(0),n="",h=f.data("default_value"),m=tdcIFrameData.getModel(d.data("model_id")),k=d.data("param_name"),p=window.tdcAdminSettings.mappedShortcodes[m.attributes.tag],u=m="";var v=[];for(var r=0;r<p.params.length;r++)if(k===p.params[r].param_name){r=p.params[r].tdc_values;for(var t in r)r.hasOwnProperty(t)&&(v.push(r[t].unit),""===m||""===u)&&(m=r[t].value,u=r[t].unit);break}f.length&&(n=f.data("unit_value"));if("range"===
b.attr("type"))v=d.val(),g.val(v),f.data("last_value",v),g.val(v),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),v+n,tdcSidebar.currentViewportSettings.name)),c.removeClass("tdc-css-inherited");else if("text"===b.attr("type")){if("input"===a.type||"change"===a.type)return;c.removeClass("tdc-css-inherited");v=g.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==v||_.isUndefined(h)||""===h?(d.val(v),f.data("last_value",v),d.data("data-to-save",
tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),v+n,tdcSidebar.currentViewportSettings.name))):(d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+k,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",u),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+u+'"]'),p=n.data("unit"),t=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",!0),l.min=t,l.max=f,l.step=p,l.value=m,n.data("last_value",m),g.val(m));
else if(""===v)if(n=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),"undefined"===typeof n)d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+k,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",u),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+u+'"]'),p=n.data("unit"),t=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",!0),l.min=t,l.max=f,l.step=p,l.value=m,n.data("last_value",m),g.val(m),c.addClass("tdc-css-inherited");
else for(r=0;r<p.params.length;r++){if(k===p.params[r].param_name){v=[];g=[];r=p.params[r].tdc_values;for(t in r)r.hasOwnProperty(t)&&v.push(r[t].unit);for(r=0;r<v.length&&!(g=n.split(v[r]),1<g.length);r++);g.length&&(m=g[0],u=v[r],d.data("range_value",m),d.data("range_unit",u),n=c.find('input[type="radio"][data-unit_value="'+u+'"]'),p=n.data("unit"),t=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",!0),l.min=t,l.max=f,l.step=p,l.value=m,n.data("last_value",m),c.find('input[type="text"]').val(m));
d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+k,tdcSidebar.currentViewportSettings.name));c.addClass("tdc-css-inherited");break}}else d.val(v),f.data("last_value",v),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),v+n,tdcSidebar.currentViewportSettings.name))}else if("radio"===b.attr("type")){if("input"===a.type)return;k=f.data("last_value");p=f.data("unit");t=d.data("min_"+p);f=d.data("max_"+p);p=d.data("step_"+p);l.min=t;l.max=f;l.step=
p;""===k?(g.val(h),d.val(h),v=h):(g.val(k),d.val(k),v=k);d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),v+n,tdcSidebar.currentViewportSettings.name));c.removeClass("tdc-css-inherited")}n="";c=jQuery(l).parent().find('input[type="radio"]:checked');c.length&&(n=jQuery(c[0]).data("unit_value"));"focusin"===a.type?l.oldValue=l.value+n:(c=jQuery(l),a=c.data("data-to-save"),m=tdcIFrameData.getModel(c.data("model_id")),l.oldValue!==a&&(tdcSidebarController.onUpdate(m,
jQuery(l).data("param_name"),l.oldValue,_.escape(a)),l.oldValue=a))});a.on("focus change",".tdc-tab-no-design .tdc-property-checkbox input",function(a){if("focusin"===a.type)this.oldValue=this.value;else{a=jQuery(this);var b=a.val();a.is(":checked")||(b="");var c=tdcIFrameData.getModel(a.data("model_id"));tdcSidebarController.onUpdate(c,a.data("param_name"),this.oldValue,b);this.oldValue=b}});a.on("focus change",".tdc-tab-no-design .tdc-property-checkbox-responsive input",function(a){if("focusin"===
a.type)this.oldValue=this.value;else{a=jQuery(this);var b=a.val(),c=tdcIFrameData.getModel(a.data("model_id")),d=a.data("param_name");a.is(":checked")||(b="");var f=a.attr("name"),g=a.closest(".tdc-property-responsive");b="all"===tdcSidebar.currentViewportSettings.name&&""===b?tdcSidebarPanel.deleteResponsiveValue(f,tdcSidebar.currentViewportSettings.name):tdcSidebarPanel.updateCheckboxResponsiveValues(f,b,tdcSidebar.currentViewportSettings.name);g.removeClass("tdc-css-inherited");g.find(".tdc-inherit-checkbox").hide();
...
a.on("click",".tdc-property-editor_css .tdc-property-title",function(a){tdcSidebarPanel.showHideTdcCssEditor.call(this,a)});a.on("mousedown",function(a){var b=jQuery("#tdc-sidebar"),c=jQuery("#tdc-icon-selector"),d=jQuery("#tdc-gradient"),f=jQuery("#tdc-palette"),g=jQuery("#tdc-font-list"),l=jQuery(".tdc-preset-values-list");c.length?c.get(0).contains(a.target)||(c.hide(),b.after(c)):c=tdcSidebar.buildIconSelector();d.length?d.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-gradient-wrap")||
(d.hide(),b.after(d))):d=tdcSidebar.buildGradient();f.length?f.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-colorpicker-wrap")||(f.hide(),b.after(f),f.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):f=tdcSidebar.buildPalette();g.length&&!g.get(0).contains(a.target)&&(g.hide(),b.after(g));!l.length||l.get(0).contains(a.target)||jQuery(".tdc-preset-values").get(0).contains(a.target)?l.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(a.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),
...
a.name+'</span><span class="tdc-font-delete"></span></div>').appendTo(f)}));if("undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts){jQuery('<div class="tdc-font-list-header"><span>Recent fonts</span></div>').appendTo(f);a=_.invert(window.tdcAdminSettings.mappedFontFamily);for(var g=window.tdcAdminSettings.tdcSavings.recentFonts.length;0<g;g--){var l=window.tdcAdminSettings.tdcSavings.recentFonts[g],n=a[l];_.isUndefined(n)||jQuery('<div class="tdc-recent-font-settings" data-value="'+
...
tdcIFrameData._checkModelData(c,a));var b=c.get("tag");c=c.get("attrs");c=_.clone(c);if(!_.isUndefined(c)){var e={};a={};for(var d in c)0===d.indexOf("tds_")&&(e[d]=c[d]);d=window.tdcAdminSettings.mappedShortcodes[b].params;for(b=0;b<d.length;b++){var f=!1,g=d[b];if(0===g.param_name.indexOf("tds_")){for(var l in e)if(g.param_name===l){a[l]=e[l];f=!0;break}f||(a[g.param_name]="")}}for(l in e)switch(e=l.split("-"),e.length){case 2:if(!_.has(a,l)){d=e[0];e=!1;for(var n in a)if(d===a[n]&&1===n.split("-").length){e=
!0;break}if(!e){var h;for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],d)){var m=h;break}_.has(a,m)&&""===a[m]&&window.tdcAdminSettings.globalStyle[m]===d&&(e=!0)}e||delete c[l]}break;case 3:d=e[0];b=e[2];for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],d)){m=h;break}e=!1;for(n in a)if(d===a[n]&&n===m+"-"+b){e=!0;break}e||_.has(a,m+"-"+b)&&""===a[m+"-"+b]&&window.tdcAdminSettings.globalStyle[m]===d&&(e=
!0);e||delete c[l]}return c}},getCurrentListAtts:function(a,c,b){_.isUndefined(c)&&(a=jQuery(a.currentTarget).data("model_id"),c=tdcIFrameData.getModel(a),a={error:k},_.isUndefined(c)||tdcIFrameData._checkModelData(c,a));a=c.get("tag");c=c.get("attrs");var e=_.clone(c);if(!_.isUndefined(e)){var d={};c={};for(var f in e)0===f.indexOf("tds_")&&(d[f]=e[f]);f=window.tdcAdminSettings.mappedShortcodes[a].params;for(var g=0;g<f.length;g++){var l=!1,n=f[g];if(0===n.param_name.indexOf("tds_")){for(var h in d)if(n.param_name===
h){c[h]=d[h];l=!0;break}l||(c[n.param_name]="")}}for(h in d)switch(d=h.split("-"),d.length){case 2:if(!_.has(c,h)){f=d[0];d=!1;for(var m in c)if(f===c[m]&&1===m.split("-").length){d=!0;break}if(!d){var q;for(q in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[q],f)){var p=q;break}_.has(c,p)&&""===c[p]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0)}d||delete e[h]}break;case 3:f=d[0];l=d[2];for(q in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[q],
f)){p=q;break}d=!1;for(m in c)if(f===c[m]&&m===p+"-"+l){d=!0;break}d||_.has(c,p+"-"+l)&&""===c[p+"-"+l]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0);d||delete e[h]}var u=[],v;for(v in window.tdcAdminSettings.listStyles[b])if(v===a){for(g=0;g<window.tdcAdminSettings.listStyles[b][v].length;g++)h=window.tdcAdminSettings.listStyles[b][v][g],_.isArray(h)?_.map(h,function(a){_.isUndefined(e[a])||(_.isUndefined(u[g])&&(u[g]=[]),u[g].push(e[a]))}):_.isUndefined(e[h])||(_.isArray(e[h])&&e[h].length?
u[g]=e[h][0]:u[g]=e[h]);break}return u}},showHideTdcCssEditor:function(a){a=jQuery("#tdc-editor-css");var c=jQuery(this).closest(".tdc-property-wrap"),b=c.find("textarea:first");a.length||tdcSidebar.buildEditorCss();tdcSidebar.$editorTextarea=b;c.next("#tdc-editor-css").length?a.toggle():(c.after(a),a.show(),tdcSidebar.editorCss.getSession().setValue(b.val()))},showHideTdcPalette:function(a){a=jQuery("#tdc-palette");var c=jQuery(this).closest(".tdc-property-wrap");a.length||tdcSidebar.buildPalette();
c.next("#tdc-palette").length?(a.toggle(),tdcSidebarPanel.saveTdcPalette()):(tdcSidebarPanel.saveTdcPalette(),c.after(a),a.show(),tdcSidebarPanel.openTdcPalette())},saveTdcPalette:function(){var a=jQuery("#tdc-palette"),c=a.prev(".tdc-property-wrap");a.length||tdcSidebar.buildPalette();c.length&&(c=c.find("input").val(),a=a.find("input.wp-color-picker"),a.tdPaletteColorPicker("open_palette",c),a.tdPaletteColorPicker("save_color"))},openTdcPalette:function(){var a=jQuery("#tdc-palette"),c=a.prev(".tdc-property-wrap");
a.length||tdcSidebar.buildPalette();c.length&&(c=c.find("input").val(),a.find("input.wp-color-picker").tdPaletteColorPicker("open_palette",c))},tdcIconWrapHandler:function(a){var c=jQuery(this),b=jQuery("#tdc-icon-selector");b.length||(b=tdcSidebar.buildIconSelector());var e=c.closest(".tdc-property-wrap");a=b.find(".tdc-icon-selector-filter");var d=b.find(".tdc-icon-selector-lib"),f=b.find(".tdc-icon-selector-content");d.val("");a.val("");f.children().each(function(){jQuery(this).show()});b.data("model_id",
c.data("model_id"));b.data("param_name",c.data("param_name"));b.show();e.after(b);c=b.data("param_name");b=tdcIFrameData.getModel(b.data("model_id")).get("attrs");var g="";_.has(b,c)&&(g=b[c].trim());a.focus();f.find("span").each(function(){var a=jQuery(this),b=a.data("font_class");if(g===b){for(a.addClass("selected");!a.prev(".tdc-font-separator").length;)a=a.prev();a=a.prev(".tdc-font-separator").data("font_id");d.val(a);d.trigger("change")}else a.removeClass("selected")})},tdcIconRemoveHandler:function(a){var c=
jQuery(a.currentTarget);a=c.closest(".tdc-property-wrap").find(".tdc-icon-wrap");c.addClass("tdc-hidden-button");a.addClass("tdc-no-icon-selected");a.html("");c=a.data("model_id");c=tdcIFrameData.getModel(c);tdcSidebarController.onUpdate(c,a.data("param_name"),"","")},tdcImageWrapHandler:function(a){var c=jQuery(a.currentTarget);c.closest(".tdc-tab-content");window.original_send_to_editor=window.send_to_editor;wp.media.editor.open(c);jQuery(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");
jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(a){var b=jQuery("img",a).attr("src"),d="",f="",g="";"undefined"===typeof b?(b=jQuery(a).attr("src"),d=jQuery(a).attr("class"),f=jQuery(a).attr("height"),g=jQuery(a).attr("width")):(d=jQuery("img",a).attr("class"),f=jQuery("img",a).attr("height"),g=jQuery("img",a).attr("width"));jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:d,action:"tdc_ajax_get_image_id"}}).done(function(a,d,e){"success"===d&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(c.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),c.attr("style","background-image: url( '"+b+"') "),c.data("image_link",b),c.data("image_id",a.image_id),c.data("image_height",
f),c.data("image_width",g),c.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,window.tb_remove(),d="",e=c.data("model_id"),e=tdcIFrameData.getModel(e),c.hasClass("tdc-no-image-selected")||(d=a.image_id.toString()),a=e.get("attrs"),a.media_size_image_height=f,a.media_size_image_width=g,e.set("attrs",a),tdcSidebarController.onUpdate(e,c.data("param_name"),"",d)))}).fail(function(a,b,c){})};return!1},tdcImageRemoveHandler:function(a){var c=jQuery(a.currentTarget);
a=c.closest(".tdc-property-wrap").find(".tdc-image-wrap");c.addClass("tdc-hidden-button");a.addClass("tdc-no-image-selected");jQuery.removeData(a,"image_link");a.attr("style","background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png'");c=a.data("model_id");c=tdcIFrameData.getModel(c);tdcSidebarController.onUpdate(c,a.data("param_name"),"","")},tdcInheritSelectHandler:function(a){a=jQuery(a.currentTarget);var c=a.closest(".tdc-property-wrap"),b=c.find("[data-responsive]"),
e=tdcSidebarPanel.getCurrentResponsiveValue(b.attr("name"),"all");c.hasClass("tdc-property-dropdown-responsive")&&("undefined"===typeof e?(c.removeClass("tdc-css-inherited"),b.find("option:selected").removeAttr("selected").find("option:first").attr("selected","selected")):(b.val(e),c.addClass("tdc-css-inherited")),c=tdcSidebarPanel.deleteResponsiveValue(b.attr("name"),tdcSidebar.currentViewportSettings.name),e=tdcIFrameData.getModel(b.data("model_id")),b=b.data("param_name"),tdcSidebarController.onUpdate(e,
b,"",c));a.hide()},tdcInheritCheckboxHandler:function(a){a=jQuery(a.currentTarget);var c=a.closest(".tdc-property-wrap"),b=c.find("[data-responsive]"),e=tdcSidebarPanel.getCurrentResponsiveValue(b.attr("name"),"all");c.hasClass("tdc-property-checkbox-responsive")&&("undefined"===typeof e?(c.removeClass("tdc-css-inherited"),b.removeAttr("checked")):(""===e?b.removeAttr("checked"):b.attr("checked","checked"),c.addClass("tdc-css-inherited")),c=tdcSidebarPanel.deleteResponsiveValue(b.attr("name"),tdcSidebar.currentViewportSettings.name),
e=tdcIFrameData.getModel(b.data("model_id")),b=b.data("param_name"),tdcSidebarController.onUpdate(e,b,"",c));a.hide()},bindPanelToModel:function(a,c){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==a.cid||!_.isUndefined(c)&&(_.isUndefined(c)||!0===c)){c=window.tdcAdminSettings.mappedShortcodes[a.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=a;for(var b=[],e=0;e<c.params.length;e++){var d=
tdcSidebarPanel._defaultGroupName;_.isEmpty(c.params[e].group)||(d=c.params[e].group);b.push(d)}b=_.uniq(b);var f=d="",g=tdcSidebar.getCurrentTabId(),l,n;d+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var h=n=l="";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);var m=tdcUtil.makeSafeForCSS(f);0===e?(l='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>',n='<a href="#" data-tab-id="td-tab-'+
m+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>'):_.isUndefined(g)||g!=="td-tab-"+m?h+='<a href="#" data-tab-id="td-tab-'+m+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>':(l=n,h+='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>')}f=m=n=e="";switch(tdcSidebar.currentViewportSettings.name){case "all":e="selected";break;case "landscape":n="selected";
break;case "portrait":m="selected";break;case "phone":f="selected"}d=d+(l+h)+'</div><div class="tdc-tab-responsive">';d+='<div class="tdc-responsive-buttons">';d+='<div class="tdc-responsive-all '+e+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>';"Newspaper"===window.tdcAdminSettings.themeName&&(d+='<div class="tdc-responsive-tablet-landscape '+n+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>');d+='<div class="tdc-responsive-tablet-portrait '+
...
"";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);m=tdcUtil.makeSafeForCSS(f);f="tdc-tab-no-design";var k=a.get("tag");"css"===m&&(f="tdc-tab-design");0===e?(l='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+m+'">',n='<div class="tdc-tab-content '+f+'" id="td-tab-'+m+'">',m=window.tdcAdminSettings.mappedShortcodes[k].tdc_start_values,a.unset("presetValues"),_.isUndefined(m)||(m=JSON.parse(window.atob(m)),_.isArray(m)&&1<m.length&&a.set("presetValues",m)),a.has("presetValues")&&
(m=a.get("presetValues"),h+=tdcSidebarPanel._addPresetValuesSelector(m,a))):_.isUndefined(g)||g!=="td-tab-"+m?h+='<div class="tdc-tab-content '+f+'" id="td-tab-'+m+'">':(l=n,h+='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+m+'">');h+=tdcSidebarPanel._bindGroupAndGetHtml(b[e],c,a);m=' data-model_id="'+a.cid+'" ';"dev"===window.tdcAdminSettings.deployMode&&(h+='<div class="tdc-sidebar-row-buttons">',h+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+m+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>',
h+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+m+' title="Get the current styles\' settings">CONSOLE: style presets</div>',h+="</div>");h+="</div>"}d=d+(l+h)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(d);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");tdcSidebarPanel._hook.addAction("panel_rendered",function(){"undefined"===typeof window.tdcResponsiveValues&&(window.tdcResponsiveValues={},"all"===tdcSidebar.currentViewportSettings.name?jQuery(".tdc-tab-content-wrap").removeClass("tdc-viewport-responsive"):
jQuery(".tdc-tab-content-wrap").addClass("tdc-viewport-responsive"),jQuery(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=jQuery(this),b=a.find("[data-responsive]"),c=b.attr("name"),d=b.data("responsive");try{var e=window.atob(d);window.tdcResponsiveValues[c]=JSON.parse(e)}catch(x){d={},a.hasClass("tdc-property-textfield-responsive")?""!==b.val()&&(d.all=b.val()):a.hasClass("tdc-property-dropdown-responsive")?b.find("option:first").val()!==b.val()&&(d.all=b.val()):a.hasClass("tdc-property-checkbox-responsive")?
b.is(":checked")&&(d.all=b.val()):a.hasClass("tdc-property-range-responsive")?d.all=b.data("value"):a.hasClass("tdc-property-range_multiple-responsive")&&(d.all=b.data("range_value")+b.data("range_unit")),window.tdcResponsiveValues[c]=d}tdcSidebarPanel.setViewportCurrentResponsiveValue(b)}))});tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-tab-content-wrap").find('select[name$="font_family"]').change(function(a){a=jQuery(this).val();""===window.tdcAdminSettings.tdcSavings&&
...
0<tdcSidebarPanel.$_paramNameSwitch.length&&(tdcSidebarPanel.$_paramNameSwitch.show(),tdcSidebarPanel.$_paramNameSwitch.hasClass("tdc-param-name-switch-active")&&jQuery(".tdc-param-name").addClass("tdc-param-name-active"));tdcSidebarPanel._hook.doAction("panel_rendered");tdcSidebarPanel._hook.doAction("panel_css");(function(){if("vc_row"===a.get("tag")){var b=jQuery("body .tdc-row-col-dropdown select"),c=jQuery("body .tdc-row-stretch-dropdown select"),d=a.get("childCollection");if(!_.isUndefined(d)){d=
...
"11");var d=a.get("parentModel").get("attrs"),e="";_.has(d,"width")&&(e=d.width.replace("/",""));if(b.length)switch(b.val(c),e){case "":case "11":b.find("option[value=12_12]").addClass("tdc-block-col");b.find("option[value=23_13]").removeClass("tdc-block-col");b.find("option[value=13_23]").removeClass("tdc-block-col");b.find("option[value=13_13_13]").removeClass("tdc-block-col");break;case "13":b.find("option[value=12_12]").addClass("tdc-block-col");b.find("option[value=23_13]").addClass("tdc-block-col");
b.find("option[value=13_23]").addClass("tdc-block-col");b.find("option[value=13_13_13]").addClass("tdc-block-col");break;case "23":b.find("option[value=12_12]").removeClass("tdc-block-col"),b.find("option[value=23_13]").addClass("tdc-block-col"),b.find("option[value=13_23]").addClass("tdc-block-col"),b.find("option[value=13_13_13]").addClass("tdc-block-col")}else if(b=jQuery('body .tdc-innerRow-col-dropdown input[value="'+c+'"]'),b.length)switch(b.attr("checked","checked"),b.next("label").show(),
e){case "":case "11":b.parent().find("input[value=12_12] + label").addClass("tdc-block-col");b.parent().find("input[value=23_13] + label").removeClass("tdc-block-col");b.parent().find("input[value=13_23] + label").removeClass("tdc-block-col");b.parent().find("input[value=13_13_13] + label").removeClass("tdc-block-col");break;case "13":b.parent().find("input[value=12_12] + label").addClass("tdc-block-col");b.parent().find("input[value=23_13] + label").addClass("tdc-block-col");b.parent().find("input[value=13_23] + label").addClass("tdc-block-col");
b.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col");break;case "23":b.parent().find("input[value=12_12] + label").removeClass("tdc-block-col"),b.parent().find("input[value=23_13] + label").addClass("tdc-block-col"),b.parent().find("input[value=13_23] + label").addClass("tdc-block-col"),b.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})()}},_bindGroupAndGetHtml:function(a,c,b){var e="",d=b.get("attrs");if("tdc_zone"===b.get("tag"))var f=d.type;for(var g=
0;g<c.params.length;g++){var l=c.params[g].param_name,n=c.params[g].group;if(a===tdcSidebarPanel._defaultGroupName&&_.isEmpty(c.params[g].group)||c.params[g].group===a){if(!_.isUndefined(f)&&(!_.isUndefined(c.params[g].zone_group)&&f!==c.params[g].zone_group||"type"===l))continue;e+=tdcSidebarPanel._bindParamAndGetHtml(c.params[g],b)}if("block_template_id"===l){n=d.block_template_id;_.isEmpty(n)&&(n=window.tdcAdminSettings.globalBlockTemplate);l=window.tdcAdminSettings.mappedBlockTemplates;for(var h=
0;h<l[n].params.length;h++)if(a===tdcSidebarPanel._defaultGroupName&&_.isEmpty(l[n].params[h].group)||l[n].params[h].group===a)e+=tdcSidebarPanel._bindParamAndGetHtml(l[n].params[h],b)}else if(0===l.indexOf("tds_")){var m=l.split("-");h=m[0];var k;2===m.length?k=m[1]:2<m.length&&new tdcNotice.notice('Param "'+l+'" must have up to at most one "-" separator ',!0,!1);l=d[l];_.isEmpty(l)&&(l=window.tdcAdminSettings.globalStyle[h]);m=window.tdcAdminSettings.settingsStyle[h];for(h=0;h<m[l].params.length;h++)if(n==
a||_.isUndefined(n)&&a===tdcSidebarPanel._defaultGroupName){var p=JSON.parse(JSON.stringify(m[l].params[h]));p.param_name=l+"-"+p.param_name;_.isUndefined(k)||(p.param_name+="-"+k);e+=tdcSidebarPanel._bindParamAndGetHtml(p,b)}}}return e},_bindParamAndGetHtml:function(a,c){switch(a.type){case "custom":return tdcSidebarPanel.addCustom(a,c);case "colorpicker":return tdcSidebarPanel.addColorpicker(a,c);case "gradient":return tdcSidebarPanel.addGradient(a,c);case "dropdown":return tdcSidebarPanel.addDropDown(a,
...
tdcSidebarPanel.callbackColorPicker);return e},addCustom:function(a,c){c="";_.has(a,"description")&&""!==a.description&&(c=' title="'+a.description+'" ');var b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';b+='<div class="tdc-property-title"><span class="tdc-search-data"'+c+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property">'+a.value;b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+"</div>"},callbackEditorCss:function(){tdcSidebar.buildEditorCss()},
callbackColorPicker:function(){jQuery("#tdc-palette-color-picker").tdPalette();jQuery(".tdc-tab-no-design .tdc-property-colorpicker").each(function(){var a=jQuery(this),c=a.find("input");a=a.find(".tdc-colorpicker-wrap");_.isUndefined(c.val())||""===c.val()||a.attr("style","background: "+c.val())})},addGradient:function(a,c){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var e='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';e+='<div class="tdc-property-title"><span class="tdc-search-data"'+
b+">"+a.heading+"</span></div>";e=e+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(a,c)+'"/>');e=e+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");e+="</div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackGradient)||tdcSidebarPanel._hook.addAction("panel_rendered",
tdcSidebarPanel.callbackGradient);return e},callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var a=jQuery(this),c=a.find("input");a=a.find(".tdc-gradient-wrap");if(!_.isUndefined(c.val())&&""!==c.val())try{var b=JSON.parse(window.atob(c.val()));_.isUndefined(b.css)||a.attr("style",b.css)}catch(e){b=c.val(),_.isUndefined(b)||a.attr("style","background: "+b)}})},addDropDown:function(a,c){if("tdb_mobile_menu"===c.get("tag")&&
"menu_id"===a.param_name){var b=c.get("attrs");b.menu_id=window.tdcPostSettings.mobileMenuId;c.set("attrs",b)}var e=b=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(b=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(e=!0);var d="",f="",g=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&g.length<=parseInt(a.tdc_min_options))return d;for(var l=0;l<g.length;l++){var k=!1,h="",m="",q=g[l],p=String(tdcSidebarPanel._getParameterCurrentValue(a,c)),u=String(a.value[g[l]]);
_.isObject(a.value[g[l]])&&(k=!0,u=_.values(a.value[g[l]])[0],q=_.keys(a.value[g[l]])[0]);if(b||e){0===l&&""===p&&(p=u);p===u&&(h=" checked ");m=_.uniqueId();p=u;if("vc_row"===c.attributes.tag||"vc_row_inner"===c.attributes.tag)p="col_"+p;f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+m+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+h+' value="'+u+'">';b?(h="",k&&(h="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+
h+'" for="'+m+'" title="'+q+'"><div class="'+p+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+m+'" title="'+q+'">'+u+"</label>"}else p===u&&(h=' selected="selected" '),"__"===u&&-1!==q.search("--")&&(m=" disabled "),f+="<option "+h+" "+m+' value="'+u+'">'+q+"</option>"}g="";_.has(a,"description")&&""!==a.description&&(g=' title="'+a.description+'" ');d+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';d+='<div class="tdc-property-title"><span class="tdc-search-data"'+
g+">"+a.heading+"</span></div>";d+='<div class="tdc-property">';b||e?d+=f:(d+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'">',d=d+f+"</select>");d=d+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return d+"</div>"},addDropDownResponsive:function(a,c){var b=!1,e=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(b=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(e=!0);var d="",f="",g=Object.keys(a.value);
if(_.has(a,"tdc_min_options")&&g.length<=parseInt(a.tdc_min_options))return d;var l=' data-responsive="" ',k=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var h=JSON.parse(window.atob(k));l=' data-responsive="'+k+'" ';"undefined"!==typeof h[tdcSidebar.currentViewportSettings.name]&&(k=h[tdcSidebar.currentViewportSettings.name])}catch(t){}for(h=0;h<g.length;h++){var m=!1,q="",p=g[h],u=String(a.value[g[h]]);_.isObject(a.value[g[h]])&&(m=!0,u=_.values(a.value[g[h]])[0],p=_.keys(a.value[g[h]])[0]);
if(b||e){0===h&&""===k&&(k=u);k===u&&(q=" checked ");var v=_.uniqueId(),r=u;if("vc_row"===c.attributes.tag||"vc_row_inner"===c.attributes.tag)r="col_"+r;f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+q+' value="'+u+'" '+l+">";b?(q="",m&&(q="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+q+'" for="'+v+'" title="'+p+'"><div class="'+r+'"></div></label>'):f+=
'<label class="tdc-property-input-radio-label" for="'+v+'" title="'+p+'">'+u+"</label>"}else k===u&&(q=' selected="selected" '),f+="<option "+q+' value="'+u+'">'+p+"</option>"}g="";_.has(a,"description")&&""!==a.description&&(g=' title="'+a.description+'" ');d+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';d+='<div class="tdc-property-title"><span class="tdc-search-data"'+g+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';
d+='<div class="tdc-property">';b||e?d+=f:(d+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+l+g+">",d=d+f+"</select>");d=d+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return d+"</div>"},addCheckBox:function(a,c){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var e="";""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&(e=" checked ");var d='<div class="'+tdcSidebarPanel._getParameterClasses(a)+
...
JSON.parse(window.atob(d));e=' data-responsive="'+d+'" ';"undefined"!==typeof f[tdcSidebar.currentViewportSettings.name]&&(d=f[tdcSidebar.currentViewportSettings.name])}catch(g){}""!==d&&(b=" checked ");f="";_.has(a,"description")&&""!==a.description&&(f=' title="'+a.description+'" ');d='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';d+='<div class="tdc-property-title"><span class="tdc-search-data"'+f+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';
...
var f="";_.has(a,"range_step")&&""!==a.range_step&&(f=a.range_step);var g="";_.has(a,"value")&&""!==a.value&&(g=a.value);var l="";""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&(l=tdcSidebarPanel._getParameterCurrentValue(a,c));var k='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';k+='<div class="tdc-property-title"><span class="tdc-search-data"'+b+">"+a.heading+"</span></div>";k=k+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+
'" type="range" data-value="'+l+'" data-min="'+d+'" data-max="'+e+'" data-step="'+f+'" min="'+d+'" max="'+e+'" step="'+f+'" value="'+l+'" />');k=k+('<input type="text" class="tdc_range_value" data-default_value="'+g+'" value="'+l+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return k+="</div>"},addRangeResponsive:function(a,c){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var e="";_.has(a,"range_max")&&""!==a.range_max&&(e=a.range_max);
var d="";_.has(a,"range_min")&&""!==a.range_min&&(d=a.range_min);var f="";_.has(a,"range_step")&&""!==a.range_step&&(f=a.range_step);var g="";_.has(a,"value")&&""!==a.value&&(g=a.value);""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&tdcSidebarPanel._getParameterCurrentValue(a,c);var l="";_.has(a,"placeholder")&&""!==a.placeholder&&(l=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var k=' data-responsive="" ',h=tdcSidebarPanel._getParameterCurrentValue(a,c);try{var m=
JSON.parse(window.atob(h));k=' data-responsive="'+h+'" ';h="undefined"===typeof m[tdcSidebar.currentViewportSettings.name]?"":m[tdcSidebar.currentViewportSettings.name]}catch(q){}m='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';m+='<div class="tdc-property-title"><span class="tdc-search-data"'+b+">"+a.heading+"</span></div>";m=m+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+
h+'" data-min="'+d+'" data-max="'+e+'" data-step="'+f+'" min="'+d+'" max="'+e+'" step="'+f+'" value="'+h+'" '+k+" />");m=m+('<input type="text" class="tdc_range_value" data-default_value="'+g+'" '+l+' value="'+h+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return m+="</div>"},addRangeMultiple:function(a,c){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var e=a.tdc_values,d=tdcSidebarPanel._getParameterCurrentValue(a,c),f="",g="",l=[],k=
"",h="",m="",q="",p="",u="",v="",r;for(r in e)e.hasOwnProperty(r)&&(l.push(e[r].unit),""===h||""===k)&&(q=e[r].unit,h=' data-range_unit="'+q+'" ',m=e[r].value,k=' data-range_value="'+m+'" ',p=e[r].range_min,u=e[r].range_max,v=e[r].range_step);if(""!==d){for(var t=[],x=0;x<l.length&&!(t=d.split(l[x]),1<t.length);x++);t.length&&(q=l[x],h=' data-range_unit="'+q+'" ',m=t[0],k=' data-range_value="'+m+'" ')}for(r in e)e.hasOwnProperty(r)&&(d=_.uniqueId(),f+=" data-value_"+r+'="'+e[r].value+'" ',f+=" data-min_"+
r+'="'+e[r].range_min+'" ',f+=" data-max_"+r+'="'+e[r].range_max+'" ',f+=" data-step_"+r+'="'+e[r].range_step+'" ',l=e[r].value,t="",e[r].unit===q&&(l=m,p=e[r].range_min,u=e[r].range_max,v=e[r].range_step,t="checked"),g+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+r+'" data-unit_value="'+e[r].unit+'" type="radio" id="'+d+'" '+t+' data-default_value="'+e[r].value+'" data-last_value="'+l+'"/>',g+='<label for="'+d+'">'+e[r].unit+"</label>");e='<div class="'+tdcSidebarPanel._getParameterClasses(a)+
'">';e+='<div class="tdc-property-title"><span class="tdc-search-data"'+b+">"+a.heading+"</span></div>";e=e+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+k+" "+h+" "+f+' min="'+p+'" max="'+u+'" step="'+v+'" value="'+m+'"/>');e=e+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+g+'</div><input type="text" class="tdc_range_value" value="'+(m+'"/>');
e+="</div>";e+="</div>";e+='<span class="tdc-param-name">'+a.param_name+"</span>";return e+="</div>"},addRangeMultipleResponsive:function(a,c){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var e=a.tdc_values,d=tdcSidebarPanel._getParameterCurrentValue(a,c),f="",g="",l=[],k=' data-responsive="" ',h="",m="",q="",p="",u="",v="",r="",t;for(t in e)e.hasOwnProperty(t)&&(l.push(e[t].unit),""===m||""===h)&&(p=e[t].unit,m=' data-range_unit="'+p+'" ',q=e[t].value,h=
' data-range_value="'+q+'" ',u=e[t].range_min,v=e[t].range_max,r=e[t].range_step);if(""!==d){var x=d;try{var A=JSON.parse(window.atob(d));k=' data-responsive="'+d+'" ';x="undefined"===typeof A[tdcSidebar.currentViewportSettings.name]?"":A[tdcSidebar.currentViewportSettings.name]}catch(w){}if(""!==x){d=[];for(A=0;A<l.length&&!(d=x.split(l[A]),1<d.length);A++);d.length&&(p=l[A],m=' data-range_unit="'+p+'" ',q=d[0],h=' data-range_value="'+q+'" ')}}for(t in e)e.hasOwnProperty(t)&&(l=_.uniqueId(),f+=" data-value_"+
t+'="'+e[t].value+'" ',f+=" data-min_"+t+'="'+e[t].range_min+'" ',f+=" data-max_"+t+'="'+e[t].range_max+'" ',f+=" data-step_"+t+'="'+e[t].range_step+'" ',x=e[t].value,d="",e[t].unit===p&&(x=q,u=e[t].range_min,v=e[t].range_max,r=e[t].range_step,d="checked"),g+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+t+'" data-unit_value="'+e[t].unit+'" type="radio" id="'+l+'" '+d+' data-default_value="'+e[t].value+'" data-last_value="'+x+'"/>',g+='<label for="'+l+'">'+e[t].unit+
"</label>");e='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';e+='<div class="tdc-property-title"><span class="tdc-search-data"'+b+">"+a.heading+"</span></div>";e=e+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+h+" "+m+" "+f+" "+k+' min="'+u+'" max="'+v+'" step="'+r+'" value="'+q+'"/>');e=e+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+
g+'</div><input type="text" class="tdc_range_value" value="'+(q+'"/>');e+="</div>";e+="</div>";e+='<span class="tdc-param-name">'+a.param_name+"</span>";return e+="</div>"},addIconSelector:function(a,c){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var e='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';e+='<div class="tdc-property-title"><span class="tdc-search-data"'+b+">"+a.heading+"</span></div>";e=e+'<div class="tdc-property"><div class="tdc-icon-wrap tdc-no-icon-selected" '+
...
e=window.btoa(encodeURIComponent(a.target.oldValue));tdcSidebarController.onUpdate(c,b.data("param_name"),e,d)}a.target.oldValue=a.target.value});return d},addEditorCss:function(a,c){var b=_.uniqueId("tdc_textarea_"),e="";_.has(a,"description")&&""!==a.description&&(e=' title="'+a.description+'" ');var d='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';d+='<div class="tdc-property-title"><span class="tdc-search-data tdc-open-csseditor"'+e+">"+a.heading+"</span></div>";d=d+'<div class="tdc-property"><textarea id="'+
(b+'" class="tdc-textarea tdc-editor-css" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' style="display: none">'+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</textarea>");d=d+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");d+="</div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackEditorCss)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackEditorCss);jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(a,c)}}).done(function(a,c,d){"success"===c&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):jQuery("#"+b).html(a.parsed_content).addClass("tdc-textarea-visible"))}).fail(function(a,b,c){});return d},
addSeparatorHorizontal:function(a,c){return'<div class="tdc-sidebar-horizontal-separator '+tdcSidebarPanel._getParameterClasses(a)+'"></div>'},addTextSeparatorHorizontal:function(a,c){return'<div class="tdc-sidebar-text-separator tdc-property-title '+tdcSidebarPanel._getParameterClasses(a)+'"><span class="tdc-search-data">'+a.heading+"</span></div>"},addFontHeader:function(a,c){return'<div class="tdc-sidebar-font-header '+tdcSidebarPanel._getParameterClasses(a)+'"><span class="tdc-font-ico1" title="Font size"></span><span class="tdc-font-ico2" title="Line height (Use with px or a number that will be multiplied with the current font-size)"></span><span class="tdc-font-ico3" title="Font style"></span><span class="tdc-font-ico4" title="Font weight"></span><span class="tdc-font-ico5" title="Text transform"></span><span class="tdc-font-ico6" title="Letter spacing"></span></div>'},
...
"checked"),b.removeClass("tdc-css-inherited"),"all"===tdcSidebar.currentViewportSettings.name?e.hide():e.show());else if(b.hasClass("tdc-property-dropdown-responsive")){e=b.find(".tdc-inherit-select");var d=a.attr("type");_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)?"undefined"!==typeof d&&"radio"===d?a.each(function(a){var b=jQuery(this);"radio"===b.attr("type")&&(0===a?b.prop("checked",!0):b.prop("checked",!1))}):a.find("option:selected").removeAttr("selected").find("option:first").attr("selected",
"selected"):("undefined"!==typeof d&&"radio"===d?a.each(function(a){a=jQuery(this);"radio"===a.attr("type")&&(a.val()===c?a.prop("checked",!0):a.prop("checked",!1))}):a.val(c),b.addClass("tdc-css-inherited")),e.hide()):("undefined"!==typeof d&&"radio"===d?a.each(function(a){a=jQuery(this);"radio"===a.attr("type")&&(a.val()===c?a.prop("checked",!0):a.prop("checked",!1))}):a.val(c),b.removeClass("tdc-css-inherited"),"all"===tdcSidebar.currentViewportSettings.name?e.hide():e.show())}else if(b.hasClass("tdc-property-range-responsive"))e=
"",_.isUndefined(a.data("placeholder"))||(e=a.data("placeholder")),d=a.next('input[type="text"]'),d.attr("placeholder",e),_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)?(a.val(""),d.val("")):(a.val(c),d.val(c),d.attr("placeholder",c),b.addClass("tdc-css-inherited"))):(a.val(c),d.val(c),b.removeClass("tdc-css-inherited"));else if(b.hasClass("tdc-property-range_multiple-responsive")){e=tdcIFrameData.getModel(a.data("model_id"));var f=a.data("param_name"),
g=window.tdcAdminSettings.mappedShortcodes[e.attributes.tag];e=[];for(var l=d="",k=0;k<g.params.length;k++)if(f===g.params[k].param_name){f=g.params[k].tdc_values;for(var h in f)f.hasOwnProperty(h)&&(e.push(f[h].unit),""===d||""===l)&&(d=f[h].value,l=f[h].unit);break}_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)&&(a.data("range_value",d),a.data("range_unit",l),a.val(d),h=b.find('input[type="radio"][data-unit_value="'+l+'"]'),k=h.data("unit"),
f=a.data("min_"+k),l=a.data("max_"+k),k=a.data("step_"+k),g=a.get(0),h.prop("checked",!0),g.min=f,g.max=l,g.step=k,g.value=d,h.data("last_value",d),b.find('input[type="text"]').val(d)),"all"===tdcSidebar.currentViewportSettings.name?b.removeClass("tdc-css-inherited"):b.addClass("tdc-css-inherited")):b.removeClass("tdc-css-inherited");if(!_.isUndefined(c)){d=[];for(k=0;k<e.length&&!(d=c.split(e[k]),1<d.length);k++);d.length&&(d=d[0],l=e[k],a.data("range_value",d),a.data("range_unit",l),a.val(d),h=
b.find('input[type="radio"][data-unit_value="'+l+'"]'),k=h.data("unit"),f=a.data("min_"+k),l=a.data("max_"+k),k=a.data("step_"+k),g=a.get(0),h.prop("checked",!0),g.min=f,g.max=l,g.step=k,g.value=d,h.data("last_value",d),b.find('input[type="text"]').val(d))}}},showShortcodeFromPath:function(a){if(!_.isUndefined(a)){a=a.toString().split("_");var c;a.forEach(function(a,b){""!==a&&(_.isUndefined(c)?c=tdcIFrameData.tdcTopCollection.at(a):(b=c.get("childCollection"),!_.isUndefined(b)&&b.length>a&&(c=b.at(a))))});
if(!_.isUndefined(c)){var b=c.get("blockUid");if(!_.isUndefined(b)){var e=tdcAdminIFrameUI.getLiveIframe();a=e.contents().find("#"+b);a.length||(a=e.contents().find('[data-td-block-uid="'+b+'"]'));a.length&&(e.contents().scrollTop(a.offset().top-100),b={},tdcOperationUI.inZone(a)?tdcOperationUI.inRow(a)?tdcOperationUI.inColumn(a)?tdcOperationUI.inInnerRow(a)?tdcOperationUI.inInnerColumn(a)?(b.$currentZone=tdcOperationUI.inZone(a),b.$currentRow=tdcOperationUI.inRow(a),b.$currentColumn=tdcOperationUI.inColumn(a),
b.$currentInnerRow=tdcOperationUI.inInnerRow(a),b.$currentInnerColumn=tdcOperationUI.inInnerColumn(a),b.$currentElement=a):(b.$currentZone=tdcOperationUI.inZone(a),b.$currentRow=tdcOperationUI.inRow(a),b.$currentColumn=tdcOperationUI.inColumn(a),b.$currentInnerRow=tdcOperationUI.inInnerRow(a),b.$currentInnerColumn=a):(b.$currentZone=tdcOperationUI.inZone(a),b.$currentRow=tdcOperationUI.inRow(a),b.$currentColumn=tdcOperationUI.inColumn(a),b.$currentInnerRow=a):(b.$currentZone=tdcOperationUI.inZone(a),
b.$currentRow=tdcOperationUI.inRow(a),b.$currentColumn=a):(b.$currentZone=tdcOperationUI.inZone(a),b.$currentRow=a):b.$currentZone=a,tdcSidebar._currentModel=c,a.data("model_id",c.cid),tdcSidebar.setSettings(b,!0,c))}}}}}})();var tdcUtil={};
