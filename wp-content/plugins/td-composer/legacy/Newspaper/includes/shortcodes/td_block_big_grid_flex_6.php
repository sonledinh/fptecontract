    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
				...
				/* @video_icon3 */
                @media (max-width: 767px) {
                    .$unique_block_class .td-big-grid-flex-post-3 .td-video-play-ico,
                    .$unique_block_class .td-big-grid-flex-post-4 .td-video-play-ico {
                        width: @video_icon3;
                        height: @video_icon3;
				...
				/* @show_review3 */
                @media (max-width: 767px) {
                    .$unique_block_class .td-big-grid-flex-post-3 .entry-review-stars,
                    .$unique_block_class .td-big-grid-flex-post-4 .entry-review-stars {
                        display: @show_review3;
                    }
                }
				/* @review_size3 */
                @media (max-width: 767px) {
                    .$unique_block_class .td-big-grid-flex-post-3 .td-icon-star,
                    .$unique_block_class .td-big-grid-flex-post-3 .td-icon-star-empty,
                    .$unique_block_class .td-big-grid-flex-post-3 .td-icon-star-half,
                    .$unique_block_class .td-big-grid-flex-post-4 .td-icon-star,
                    .$unique_block_class .td-big-grid-flex-post-4 .td-icon-star-empty,
                    .$unique_block_class .td-big-grid-flex-post-4 .td-icon-star-half  {
