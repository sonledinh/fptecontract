    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
				...
				/* @image_alignment3 */
				.$unique_block_class .td_module_flex_8 .entry-thumb {
				...
				/* @image_height3 */
				.$unique_block_class .td_module_flex_8 .td-image-wrap {
				...
				/* @video_icon3 */
				.$unique_block_class .td_module_flex_8 .td-video-play-ico {
					width: @video_icon3;
					height: @video_icon3;
				...
				/* @image_width3 */
				.$unique_block_class .td_module_flex_8 {
					width: @image_width3;
				}
				...
				/* @meta_width3 */
				.$unique_block_class .td_module_flex_8 .td-module-meta-info {
					width: @meta_width3;
				}
				...
				/* @art_title3 */
				.$unique_block_class .td_module_flex_8 .tdb-module-title-wrap {
					margin: @art_title3;
				}
				...
				/* @art_title_padd3 */
				.$unique_block_class .td_module_flex_8 .entry-title {
				...
				/* @auth_date_padding3 */
				.$unique_block_class .td_module_flex_8 .td-editor-date {
				...
				.$unique_block_class .td_module_flex_8 .td-post-category {
				...
				/* @show_author3 */
				.$unique_block_class .td_module_flex_8 .td-post-author-name {
				...
				/* @show_date3 */
				.$unique_block_class .td_module_flex_8 .td-post-date,
				.$unique_block_class .td_module_flex_8 .td-post-author-name span {
					display: @show_date3;
				}
				...
				/* @show_review3 */
				.$unique_block_class .td_module_flex_8 .entry-review-stars {
					display: @show_review3;
				}
				/* @review_size3 */
				.$unique_block_class .td_module_flex_8 .td-icon-star,
                .$unique_block_class .td_module_flex_8 .td-icon-star-empty,
                .$unique_block_class .td_module_flex_8 .td-icon-star-half {
				...
				/* @f_meta3 */
				.$unique_block_class .td_module_flex_8 .td-editor-date,
				.$unique_block_class .td_module_flex_8 .td-module-comments a {
					@f_meta3
				}
