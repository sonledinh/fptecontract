    ...
    function get_date($modified_date = '', $show_stars_on_review = true) {
        ...
        if ($this->is_review and $show_stars_on_review === true) {
            ...
            if (td_util::get_option('tds_p_show_date') != 'hide') {
                ...
                $buffy .= '<span class="p-icon-small icfcalendar"></span><span class="td-post-date">';
...
//                $td_article_date_unix = get_the_time('U', $this->post->ID);
                ...
                $buffy .= '<span class="p-icon-small icfcalendar"></span><span class="td-post-date td-post-modified-date">';
    ...
    function get_views() {
        ...
        if (td_util::get_option('tds_p_show_views') != 'hide') {
            ...
            // Default Theme Views Counter
                ...
                $buffy .= '<span class="p-icon-small icfview" ></span><span class="td-nr-views-' . $this->post->ID . '">' . td_page_views::get_page_views($this->post->ID) .'</span>';
            }
...
//            }
    ...
    function get_the_tags() {
        ...
        if (!empty($terms_ui_array)) {
			$buffy .= '<span class="pitti-tags">' . $tags_spot_text . '</span>';
